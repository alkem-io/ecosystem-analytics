...
const NODE_COLORS: Record<string, string> = {
  ...
  USER: 'var(--node-user)',
  // Feature 016 (VNG) — GemeenteDelers layer (basic visual treatment)
  INITIATIVE: '#ec4899', // pink
  THEME: '#06b6d4', // cyan
};
...
const EDGE_COLORS: Record<string, string> = {
  ...
  // Feature 016 (VNG) — GemeenteDelers layer
  INITIATIVE_GEMEENTE: 'rgba(236,72,153,0.45)', // pink — initiative → gemeente org
  INITIATIVE_THEME: 'rgba(6,182,212,0.45)',     // cyan — initiative → theme
};
