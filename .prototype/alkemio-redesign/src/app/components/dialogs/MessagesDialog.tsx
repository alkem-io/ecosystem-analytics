              ...
              {conversations.map((conv) => (
                ...
                >
                  <div className="relative">
                    ...
                    {conv.user.status === 'online' && <span className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-background rounded-full"></span>}
                    {conv.user.status === 'busy' && <span className="absolute bottom-0 right-0 w-3 h-3 bg-red-500 border-2 border-background rounded-full"></span>}
                  </div>
