          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <DialogDescription className="text-xs text-muted-foreground">
                in Innovation Hub / Sustainability
              </DialogDescription>
            </div>
          </div>
            ...
            <div className="px-6 py-8 md:px-10 md:py-10 space-y-6">
              ...
              <div className="flex items-center gap-4 py-4 border-y border-border mt-8">
                <div className="flex -space-x-2">
                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 text-xs border border-background">👍</span>
                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-red-100 text-red-600 text-xs border border-background">❤️</span>
                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-yellow-100 text-yellow-600 text-xs border border-background">💡</span>
                </div>
              ...
              <div className="bg-muted/30 py-10 px-6 md:px-10 border-t border-border">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {post.contentPreview?.items?.map((item, idx) => (
                    ...
                    >
                      <div className="h-32 bg-indigo-50/50 flex items-center justify-center relative">
                         <FileText className="w-10 h-10 text-indigo-300 group-hover:text-indigo-500 transition-colors" />
                         <div className="absolute top-2 left-2 bg-background/80 backdrop-blur-sm p-1.5 rounded-md">
