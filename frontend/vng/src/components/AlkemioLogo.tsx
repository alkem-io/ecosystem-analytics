/**
 * Alkemio brand mark (cyan #09BCD4). Markup ported from client-web
 * (`src/crd/components/common/AlkemioLogo.tsx`) so the EA sign-in screens
 * carry the same Alkemio identity as the hosted login they redirect to.
 */
const SVG_PATHS = {
...
export function AlkemioLogo({
  ...
  return (
    <div className={className} data-name="alkemio-logo" aria-hidden={ariaHidden}>
      <svg
