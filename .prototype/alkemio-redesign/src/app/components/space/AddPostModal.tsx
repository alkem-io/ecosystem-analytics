...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogClose, DialogFooter } from "@/app/components/ui/dialog";
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-3">
             ...
             <div className="flex flex-wrap gap-2">
                <TooltipProvider>
                  {[
                    { id: 'whiteboard', label: 'Whiteboard', icon: Presentation, color: "text-blue-500 bg-blue-50 hover:bg-blue-100 border-blue-200" },
                    { id: 'memo', label: 'Memo', icon: StickyNote, color: "text-amber-500 bg-amber-50 hover:bg-amber-100 border-amber-200" },
                    { id: 'cta', label: 'Call to Action', icon: Megaphone, color: "text-purple-500 bg-purple-50 hover:bg-purple-100 border-purple-200" },
                    { id: 'image', label: 'Image', icon: Image, color: "text-emerald-500 bg-emerald-50 hover:bg-emerald-100 border-emerald-200" },
                  ].map((item) => (
                    <Tooltip key={item.id}>
             ...
             {activeAttachment === 'whiteboard' && (
                <div className="mt-2 p-4 border rounded-xl bg-muted/30 flex items-center justify-between animate-in fade-in slide-in-from-top-2">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-blue-100 rounded-lg text-blue-600"><Presentation className="w-5 h-5" /></div>
                    <div>
