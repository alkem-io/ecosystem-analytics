...
import { 
  Search, RefreshCw, LayoutGrid, Users, ZoomIn, ZoomOut, Maximize, 
  Map as MapIcon, ChevronRight, Share2, ExternalLink, User, Building, 
...
const SPACE_DEFS: Record<string, SpaceDef[]> = {
  '1': [
    ...
    { id: 'circular-econ', name: 'Circular Economy', level: 'L1', parent: 'innovation-hub', image: IMG.circularEcon },
    { id: 'digital-health', name: 'Digital Health', level: 'L1', parent: 'innovation-hub', image: IMG.digitalHealth },
  ],
  '2': [
    { id: 'urban-mobility', name: 'Urban Mobility', level: 'L0', image: IMG.urbanMobility, location: { lat: 51.92, lng: 4.48 } },
    { id: 'autonomous-transit', name: 'Autonomous Transit', level: 'L1', parent: 'urban-mobility', image: IMG.autoTransit },
    { id: 'bike-infra', name: 'Bike Infrastructure', level: 'L1', parent: 'urban-mobility' },
    { id: 'last-mile', name: 'Last Mile Delivery', level: 'L1', parent: 'urban-mobility' },
  ],
  '3': [
    { id: 'green-energy', name: 'Green Energy', level: 'L0', image: IMG.greenEnergy, location: { lat: 51.44, lng: 5.47 } },
    { id: 'solar-innovation', name: 'Solar Innovation', level: 'L1', parent: 'green-energy' },
    { id: 'wind-energy', name: 'Wind Farm Tech', level: 'L1', parent: 'green-energy' },
    { id: 'grid-storage', name: 'Grid Storage', level: 'L1', parent: 'green-energy' },
  ],
};
    ...
    <div className="flex flex-col h-screen" style={{ background: 'var(--background)', color: 'var(--foreground)', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        >
          ...
          <div 
            className="absolute bottom-5 left-5 flex flex-col z-10"
            style={{ 
              background: 'var(--background)', 
          ...
          >
            <Button variant="ghost" size="icon" style={{ width: 30, height: 30 }}><ZoomIn style={{ width: 14, height: 14 }} /></Button>
            <Button variant="ghost" size="icon" style={{ width: 30, height: 30 }}><ZoomOut style={{ width: 14, height: 14 }} /></Button>
            <Separator style={{ margin: '2px 0' }} />
            <Button variant="ghost" size="icon" style={{ width: 30, height: 30 }}><Maximize style={{ width: 14, height: 14 }} /></Button>
          </div>
