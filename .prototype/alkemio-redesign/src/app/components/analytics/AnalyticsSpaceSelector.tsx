...
const MOCK_SPACES: SpaceOption[] = [
  { id: "1", name: "Innovation Hub", role: "Lead", privacy: "Public", lastActive: "2m ago", health: "High" },
                 ...
                 {filteredSpaces.map(space => (
                    ...
                    >
                       ...
                       <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-[length:var(--text-xs)] text-muted-foreground">
                             <span className="flex items-center gap-1">
                                <div className={cn("w-1.5 h-1.5 rounded-full", space.privacy === 'Public' ? "bg-green-500" : "bg-amber-500")} />
                                {space.privacy}
                             </span>
                             <span>•</span>
                       ...
                       <div className="text-right hidden sm:block">
                          ...
                          <Badge variant={space.health === 'High' ? 'default' : space.health === 'Medium' ? 'secondary' : 'outline'} className={cn("text-[10px]", space.health === 'High' && "bg-green-100 text-green-700 hover:bg-green-100 border-transparent dark:bg-green-900/30 dark:text-green-300")}>
                             {space.health}
                          </Badge>
                       </div>
                    </div>
