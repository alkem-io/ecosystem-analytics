...
export type CalloutAllowedActors =
  | 'ADMINS'
  | 'MEMBERS'
  | 'NONE';
...
export type CalloutContributionType =
  | 'COLLABORA_DOCUMENT'
  | 'LINK'
  | 'MEMO'
  | 'POST'
...
export type CalloutDescriptionDisplayMode =
  | 'COLLAPSED'
  | 'EXPANDED';
...
export type CalloutFramingType =
  | 'COLLABORA_DOCUMENT'
  | 'CONTRIBUTORS'
  | 'LINK'
  | 'MEDIA_GALLERY'
...
export type CalloutSelectionMode =
  | 'AUTO'
  | 'CUSTOM';
...
export type ClassificationCardinality =
  | 'MULTI_SELECT'
  | 'SINGLE_SELECT';
...
export type CollaboraDocumentType =
  | 'DRAWING'
  | 'PDF'
  | 'PRESENTATION'
  | 'SPREADSHEET'
...
export type CommunityMembershipPolicy =
  | 'APPLICATIONS'
  | 'INVITATIONS'
  | 'OPEN';
...
export type ContentUpdatePolicy =
  | 'ADMINS'
  | 'CONTRIBUTORS'
  | 'OWNER';
...
export type ContributorCollectionView =
  | 'LIST'
  | 'MAP';
...
export type ConversationCreationType =
  | 'DIRECT'
  | 'GROUP';
...
export type DirectMessageDeliveryStatus =
  | 'BLOCKED_NO_CONSENT'
  | 'FAILED'
  | 'SENT';
...
export type ForumDiscussionPrivacy =
  | 'AUTHENTICATED'
  | 'AUTHOR'
  | 'PUBLIC';
...
export type IdentityVerificationStatusFilter =
  | 'ALL'
  | 'UNVERIFIED'
  | 'VERIFIED';
...
export type LicenseEntitlementDataType =
  | 'FLAG'
  | 'LIMIT';
...
export type McpApiKeyOperation =
  | 'READ'
  | 'TOOLS';
...
export type MemoSignatureVerificationStatus =
  | 'INVALID'
  | 'UNAVAILABLE'
  | 'VERIFIED';
...
export type NotificationEvent =
  ...
  | 'PLATFORM_ADMIN_USER_PROFILE_CREATED'
  | 'PLATFORM_ADMIN_USER_PROFILE_REMOVED'
  ...
  | 'USER_MENTIONED'
  | 'USER_MESSAGE'
  | 'USER_PASSWORD_CHANGE_SECURITY_SIGNAL'
  | 'USER_SIGN_UP_WELCOME'
  | 'USER_SPACE_COMMUNITY_APPLICATION_DECLINED'
  | 'USER_SPACE_COMMUNITY_INVITATION'
  | 'USER_SPACE_COMMUNITY_JOINED'
  | 'VIRTUAL_ADMIN_SPACE_COMMUNITY_INVITATION';
...
export type NotificationEventInAppState =
  | 'ARCHIVED'
  | 'READ'
  | 'UNREAD';
...
export type RoleSetRoleImplicit =
  | 'ACCOUNT_ADMIN'
  | 'SUBSPACE_ADMIN';

export type RoleSetType =
  | 'ORGANIZATION'
  | 'PLATFORM'
  | 'SPACE';
...
export type UrlResolverResultState =
  | 'Forbidden'
  | 'NotFound'
  | 'Resolved';
...
export type UserEmailChangeAuditOutcome =
  | 'COMMITTED'
  | 'DRIFT_DETECTED'
...
export type UserEmailChangeInitiatorRole =
  | 'PLATFORM_ADMIN'
  | 'SELF';
...
export type UserInformationVisibility =
...
export type VirtualContributorBodyOfKnowledgeType =
...
export type VirtualContributorDataAccessMode =
  | 'NONE'
  | 'SPACE_PROFILE'
  | 'SPACE_PROFILE_AND_CONTENTS';

export type VirtualContributorInteractionMode =
  | 'DISCUSSION_TAGGING';
...
export type VirtualContributorModelCardEntry =
  | 'SPACE_CAPABILITIES'
  | 'SPACE_DATA_ACCESS'
  | 'SPACE_ROLE_REQUIRED';

export type VirtualContributorModelCardEntryFlagName =
...
export type VirtualContributorStatus =
  | 'INITIALIZING'
  | 'READY';
...
export type VirtualContributorWellKnown =
  | 'CHAT_GUIDANCE'
  | 'STEWARD_OWNERSHIP_EXPERT';
...
export type WhiteboardPreviewMode =
  | 'AUTO'
  | 'CUSTOM'
  | 'FIXED';
...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  ActivityLogEntry:
    | ( Omit<SchemaTypes.ActivityLogEntryCalendarEventCreated, 'calendar' | 'calendarEvent' | 'space' | 'triggeredBy'> & { calendar: _RefType['Calendar'], calendarEvent: _RefType['CalendarEvent'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutDiscussionComment, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutLinkCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutMemoCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutPostComment, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutPostCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutPublished, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutWhiteboardContentModified, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryCalloutWhiteboardCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: _RefType['Callout'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryMemberJoined, 'actor' | 'community' | 'space' | 'triggeredBy'> & { actor: _RefType['Actor'], community: _RefType['Community'], space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntrySubspaceCreated, 'space' | 'subspace' | 'triggeredBy'> & { space?: SchemaTypes.Maybe<_RefType['Space']>, subspace: _RefType['Space'], triggeredBy: _RefType['User'] } )
    | ( Omit<SchemaTypes.ActivityLogEntryUpdateSent, 'space' | 'triggeredBy'> & { space?: SchemaTypes.Maybe<_RefType['Space']>, triggeredBy: _RefType['User'] } )
  ;
  ActorFull:
    | ( Omit<SchemaTypes.Account, 'actor' | 'baselineLicensePlan' | 'credentials' | 'host' | 'innovationHubs' | 'innovationPacks' | 'profile' | 'spaces'> & { actor: _RefType['Actor'], baselineLicensePlan: _RefType['AccountLicensePlan'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, host?: SchemaTypes.Maybe<_RefType['Actor']>, innovationHubs: Array<_RefType['InnovationHub']>, innovationPacks: Array<_RefType['InnovationPack']>, profile?: SchemaTypes.Maybe<_RefType['Profile']>, spaces: Array<_RefType['Space']> } )
    | ( Omit<SchemaTypes.Organization, 'account' | 'actor' | 'credentials' | 'group' | 'groups' | 'profile' | 'roleSet'> & { account?: SchemaTypes.Maybe<_RefType['Account']>, actor: _RefType['Actor'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, group?: SchemaTypes.Maybe<_RefType['UserGroup']>, groups?: SchemaTypes.Maybe<Array<_RefType['UserGroup']>>, profile?: SchemaTypes.Maybe<_RefType['Profile']>, roleSet: _RefType['RoleSet'] } )
    | ( Omit<SchemaTypes.RelayPaginatedSpace, 'about' | 'account' | 'actor' | 'collaboration' | 'community' | 'credentials' | 'mentionableContributors' | 'profile' | 'subspaceByNameID' | 'subspaces'> & { about: _RefType['SpaceAbout'], account: _RefType['Account'], actor: _RefType['Actor'], collaboration: _RefType['Collaboration'], community: _RefType['Community'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, mentionableContributors: Array<_RefType['ActorFull']>, profile?: SchemaTypes.Maybe<_RefType['Profile']>, subspaceByNameID: _RefType['Space'], subspaces: Array<_RefType['Space']> } )
    | ( Omit<SchemaTypes.Space, 'about' | 'account' | 'actor' | 'collaboration' | 'community' | 'credentials' | 'mentionableContributors' | 'profile' | 'subspaceByNameID' | 'subspaces'> & { about: _RefType['SpaceAbout'], account: _RefType['Account'], actor: _RefType['Actor'], collaboration: _RefType['Collaboration'], community: _RefType['Community'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, mentionableContributors: Array<_RefType['ActorFull']>, profile?: SchemaTypes.Maybe<_RefType['Profile']>, subspaceByNameID: _RefType['Space'], subspaces: Array<_RefType['Space']> } )
    | ( Omit<SchemaTypes.User, 'account' | 'actor' | 'credentials' | 'profile'> & { account?: SchemaTypes.Maybe<_RefType['Account']>, actor: _RefType['Actor'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, profile?: SchemaTypes.Maybe<_RefType['Profile']> } )
    | ( Omit<SchemaTypes.VirtualAssistant, 'credentials' | 'profile'> & { credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, profile?: SchemaTypes.Maybe<_RefType['Profile']> } )
    | ( Omit<SchemaTypes.VirtualContributor, 'account' | 'actor' | 'credentials' | 'knowledgeSpace' | 'profile' | 'provider'> & { account?: SchemaTypes.Maybe<_RefType['Account']>, actor: _RefType['Actor'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, knowledgeSpace?: SchemaTypes.Maybe<_RefType['Space']>, profile?: SchemaTypes.Maybe<_RefType['Profile']>, provider: _RefType['Actor'] } )
  ;
  Groupable:
    | ( Omit<SchemaTypes.Community, 'communication' | 'group' | 'groups' | 'roleSet'> & { communication: _RefType['Communication'], group: _RefType['UserGroup'], groups: Array<_RefType['UserGroup']>, roleSet: _RefType['RoleSet'] } )
    | ( Omit<SchemaTypes.Organization, 'account' | 'actor' | 'credentials' | 'group' | 'groups' | 'profile' | 'roleSet'> & { account?: SchemaTypes.Maybe<_RefType['Account']>, actor: _RefType['Actor'], credentials?: SchemaTypes.Maybe<Array<_RefType['Credential']>>, group?: SchemaTypes.Maybe<_RefType['UserGroup']>, groups?: SchemaTypes.Maybe<Array<_RefType['UserGroup']>>, profile?: SchemaTypes.Maybe<_RefType['Profile']>, roleSet: _RefType['RoleSet'] } )
  ;
  InAppNotificationPayload:
    | ( Omit<SchemaTypes.InAppNotificationPayloadOrganizationMessageDirect, 'organization'> & { organization?: SchemaTypes.Maybe<_RefType['Organization']> } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadOrganizationMessageRoom, 'organization'> & { organization: _RefType['Organization'] } )
    | ( SchemaTypes.InAppNotificationPayloadPlatformForumDiscussion )
    | ( Omit<SchemaTypes.InAppNotificationPayloadPlatformGlobalRoleChange, 'user'> & { user?: SchemaTypes.Maybe<_RefType['User']> } )
    | ( SchemaTypes.InAppNotificationPayloadPlatformUser )
    | ( Omit<SchemaTypes.InAppNotificationPayloadPlatformUserMessageRoom, 'user'> & { user: _RefType['User'] } )
    | ( SchemaTypes.InAppNotificationPayloadPlatformUserProfileRemoved )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpace, 'space'> & { space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCallout, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutComment, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutPostComment, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutReaction, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationPoll, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunicationMessageDirect, 'space'> & { space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunicationUpdate, 'space'> & { space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityActor, 'actor' | 'space'> & { actor: _RefType['Actor'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityApplication, 'space'> & { space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityCalendarEvent, 'calendarEvent' | 'space'> & { calendarEvent: _RefType['CalendarEvent'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityCalendarEventComment, 'calendarEvent' | 'space'> & { calendarEvent: _RefType['CalendarEvent'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityInvitation, 'space'> & { space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityInvitationPlatform, 'space'> & { space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadUserMessageDirect, 'user'> & { user?: SchemaTypes.Maybe<_RefType['User']> } )
    | ( Omit<SchemaTypes.InAppNotificationPayloadVirtualContributor, 'space'> & { space: _RefType['Space'] } )
  ;
  SearchResult:
    | ( Omit<SchemaTypes.SearchResultCallout, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.SearchResultCollaboraDocument, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.SearchResultMemo, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.SearchResultOrganization, 'organization'> & { organization: _RefType['Organization'] } )
    | ( Omit<SchemaTypes.SearchResultPost, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.SearchResultSpace, 'parentSpace' | 'space'> & { parentSpace?: SchemaTypes.Maybe<_RefType['Space']>, space: _RefType['Space'] } )
    | ( Omit<SchemaTypes.SearchResultUser, 'user'> & { user: _RefType['User'] } )
    | ( Omit<SchemaTypes.SearchResultWhiteboard, 'callout' | 'space'> & { callout: _RefType['Callout'], space: _RefType['Space'] } )
  ;
};
...
export type ResolversTypes = {
  ...
  Account: ResolverTypeWrapper<Omit<SchemaTypes.Account, 'actor' | 'baselineLicensePlan' | 'credentials' | 'host' | 'innovationHubs' | 'innovationPacks' | 'profile' | 'spaces'> & { actor: ResolversTypes['Actor'], baselineLicensePlan: ResolversTypes['AccountLicensePlan'], credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, host?: SchemaTypes.Maybe<ResolversTypes['Actor']>, innovationHubs: Array<ResolversTypes['InnovationHub']>, innovationPacks: Array<ResolversTypes['InnovationPack']>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']>, spaces: Array<ResolversTypes['Space']> }>;
  ...
  ActivityCreatedSubscriptionResult: ResolverTypeWrapper<Omit<SchemaTypes.ActivityCreatedSubscriptionResult, 'activity'> & { activity: ResolversTypes['ActivityLogEntry'] }>;
  ActivityEventType: SchemaTypes.ActivityEventType;
  ActivityFeed: ResolverTypeWrapper<Omit<SchemaTypes.ActivityFeed, 'activityFeed'> & { activityFeed: Array<ResolversTypes['ActivityLogEntry']> }>;
  ...
  ActivityLogEntry: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['ActivityLogEntry']>;
  ActivityLogEntryCalendarEventCreated: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalendarEventCreated, 'calendar' | 'calendarEvent' | 'space' | 'triggeredBy'> & { calendar: ResolversTypes['Calendar'], calendarEvent: ResolversTypes['CalendarEvent'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutDiscussionComment: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutDiscussionComment, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutLinkCreated: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutLinkCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutMemoCreated: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutMemoCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutPostComment: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutPostComment, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutPostCreated: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutPostCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutPublished: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutPublished, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutWhiteboardContentModified: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutWhiteboardContentModified, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryCalloutWhiteboardCreated: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryCalloutWhiteboardCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversTypes['Callout'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryMemberJoined: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryMemberJoined, 'actor' | 'community' | 'space' | 'triggeredBy'> & { actor: ResolversTypes['Actor'], community: ResolversTypes['Community'], space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntrySubspaceCreated: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntrySubspaceCreated, 'space' | 'subspace' | 'triggeredBy'> & { space?: SchemaTypes.Maybe<ResolversTypes['Space']>, subspace: ResolversTypes['Space'], triggeredBy: ResolversTypes['User'] }>;
  ActivityLogEntryUpdateSent: ResolverTypeWrapper<Omit<SchemaTypes.ActivityLogEntryUpdateSent, 'space' | 'triggeredBy'> & { space?: SchemaTypes.Maybe<ResolversTypes['Space']>, triggeredBy: ResolversTypes['User'] }>;
  ActivityLogInput: SchemaTypes.ActivityLogInput;
  Actor: ResolverTypeWrapper<Omit<SchemaTypes.Actor, 'credentials' | 'profile'> & { credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']> }>;
  ActorFilterInput: SchemaTypes.ActorFilterInput;
  ActorFull: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['ActorFull']>;
  ...
  Application: ResolverTypeWrapper<Omit<SchemaTypes.Application, 'actor' | 'user'> & { actor: ResolversTypes['Actor'], user?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  AuthenticationConfig: ResolverTypeWrapper<Omit<SchemaTypes.AuthenticationConfig, 'providers'> & { providers: Array<ResolversTypes['AuthenticationProviderConfig']> }>;
  ...
  AuthenticationProviderConfigUnion: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['AuthenticationProviderConfigUnion']>;
  ...
  Calendar: ResolverTypeWrapper<Omit<SchemaTypes.Calendar, 'event' | 'events'> & { event?: SchemaTypes.Maybe<ResolversTypes['CalendarEvent']>, events: Array<ResolversTypes['CalendarEvent']> }>;
  CalendarEvent: ResolverTypeWrapper<Omit<SchemaTypes.CalendarEvent, 'createdBy' | 'profile' | 'subspace'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']>, profile: ResolversTypes['Profile'], subspace?: SchemaTypes.Maybe<ResolversTypes['Space']> }>;
  CalendarEventType: SchemaTypes.CalendarEventType;
  Callout: ResolverTypeWrapper<Omit<SchemaTypes.Callout, 'contributionDefaults' | 'createdBy' | 'framing' | 'publishedBy'> & { contributionDefaults: ResolversTypes['CalloutContributionDefaults'], createdBy?: SchemaTypes.Maybe<ResolversTypes['User']>, framing: ResolversTypes['CalloutFraming'], publishedBy?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  CalloutAllowedActors: SchemaTypes.CalloutAllowedActors;
  CalloutContribution: ResolverTypeWrapper<Omit<SchemaTypes.CalloutContribution, 'createdBy'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  CalloutFraming: ResolverTypeWrapper<Omit<SchemaTypes.CalloutFraming, 'contributorCounts' | 'profile' | 'subspaces'> & { contributorCounts: ResolversTypes['ContributorCollectionCounts'], profile: ResolversTypes['Profile'], subspaces: Array<ResolversTypes['Space']> }>;
  CalloutFramingType: SchemaTypes.CalloutFramingType;
  CalloutPostCreated: ResolverTypeWrapper<SchemaTypes.CalloutPostCreated>;
  CalloutReaction: ResolverTypeWrapper<Omit<SchemaTypes.CalloutReaction, 'user'> & { user?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  CalloutsSet: ResolverTypeWrapper<Omit<SchemaTypes.CalloutsSet, 'callouts'> & { callouts: Array<ResolversTypes['Callout']> }>;
  ...
  CollaboraDocument: ResolverTypeWrapper<Omit<SchemaTypes.CollaboraDocument, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']>, profile: ResolversTypes['Profile'] }>;
  ...
  Collaboration: ResolverTypeWrapper<Omit<SchemaTypes.Collaboration, 'timeline'> & { timeline: ResolversTypes['Timeline'] }>;
  ...
  Community: ResolverTypeWrapper<Omit<SchemaTypes.Community, 'communication' | 'group' | 'groups' | 'roleSet'> & { communication: ResolversTypes['Communication'], group: ResolversTypes['UserGroup'], groups: Array<ResolversTypes['UserGroup']>, roleSet: ResolversTypes['RoleSet'] }>;
  CommunityApplicationForRoleResult: ResolverTypeWrapper<SchemaTypes.CommunityApplicationForRoleResult>;
  CommunityApplicationResult: ResolverTypeWrapper<Omit<SchemaTypes.CommunityApplicationResult, 'spacePendingMembershipInfo'> & { spacePendingMembershipInfo: ResolversTypes['SpacePendingMembershipInfo'] }>;
  CommunityGuidelines: ResolverTypeWrapper<Omit<SchemaTypes.CommunityGuidelines, 'profile'> & { profile: ResolversTypes['Profile'] }>;
  CommunityInvitationForRoleResult: ResolverTypeWrapper<SchemaTypes.CommunityInvitationForRoleResult>;
  CommunityInvitationResult: ResolverTypeWrapper<Omit<SchemaTypes.CommunityInvitationResult, 'invitation' | 'spacePendingMembershipInfo'> & { invitation: ResolversTypes['Invitation'], spacePendingMembershipInfo: ResolversTypes['SpacePendingMembershipInfo'] }>;
  CommunityMembershipPolicy: SchemaTypes.CommunityMembershipPolicy;
  CommunityMembershipResult: ResolverTypeWrapper<Omit<SchemaTypes.CommunityMembershipResult, 'childMemberships' | 'space'> & { childMemberships: Array<ResolversTypes['CommunityMembershipResult']>, space: ResolversTypes['Space'] }>;
  CommunityMembershipStatus: SchemaTypes.CommunityMembershipStatus;
  Config: ResolverTypeWrapper<Omit<SchemaTypes.Config, 'authentication'> & { authentication: ResolversTypes['AuthenticationConfig'] }>;
  ...
  Conversation: ResolverTypeWrapper<Omit<SchemaTypes.Conversation, 'members'> & { members: Array<ResolversTypes['Actor']> }>;
  ConversationCreatedEvent: ResolverTypeWrapper<Omit<SchemaTypes.ConversationCreatedEvent, 'conversation'> & { conversation: ResolversTypes['Conversation'] }>;
  ...
  ConversationEventSubscriptionResult: ResolverTypeWrapper<Omit<SchemaTypes.ConversationEventSubscriptionResult, 'conversationCreated' | 'conversationUpdated' | 'memberAdded' | 'memberRemoved'> & { conversationCreated?: SchemaTypes.Maybe<ResolversTypes['ConversationCreatedEvent']>, conversationUpdated?: SchemaTypes.Maybe<ResolversTypes['ConversationUpdatedEvent']>, memberAdded?: SchemaTypes.Maybe<ResolversTypes['ConversationMemberAddedEvent']>, memberRemoved?: SchemaTypes.Maybe<ResolversTypes['ConversationMemberRemovedEvent']> }>;
  ConversationEventType: SchemaTypes.ConversationEventType;
  ConversationMemberAddedEvent: ResolverTypeWrapper<Omit<SchemaTypes.ConversationMemberAddedEvent, 'addedMember' | 'conversation'> & { addedMember: ResolversTypes['Actor'], conversation: ResolversTypes['Conversation'] }>;
  ConversationMemberRemovedEvent: ResolverTypeWrapper<Omit<SchemaTypes.ConversationMemberRemovedEvent, 'conversation'> & { conversation: ResolversTypes['Conversation'] }>;
  ...
  ConversationUpdatedEvent: ResolverTypeWrapper<Omit<SchemaTypes.ConversationUpdatedEvent, 'conversation'> & { conversation: ResolversTypes['Conversation'] }>;
  ...
  Discussion: ResolverTypeWrapper<Omit<SchemaTypes.Discussion, 'profile'> & { profile: ResolversTypes['Profile'] }>;
  ...
  Document: ResolverTypeWrapper<Omit<SchemaTypes.Document, 'createdBy'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  Forum: ResolverTypeWrapper<Omit<SchemaTypes.Forum, 'discussion' | 'discussions' | 'mentionableContributors'> & { discussion?: SchemaTypes.Maybe<ResolversTypes['Discussion']>, discussions?: SchemaTypes.Maybe<Array<ResolversTypes['Discussion']>>, mentionableContributors: Array<ResolversTypes['ActorFull']> }>;
  ...
  Groupable: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['Groupable']>;
  ID: ResolverTypeWrapper<SchemaTypes.Scalars['ID']['output']>;
  ISearchCategoryResult: ResolverTypeWrapper<Omit<SchemaTypes.ISearchCategoryResult, 'results'> & { results: Array<ResolversTypes['SearchResult']> }>;
  ISearchResults: ResolverTypeWrapper<Omit<SchemaTypes.ISearchResults, 'actorResults' | 'calloutResults' | 'contributionResults' | 'framingResults' | 'spaceResults'> & { actorResults: ResolversTypes['ISearchCategoryResult'], calloutResults: ResolversTypes['ISearchCategoryResult'], contributionResults: ResolversTypes['ISearchCategoryResult'], framingResults: ResolversTypes['ISearchCategoryResult'], spaceResults: ResolversTypes['ISearchCategoryResult'] }>;
  ...
  InAppNotification: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotification, 'payload' | 'receiver' | 'triggeredBy'> & { payload: ResolversTypes['InAppNotificationPayload'], receiver: ResolversTypes['Actor'], triggeredBy?: SchemaTypes.Maybe<ResolversTypes['Actor']> }>;
  InAppNotificationPayload: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['InAppNotificationPayload']>;
  InAppNotificationPayloadOrganizationMessageDirect: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadOrganizationMessageDirect, 'organization'> & { organization?: SchemaTypes.Maybe<ResolversTypes['Organization']> }>;
  InAppNotificationPayloadOrganizationMessageRoom: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadOrganizationMessageRoom, 'organization'> & { organization: ResolversTypes['Organization'] }>;
  ...
  InAppNotificationPayloadPlatformGlobalRoleChange: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadPlatformGlobalRoleChange, 'user'> & { user?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  InAppNotificationPayloadPlatformUser: ResolverTypeWrapper<SchemaTypes.InAppNotificationPayloadPlatformUser>;
  InAppNotificationPayloadPlatformUserMessageRoom: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadPlatformUserMessageRoom, 'user'> & { user: ResolversTypes['User'] }>;
  ...
  InAppNotificationPayloadSpace: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpace, 'space'> & { space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCollaborationCallout: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCallout, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCollaborationCalloutComment: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutComment, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCollaborationCalloutPostComment: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutPostComment, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCollaborationCalloutReaction: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutReaction, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCollaborationPoll: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationPoll, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunicationMessageDirect: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunicationMessageDirect, 'space'> & { space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunicationUpdate: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunicationUpdate, 'space'> & { space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunityActor: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityActor, 'actor' | 'space'> & { actor: ResolversTypes['Actor'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunityApplication: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityApplication, 'space'> & { space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunityCalendarEvent: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityCalendarEvent, 'calendarEvent' | 'space'> & { calendarEvent: ResolversTypes['CalendarEvent'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunityCalendarEventComment: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityCalendarEventComment, 'calendarEvent' | 'space'> & { calendarEvent: ResolversTypes['CalendarEvent'], space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunityInvitation: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityInvitation, 'space'> & { space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadSpaceCommunityInvitationPlatform: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityInvitationPlatform, 'space'> & { space: ResolversTypes['Space'] }>;
  InAppNotificationPayloadUserMessageDirect: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadUserMessageDirect, 'user'> & { user?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  InAppNotificationPayloadVirtualContributor: ResolverTypeWrapper<Omit<SchemaTypes.InAppNotificationPayloadVirtualContributor, 'space'> & { space: ResolversTypes['Space'] }>;
  InnovationFlow: ResolverTypeWrapper<Omit<SchemaTypes.InnovationFlow, 'profile'> & { profile: ResolversTypes['Profile'] }>;
  InnovationFlowSettings: ResolverTypeWrapper<SchemaTypes.InnovationFlowSettings>;
  InnovationFlowState: ResolverTypeWrapper<Omit<SchemaTypes.InnovationFlowState, 'defaultCalloutTemplate'> & { defaultCalloutTemplate?: SchemaTypes.Maybe<ResolversTypes['Template']> }>;
  InnovationFlowStateSettings: ResolverTypeWrapper<SchemaTypes.InnovationFlowStateSettings>;
  InnovationHub: ResolverTypeWrapper<Omit<SchemaTypes.InnovationHub, 'account' | 'innovationPackListFilter' | 'profile' | 'provider' | 'spaceListFilter'> & { account: ResolversTypes['Account'], innovationPackListFilter?: SchemaTypes.Maybe<Array<ResolversTypes['InnovationPack']>>, profile: ResolversTypes['Profile'], provider: ResolversTypes['Actor'], spaceListFilter?: SchemaTypes.Maybe<Array<ResolversTypes['Space']>> }>;
  InnovationHubType: SchemaTypes.InnovationHubType;
  InnovationPack: ResolverTypeWrapper<Omit<SchemaTypes.InnovationPack, 'profile' | 'provider' | 'templatesSet'> & { profile: ResolversTypes['Profile'], provider: ResolversTypes['Actor'], templatesSet?: SchemaTypes.Maybe<ResolversTypes['TemplatesSet']> }>;
  ...
  Invitation: ResolverTypeWrapper<Omit<SchemaTypes.Invitation, 'actor' | 'createdBy'> & { actor: ResolversTypes['Actor'], createdBy?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  KnowledgeBase: ResolverTypeWrapper<Omit<SchemaTypes.KnowledgeBase, 'profile'> & { profile: ResolversTypes['Profile'] }>;
  ...
  Library: ResolverTypeWrapper<Omit<SchemaTypes.Library, 'innovationHubs' | 'innovationPacks' | 'innovationPacksPaginated' | 'templates' | 'templatesPaginated'> & { innovationHubs: Array<ResolversTypes['InnovationHub']>, innovationPacks: Array<ResolversTypes['InnovationPack']>, innovationPacksPaginated: ResolversTypes['PaginatedInnovationPacks'], templates: Array<ResolversTypes['TemplateResult']>, templatesPaginated: ResolversTypes['PaginatedLibraryTemplateResults'] }>;
  ...
  LifecycleDefinition: ResolverTypeWrapper<SchemaTypes.Scalars['LifecycleDefinition']['output']>;
  Link: ResolverTypeWrapper<Omit<SchemaTypes.Link, 'profile'> & { profile: ResolversTypes['Profile'] }>;
  Location: ResolverTypeWrapper<SchemaTypes.Location>;
  LookupByNameQueryResults: ResolverTypeWrapper<Omit<SchemaTypes.LookupByNameQueryResults, 'space'> & { space?: SchemaTypes.Maybe<ResolversTypes['Space']> }>;
  LookupMyPrivilegesQueryResults: ResolverTypeWrapper<SchemaTypes.LookupMyPrivilegesQueryResults>;
  LookupQueryResults: ResolverTypeWrapper<Omit<SchemaTypes.LookupQueryResults, 'about' | 'account' | 'calendar' | 'calendarEvent' | 'callout' | 'collaboration' | 'community' | 'communityGuidelines' | 'conversation' | 'document' | 'innovationHub' | 'innovationPack' | 'invitation' | 'organization' | 'profile' | 'roleSet' | 'space' | 'storageBucket' | 'template' | 'templateContentSpace' | 'templatesSet' | 'user'> & { about?: SchemaTypes.Maybe<ResolversTypes['SpaceAbout']>, account?: SchemaTypes.Maybe<ResolversTypes['Account']>, calendar?: SchemaTypes.Maybe<ResolversTypes['Calendar']>, calendarEvent?: SchemaTypes.Maybe<ResolversTypes['CalendarEvent']>, callout?: SchemaTypes.Maybe<ResolversTypes['Callout']>, collaboration?: SchemaTypes.Maybe<ResolversTypes['Collaboration']>, community?: SchemaTypes.Maybe<ResolversTypes['Community']>, communityGuidelines?: SchemaTypes.Maybe<ResolversTypes['CommunityGuidelines']>, conversation?: SchemaTypes.Maybe<ResolversTypes['Conversation']>, document?: SchemaTypes.Maybe<ResolversTypes['Document']>, innovationHub?: SchemaTypes.Maybe<ResolversTypes['InnovationHub']>, innovationPack?: SchemaTypes.Maybe<ResolversTypes['InnovationPack']>, invitation?: SchemaTypes.Maybe<ResolversTypes['Invitation']>, organization?: SchemaTypes.Maybe<ResolversTypes['Organization']>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']>, roleSet?: SchemaTypes.Maybe<ResolversTypes['RoleSet']>, space?: SchemaTypes.Maybe<ResolversTypes['Space']>, storageBucket?: SchemaTypes.Maybe<ResolversTypes['StorageBucket']>, template?: SchemaTypes.Maybe<ResolversTypes['Template']>, templateContentSpace?: SchemaTypes.Maybe<ResolversTypes['TemplateContentSpace']>, templatesSet?: SchemaTypes.Maybe<ResolversTypes['TemplatesSet']>, user?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  MeConversationsResult: ResolverTypeWrapper<Omit<SchemaTypes.MeConversationsResult, 'conversations'> & { conversations: Array<ResolversTypes['Conversation']> }>;
  MeQueryResults: ResolverTypeWrapper<Omit<SchemaTypes.MeQueryResults, 'communityApplications' | 'communityInvitations' | 'conversations' | 'mySpaces' | 'notifications' | 'spaceMembershipsFlat' | 'spaceMembershipsHierarchical' | 'user'> & { communityApplications: Array<ResolversTypes['CommunityApplicationResult']>, communityInvitations: Array<ResolversTypes['CommunityInvitationResult']>, conversations: ResolversTypes['MeConversationsResult'], mySpaces: Array<ResolversTypes['MySpaceResults']>, notifications: ResolversTypes['PaginatedInAppNotifications'], spaceMembershipsFlat: Array<ResolversTypes['CommunityMembershipResult']>, spaceMembershipsHierarchical: Array<ResolversTypes['CommunityMembershipResult']>, user?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  MediaGallery: ResolverTypeWrapper<Omit<SchemaTypes.MediaGallery, 'storageBucket'> & { storageBucket?: SchemaTypes.Maybe<ResolversTypes['StorageBucket']> }>;
  Memo: ResolverTypeWrapper<Omit<SchemaTypes.Memo, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']>, profile: ResolversTypes['Profile'] }>;
  MemoSignature: ResolverTypeWrapper<Omit<SchemaTypes.MemoSignature, 'actor' | 'document'> & { actor?: SchemaTypes.Maybe<ResolversTypes['User']>, document?: SchemaTypes.Maybe<ResolversTypes['Document']> }>;
  ...
  Message: ResolverTypeWrapper<Omit<SchemaTypes.Message, 'sender'> & { sender?: SchemaTypes.Maybe<ResolversTypes['Actor']> }>;
  ...
  MySpaceResults: ResolverTypeWrapper<Omit<SchemaTypes.MySpaceResults, 'latestActivity' | 'space'> & { latestActivity?: SchemaTypes.Maybe<ResolversTypes['ActivityLogEntry']>, space: ResolversTypes['Space'] }>;
  ...
  NotificationRecipientResult: ResolverTypeWrapper<Omit<SchemaTypes.NotificationRecipientResult, 'emailRecipients' | 'inAppRecipients' | 'pushRecipients' | 'triggeredBy'> & { emailRecipients: Array<ResolversTypes['User']>, inAppRecipients: Array<ResolversTypes['User']>, pushRecipients: Array<ResolversTypes['User']>, triggeredBy?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  Organization: ResolverTypeWrapper<Omit<SchemaTypes.Organization, 'account' | 'actor' | 'credentials' | 'group' | 'groups' | 'profile' | 'roleSet'> & { account?: SchemaTypes.Maybe<ResolversTypes['Account']>, actor: ResolversTypes['Actor'], credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, group?: SchemaTypes.Maybe<ResolversTypes['UserGroup']>, groups?: SchemaTypes.Maybe<Array<ResolversTypes['UserGroup']>>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']>, roleSet: ResolversTypes['RoleSet'] }>;
  ...
  OrganizationsInRolesResponse: ResolverTypeWrapper<Omit<SchemaTypes.OrganizationsInRolesResponse, 'organizations'> & { organizations: Array<ResolversTypes['Organization']> }>;
  OryConfig: ResolverTypeWrapper<SchemaTypes.OryConfig>;
  PageInfo: ResolverTypeWrapper<SchemaTypes.PageInfo>;
  PaginatedInAppNotifications: ResolverTypeWrapper<Omit<SchemaTypes.PaginatedInAppNotifications, 'inAppNotifications'> & { inAppNotifications: Array<ResolversTypes['InAppNotification']> }>;
  PaginatedInnovationPacks: ResolverTypeWrapper<Omit<SchemaTypes.PaginatedInnovationPacks, 'innovationPacks'> & { innovationPacks: Array<ResolversTypes['InnovationPack']> }>;
  PaginatedLibraryTemplateResults: ResolverTypeWrapper<Omit<SchemaTypes.PaginatedLibraryTemplateResults, 'templateResults'> & { templateResults: Array<ResolversTypes['TemplateResult']> }>;
  PaginatedOrganization: ResolverTypeWrapper<Omit<SchemaTypes.PaginatedOrganization, 'organization'> & { organization: Array<ResolversTypes['Organization']> }>;
  PaginatedSpaces: ResolverTypeWrapper<Omit<SchemaTypes.PaginatedSpaces, 'spaces'> & { spaces: Array<ResolversTypes['Space']> }>;
  PaginatedUsers: ResolverTypeWrapper<Omit<SchemaTypes.PaginatedUsers, 'users'> & { users: Array<ResolversTypes['User']> }>;
  PaginatedVirtualContributor: ResolverTypeWrapper<SchemaTypes.PaginatedVirtualContributor>;
  Platform: ResolverTypeWrapper<Omit<SchemaTypes.Platform, 'configuration' | 'forum' | 'innovationHub' | 'library' | 'roleSet'> & { configuration: ResolversTypes['Config'], forum: ResolversTypes['Forum'], innovationHub?: SchemaTypes.Maybe<ResolversTypes['InnovationHub']>, library: ResolversTypes['Library'], roleSet: ResolversTypes['RoleSet'] }>;
  ...
  PlatformAdminQueryResults: ResolverTypeWrapper<Omit<SchemaTypes.PlatformAdminQueryResults, 'accounts' | 'innovationHubs' | 'innovationPacks' | 'organizations' | 'spaces' | 'virtualAssistant'> & { accounts: Array<ResolversTypes['Account']>, innovationHubs: Array<ResolversTypes['InnovationHub']>, innovationPacks: Array<ResolversTypes['InnovationPack']>, organizations: ResolversTypes['PaginatedOrganization'], spaces: Array<ResolversTypes['Space']>, virtualAssistant: ResolversTypes['VirtualAssistant'] }>;
  ...
  PlatformInvitation: ResolverTypeWrapper<Omit<SchemaTypes.PlatformInvitation, 'createdBy'> & { createdBy: ResolversTypes['User'] }>;
  ...
  PollOption: ResolverTypeWrapper<Omit<SchemaTypes.PollOption, 'voters'> & { voters?: SchemaTypes.Maybe<Array<ResolversTypes['User']>> }>;
  ...
  Post: ResolverTypeWrapper<Omit<SchemaTypes.Post, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']>, profile: ResolversTypes['Profile'] }>;
  Profile: ResolverTypeWrapper<Omit<SchemaTypes.Profile, 'references' | 'storageBucket'> & { references?: SchemaTypes.Maybe<Array<ResolversTypes['Reference']>>, storageBucket: ResolversTypes['StorageBucket'] }>;
  ...
  Reaction: ResolverTypeWrapper<Omit<SchemaTypes.Reaction, 'sender'> & { sender?: SchemaTypes.Maybe<ResolversTypes['User']> }>;
  ...
  RelayPaginatedSpace: ResolverTypeWrapper<Omit<SchemaTypes.RelayPaginatedSpace, 'about' | 'account' | 'actor' | 'collaboration' | 'community' | 'credentials' | 'mentionableContributors' | 'profile' | 'subspaceByNameID' | 'subspaces'> & { about: ResolversTypes['SpaceAbout'], account: ResolversTypes['Account'], actor: ResolversTypes['Actor'], collaboration: ResolversTypes['Collaboration'], community: ResolversTypes['Community'], credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, mentionableContributors: Array<ResolversTypes['ActorFull']>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']>, subspaceByNameID: ResolversTypes['Space'], subspaces: Array<ResolversTypes['Space']> }>;
  RelayPaginatedSpaceEdge: ResolverTypeWrapper<Omit<SchemaTypes.RelayPaginatedSpaceEdge, 'node'> & { node: ResolversTypes['RelayPaginatedSpace'] }>;
  ...
  RoleSet: ResolverTypeWrapper<Omit<SchemaTypes.RoleSet, 'invitations' | 'organizationsInRole' | 'organizationsInRoles' | 'usersInRole'> & { invitations: Array<ResolversTypes['Invitation']>, organizationsInRole: Array<ResolversTypes['Organization']>, organizationsInRoles: Array<ResolversTypes['OrganizationsInRolesResponse']>, usersInRole: Array<ResolversTypes['User']> }>;
  RoleSetInvitationResult: ResolverTypeWrapper<Omit<SchemaTypes.RoleSetInvitationResult, 'invitation'> & { invitation?: SchemaTypes.Maybe<ResolversTypes['Invitation']> }>;
  ...
  SearchCursor: ResolverTypeWrapper<SchemaTypes.Scalars['SearchCursor']['output']>;
  ...
  SearchResultCallout: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultCallout, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  SearchResultCollaboraDocument: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultCollaboraDocument, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  SearchResultMemo: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultMemo, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  SearchResultOrganization: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultOrganization, 'organization'> & { organization: ResolversTypes['Organization'] }>;
  SearchResultPost: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultPost, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  SearchResultSpace: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultSpace, 'parentSpace' | 'space'> & { parentSpace?: SchemaTypes.Maybe<ResolversTypes['Space']>, space: ResolversTypes['Space'] }>;
  SearchResultType: SchemaTypes.SearchResultType;
  SearchResultUser: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultUser, 'user'> & { user: ResolversTypes['User'] }>;
  SearchResultWhiteboard: ResolverTypeWrapper<Omit<SchemaTypes.SearchResultWhiteboard, 'callout' | 'space'> & { callout: ResolversTypes['Callout'], space: ResolversTypes['Space'] }>;
  ...
  Space: ResolverTypeWrapper<Omit<SchemaTypes.Space, 'about' | 'account' | 'actor' | 'collaboration' | 'community' | 'credentials' | 'mentionableContributors' | 'profile' | 'subspaceByNameID' | 'subspaces'> & { about: ResolversTypes['SpaceAbout'], account: ResolversTypes['Account'], actor: ResolversTypes['Actor'], collaboration: ResolversTypes['Collaboration'], community: ResolversTypes['Community'], credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, mentionableContributors: Array<ResolversTypes['ActorFull']>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']>, subspaceByNameID: ResolversTypes['Space'], subspaces: Array<ResolversTypes['Space']> }>;
  SpaceAbout: ResolverTypeWrapper<Omit<SchemaTypes.SpaceAbout, 'guidelines' | 'membership' | 'profile' | 'provider'> & { guidelines: ResolversTypes['CommunityGuidelines'], membership: ResolversTypes['SpaceAboutMembership'], profile: ResolversTypes['Profile'], provider?: SchemaTypes.Maybe<ResolversTypes['Actor']> }>;
  SpaceAboutMembership: ResolverTypeWrapper<Omit<SchemaTypes.SpaceAboutMembership, 'leadOrganizations' | 'leadUsers'> & { leadOrganizations: Array<ResolversTypes['Organization']>, leadUsers: Array<ResolversTypes['User']> }>;
  SpaceFilterInput: SchemaTypes.SpaceFilterInput;
  SpaceLevel: SchemaTypes.SpaceLevel;
  SpacePendingMembershipInfo: ResolverTypeWrapper<Omit<SchemaTypes.SpacePendingMembershipInfo, 'about' | 'communityGuidelines'> & { about: ResolversTypes['SpaceAbout'], communityGuidelines: ResolversTypes['CommunityGuidelines'] }>;
  ...
  StorageAggregator: ResolverTypeWrapper<Omit<SchemaTypes.StorageAggregator, 'directStorageBucket' | 'storageBuckets'> & { directStorageBucket: ResolversTypes['StorageBucket'], storageBuckets: Array<ResolversTypes['StorageBucket']> }>;
  ...
  StorageBucket: ResolverTypeWrapper<Omit<SchemaTypes.StorageBucket, 'document' | 'documents'> & { document?: SchemaTypes.Maybe<ResolversTypes['Document']>, documents: Array<ResolversTypes['Document']> }>;
  ...
  SubspaceCreated: ResolverTypeWrapper<Omit<SchemaTypes.SubspaceCreated, 'subspace'> & { subspace: ResolversTypes['Space'] }>;
  ...
  Template: ResolverTypeWrapper<Omit<SchemaTypes.Template, 'callout' | 'communityGuidelines' | 'contentSpace' | 'profile'> & { callout?: SchemaTypes.Maybe<ResolversTypes['Callout']>, communityGuidelines?: SchemaTypes.Maybe<ResolversTypes['CommunityGuidelines']>, contentSpace?: SchemaTypes.Maybe<ResolversTypes['TemplateContentSpace']>, profile: ResolversTypes['Profile'] }>;
  TemplateContentSpace: ResolverTypeWrapper<Omit<SchemaTypes.TemplateContentSpace, 'about' | 'collaboration' | 'subspaces'> & { about: ResolversTypes['SpaceAbout'], collaboration: ResolversTypes['Collaboration'], subspaces: Array<ResolversTypes['TemplateContentSpace']> }>;
  TemplateDefault: ResolverTypeWrapper<Omit<SchemaTypes.TemplateDefault, 'template'> & { template?: SchemaTypes.Maybe<ResolversTypes['Template']> }>;
  TemplateDefaultType: SchemaTypes.TemplateDefaultType;
  TemplateResult: ResolverTypeWrapper<Omit<SchemaTypes.TemplateResult, 'innovationPack' | 'template'> & { innovationPack: ResolversTypes['InnovationPack'], template: ResolversTypes['Template'] }>;
  TemplateType: SchemaTypes.TemplateType;
  TemplatesManager: ResolverTypeWrapper<Omit<SchemaTypes.TemplatesManager, 'templatesSet'> & { templatesSet?: SchemaTypes.Maybe<ResolversTypes['TemplatesSet']> }>;
  TemplatesSet: ResolverTypeWrapper<Omit<SchemaTypes.TemplatesSet, 'calloutTemplates' | 'classificationTemplates' | 'communityGuidelinesTemplates' | 'postTemplates' | 'spaceTemplates' | 'templates' | 'whiteboardTemplates'> & { calloutTemplates: Array<ResolversTypes['Template']>, classificationTemplates: Array<ResolversTypes['Template']>, communityGuidelinesTemplates: Array<ResolversTypes['Template']>, postTemplates: Array<ResolversTypes['Template']>, spaceTemplates: Array<ResolversTypes['Template']>, templates: Array<ResolversTypes['Template']>, whiteboardTemplates: Array<ResolversTypes['Template']> }>;
  Timeline: ResolverTypeWrapper<Omit<SchemaTypes.Timeline, 'calendar'> & { calendar: ResolversTypes['Calendar'] }>;
  ...
  User: ResolverTypeWrapper<Omit<SchemaTypes.User, 'account' | 'actor' | 'credentials' | 'profile'> & { account?: SchemaTypes.Maybe<ResolversTypes['Account']>, actor: ResolversTypes['Actor'], credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']> }>;
  ...
  UserGroup: ResolverTypeWrapper<Omit<SchemaTypes.UserGroup, 'members' | 'parent' | 'profile'> & { members?: SchemaTypes.Maybe<Array<ResolversTypes['User']>>, parent?: SchemaTypes.Maybe<ResolversTypes['Groupable']>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']> }>;
  ...
  UsersInRolesResponse: ResolverTypeWrapper<Omit<SchemaTypes.UsersInRolesResponse, 'users'> & { users: Array<ResolversTypes['User']> }>;
  ...
  VirtualAssistant: ResolverTypeWrapper<Omit<SchemaTypes.VirtualAssistant, 'credentials' | 'profile'> & { credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']> }>;
  VirtualContributor: ResolverTypeWrapper<Omit<SchemaTypes.VirtualContributor, 'account' | 'actor' | 'credentials' | 'knowledgeSpace' | 'profile' | 'provider'> & { account?: SchemaTypes.Maybe<ResolversTypes['Account']>, actor: ResolversTypes['Actor'], credentials?: SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, knowledgeSpace?: SchemaTypes.Maybe<ResolversTypes['Space']>, profile?: SchemaTypes.Maybe<ResolversTypes['Profile']>, provider: ResolversTypes['Actor'] }>;
  ...
  Whiteboard: ResolverTypeWrapper<Omit<SchemaTypes.Whiteboard, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversTypes['User']>, profile: ResolversTypes['Profile'] }>;
...
export type ResolversParentTypes = {
  APM: SchemaTypes.Apm;
  Account: Omit<SchemaTypes.Account, 'actor' | 'baselineLicensePlan' | 'credentials' | 'host' | 'innovationHubs' | 'innovationPacks' | 'profile' | 'spaces'> & { actor: ResolversParentTypes['Actor'], baselineLicensePlan: ResolversParentTypes['AccountLicensePlan'], credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, host?: SchemaTypes.Maybe<ResolversParentTypes['Actor']>, innovationHubs: Array<ResolversParentTypes['InnovationHub']>, innovationPacks: Array<ResolversParentTypes['InnovationPack']>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']>, spaces: Array<ResolversParentTypes['Space']> };
  AccountAuthorizationResetInput: SchemaTypes.AccountAuthorizationResetInput;
  ...
  ActivityCreatedSubscriptionInput: SchemaTypes.ActivityCreatedSubscriptionInput;
  ActivityCreatedSubscriptionResult: Omit<SchemaTypes.ActivityCreatedSubscriptionResult, 'activity'> & { activity: ResolversParentTypes['ActivityLogEntry'] };
  ActivityFeed: Omit<SchemaTypes.ActivityFeed, 'activityFeed'> & { activityFeed: Array<ResolversParentTypes['ActivityLogEntry']> };
  ActivityFeedGroupedQueryArgs: SchemaTypes.ActivityFeedGroupedQueryArgs;
  ActivityFeedQueryArgs: SchemaTypes.ActivityFeedQueryArgs;
  ActivityLogEntry: ResolversInterfaceTypes<ResolversParentTypes>['ActivityLogEntry'];
  ActivityLogEntryCalendarEventCreated: Omit<SchemaTypes.ActivityLogEntryCalendarEventCreated, 'calendar' | 'calendarEvent' | 'space' | 'triggeredBy'> & { calendar: ResolversParentTypes['Calendar'], calendarEvent: ResolversParentTypes['CalendarEvent'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutDiscussionComment: Omit<SchemaTypes.ActivityLogEntryCalloutDiscussionComment, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutLinkCreated: Omit<SchemaTypes.ActivityLogEntryCalloutLinkCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutMemoCreated: Omit<SchemaTypes.ActivityLogEntryCalloutMemoCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutPostComment: Omit<SchemaTypes.ActivityLogEntryCalloutPostComment, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutPostCreated: Omit<SchemaTypes.ActivityLogEntryCalloutPostCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutPublished: Omit<SchemaTypes.ActivityLogEntryCalloutPublished, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutWhiteboardContentModified: Omit<SchemaTypes.ActivityLogEntryCalloutWhiteboardContentModified, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryCalloutWhiteboardCreated: Omit<SchemaTypes.ActivityLogEntryCalloutWhiteboardCreated, 'callout' | 'space' | 'triggeredBy'> & { callout: ResolversParentTypes['Callout'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryMemberJoined: Omit<SchemaTypes.ActivityLogEntryMemberJoined, 'actor' | 'community' | 'space' | 'triggeredBy'> & { actor: ResolversParentTypes['Actor'], community: ResolversParentTypes['Community'], space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntrySubspaceCreated: Omit<SchemaTypes.ActivityLogEntrySubspaceCreated, 'space' | 'subspace' | 'triggeredBy'> & { space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, subspace: ResolversParentTypes['Space'], triggeredBy: ResolversParentTypes['User'] };
  ActivityLogEntryUpdateSent: Omit<SchemaTypes.ActivityLogEntryUpdateSent, 'space' | 'triggeredBy'> & { space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, triggeredBy: ResolversParentTypes['User'] };
  ActivityLogInput: SchemaTypes.ActivityLogInput;
  Actor: Omit<SchemaTypes.Actor, 'credentials' | 'profile'> & { credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']> };
  ActorFilterInput: SchemaTypes.ActorFilterInput;
  ...
  Application: Omit<SchemaTypes.Application, 'actor' | 'user'> & { actor: ResolversParentTypes['Actor'], user?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  ApplicationEventInput: SchemaTypes.ApplicationEventInput;
  ApplyForEntryRoleOnRoleSetInput: SchemaTypes.ApplyForEntryRoleOnRoleSetInput;
  AssignConversationMemberInput: SchemaTypes.AssignConversationMemberInput;
  AssignLicensePlanToAccount: SchemaTypes.AssignLicensePlanToAccount;
  ...
  AssistantCapabilityToggleInput: SchemaTypes.AssistantCapabilityToggleInput;
  AuthenticationConfig: Omit<SchemaTypes.AuthenticationConfig, 'providers'> & { providers: Array<ResolversParentTypes['AuthenticationProviderConfig']> };
  ...
  Calendar: Omit<SchemaTypes.Calendar, 'event' | 'events'> & { event?: SchemaTypes.Maybe<ResolversParentTypes['CalendarEvent']>, events: Array<ResolversParentTypes['CalendarEvent']> };
  CalendarEvent: Omit<SchemaTypes.CalendarEvent, 'createdBy' | 'profile' | 'subspace'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']>, profile: ResolversParentTypes['Profile'], subspace?: SchemaTypes.Maybe<ResolversParentTypes['Space']> };
  Callout: Omit<SchemaTypes.Callout, 'contributionDefaults' | 'createdBy' | 'framing' | 'publishedBy'> & { contributionDefaults: ResolversParentTypes['CalloutContributionDefaults'], createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']>, framing: ResolversParentTypes['CalloutFraming'], publishedBy?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  CalloutContribution: Omit<SchemaTypes.CalloutContribution, 'createdBy'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  ...
  CalloutFraming: Omit<SchemaTypes.CalloutFraming, 'contributorCounts' | 'profile' | 'subspaces'> & { contributorCounts: ResolversParentTypes['ContributorCollectionCounts'], profile: ResolversParentTypes['Profile'], subspaces: Array<ResolversParentTypes['Space']> };
  CalloutPostCreated: SchemaTypes.CalloutPostCreated;
  CalloutReaction: Omit<SchemaTypes.CalloutReaction, 'user'> & { user?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  ...
  CalloutsSet: Omit<SchemaTypes.CalloutsSet, 'callouts'> & { callouts: Array<ResolversParentTypes['Callout']> };
  CastPollVoteInput: SchemaTypes.CastPollVoteInput;
  ...
  CollaboraDocument: Omit<SchemaTypes.CollaboraDocument, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']>, profile: ResolversParentTypes['Profile'] };
  CollaboraEditorUrlResult: SchemaTypes.CollaboraEditorUrlResult;
  Collaboration: Omit<SchemaTypes.Collaboration, 'timeline'> & { timeline: ResolversParentTypes['Timeline'] };
  ...
  CommunicationSendMessageToOrganizationInput: SchemaTypes.CommunicationSendMessageToOrganizationInput;
  CommunicationSendMessageToUsersInput: SchemaTypes.CommunicationSendMessageToUsersInput;
  Community: Omit<SchemaTypes.Community, 'communication' | 'group' | 'groups' | 'roleSet'> & { communication: ResolversParentTypes['Communication'], group: ResolversParentTypes['UserGroup'], groups: Array<ResolversParentTypes['UserGroup']>, roleSet: ResolversParentTypes['RoleSet'] };
  CommunityApplicationForRoleResult: SchemaTypes.CommunityApplicationForRoleResult;
  CommunityApplicationResult: Omit<SchemaTypes.CommunityApplicationResult, 'spacePendingMembershipInfo'> & { spacePendingMembershipInfo: ResolversParentTypes['SpacePendingMembershipInfo'] };
  CommunityGuidelines: Omit<SchemaTypes.CommunityGuidelines, 'profile'> & { profile: ResolversParentTypes['Profile'] };
  CommunityInvitationForRoleResult: SchemaTypes.CommunityInvitationForRoleResult;
  CommunityInvitationResult: Omit<SchemaTypes.CommunityInvitationResult, 'invitation' | 'spacePendingMembershipInfo'> & { invitation: ResolversParentTypes['Invitation'], spacePendingMembershipInfo: ResolversParentTypes['SpacePendingMembershipInfo'] };
  CommunityMembershipResult: Omit<SchemaTypes.CommunityMembershipResult, 'childMemberships' | 'space'> & { childMemberships: Array<ResolversParentTypes['CommunityMembershipResult']>, space: ResolversParentTypes['Space'] };
  Config: Omit<SchemaTypes.Config, 'authentication'> & { authentication: ResolversParentTypes['AuthenticationConfig'] };
  ContributionsFilterInput: SchemaTypes.ContributionsFilterInput;
  ...
  Conversation: Omit<SchemaTypes.Conversation, 'members'> & { members: Array<ResolversParentTypes['Actor']> };
  ConversationCreatedEvent: Omit<SchemaTypes.ConversationCreatedEvent, 'conversation'> & { conversation: ResolversParentTypes['Conversation'] };
  ConversationDeletedEvent: SchemaTypes.ConversationDeletedEvent;
  ConversationEventSubscriptionResult: Omit<SchemaTypes.ConversationEventSubscriptionResult, 'conversationCreated' | 'conversationUpdated' | 'memberAdded' | 'memberRemoved'> & { conversationCreated?: SchemaTypes.Maybe<ResolversParentTypes['ConversationCreatedEvent']>, conversationUpdated?: SchemaTypes.Maybe<ResolversParentTypes['ConversationUpdatedEvent']>, memberAdded?: SchemaTypes.Maybe<ResolversParentTypes['ConversationMemberAddedEvent']>, memberRemoved?: SchemaTypes.Maybe<ResolversParentTypes['ConversationMemberRemovedEvent']> };
  ConversationMemberAddedEvent: Omit<SchemaTypes.ConversationMemberAddedEvent, 'addedMember' | 'conversation'> & { addedMember: ResolversParentTypes['Actor'], conversation: ResolversParentTypes['Conversation'] };
  ConversationMemberRemovedEvent: Omit<SchemaTypes.ConversationMemberRemovedEvent, 'conversation'> & { conversation: ResolversParentTypes['Conversation'] };
  ...
  ConversationUpdatedEvent: Omit<SchemaTypes.ConversationUpdatedEvent, 'conversation'> & { conversation: ResolversParentTypes['Conversation'] };
  ConversationVcResetInput: SchemaTypes.ConversationVcResetInput;
  ConversionVcSpaceToVcKnowledgeBaseInput: SchemaTypes.ConversionVcSpaceToVcKnowledgeBaseInput;
  ConvertSpaceL1ToSpaceL0Input: SchemaTypes.ConvertSpaceL1ToSpaceL0Input;
  ConvertSpaceL1ToSpaceL2Input: SchemaTypes.ConvertSpaceL1ToSpaceL2Input;
  ...
  Discussion: Omit<SchemaTypes.Discussion, 'profile'> & { profile: ResolversParentTypes['Profile'] };
  DiscussionDetails: SchemaTypes.DiscussionDetails;
  DiscussionsInput: SchemaTypes.DiscussionsInput;
  Document: Omit<SchemaTypes.Document, 'createdBy'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  ...
  Forum: Omit<SchemaTypes.Forum, 'discussion' | 'discussions' | 'mentionableContributors'> & { discussion?: SchemaTypes.Maybe<ResolversParentTypes['Discussion']>, discussions?: SchemaTypes.Maybe<Array<ResolversParentTypes['Discussion']>>, mentionableContributors: Array<ResolversParentTypes['ActorFull']> };
  ForumCreateDiscussionInput: SchemaTypes.ForumCreateDiscussionInput;
  Geo: SchemaTypes.Geo;
  ...
  ISearchCategoryResult: Omit<SchemaTypes.ISearchCategoryResult, 'results'> & { results: Array<ResolversParentTypes['SearchResult']> };
  ISearchResults: Omit<SchemaTypes.ISearchResults, 'actorResults' | 'calloutResults' | 'contributionResults' | 'framingResults' | 'spaceResults'> & { actorResults: ResolversParentTypes['ISearchCategoryResult'], calloutResults: ResolversParentTypes['ISearchCategoryResult'], contributionResults: ResolversParentTypes['ISearchCategoryResult'], framingResults: ResolversParentTypes['ISearchCategoryResult'], spaceResults: ResolversParentTypes['ISearchCategoryResult'] };
  ImportCollaboraDocumentInput: SchemaTypes.ImportCollaboraDocumentInput;
  InAppNotification: Omit<SchemaTypes.InAppNotification, 'payload' | 'receiver' | 'triggeredBy'> & { payload: ResolversParentTypes['InAppNotificationPayload'], receiver: ResolversParentTypes['Actor'], triggeredBy?: SchemaTypes.Maybe<ResolversParentTypes['Actor']> };
  InAppNotificationPayload: ResolversInterfaceTypes<ResolversParentTypes>['InAppNotificationPayload'];
  InAppNotificationPayloadOrganizationMessageDirect: Omit<SchemaTypes.InAppNotificationPayloadOrganizationMessageDirect, 'organization'> & { organization?: SchemaTypes.Maybe<ResolversParentTypes['Organization']> };
  InAppNotificationPayloadOrganizationMessageRoom: Omit<SchemaTypes.InAppNotificationPayloadOrganizationMessageRoom, 'organization'> & { organization: ResolversParentTypes['Organization'] };
  InAppNotificationPayloadPlatformForumDiscussion: SchemaTypes.InAppNotificationPayloadPlatformForumDiscussion;
  InAppNotificationPayloadPlatformGlobalRoleChange: Omit<SchemaTypes.InAppNotificationPayloadPlatformGlobalRoleChange, 'user'> & { user?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  InAppNotificationPayloadPlatformUser: SchemaTypes.InAppNotificationPayloadPlatformUser;
  InAppNotificationPayloadPlatformUserMessageRoom: Omit<SchemaTypes.InAppNotificationPayloadPlatformUserMessageRoom, 'user'> & { user: ResolversParentTypes['User'] };
  InAppNotificationPayloadPlatformUserProfileRemoved: SchemaTypes.InAppNotificationPayloadPlatformUserProfileRemoved;
  InAppNotificationPayloadSpace: Omit<SchemaTypes.InAppNotificationPayloadSpace, 'space'> & { space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCollaborationCallout: Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCallout, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCollaborationCalloutComment: Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutComment, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCollaborationCalloutPostComment: Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutPostComment, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCollaborationCalloutReaction: Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationCalloutReaction, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCollaborationPoll: Omit<SchemaTypes.InAppNotificationPayloadSpaceCollaborationPoll, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunicationMessageDirect: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunicationMessageDirect, 'space'> & { space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunicationUpdate: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunicationUpdate, 'space'> & { space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunityActor: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityActor, 'actor' | 'space'> & { actor: ResolversParentTypes['Actor'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunityApplication: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityApplication, 'space'> & { space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunityCalendarEvent: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityCalendarEvent, 'calendarEvent' | 'space'> & { calendarEvent: ResolversParentTypes['CalendarEvent'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunityCalendarEventComment: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityCalendarEventComment, 'calendarEvent' | 'space'> & { calendarEvent: ResolversParentTypes['CalendarEvent'], space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunityInvitation: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityInvitation, 'space'> & { space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadSpaceCommunityInvitationPlatform: Omit<SchemaTypes.InAppNotificationPayloadSpaceCommunityInvitationPlatform, 'space'> & { space: ResolversParentTypes['Space'] };
  InAppNotificationPayloadUserMessageDirect: Omit<SchemaTypes.InAppNotificationPayloadUserMessageDirect, 'user'> & { user?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  InAppNotificationPayloadVirtualContributor: Omit<SchemaTypes.InAppNotificationPayloadVirtualContributor, 'space'> & { space: ResolversParentTypes['Space'] };
  InnovationFlow: Omit<SchemaTypes.InnovationFlow, 'profile'> & { profile: ResolversParentTypes['Profile'] };
  InnovationFlowSettings: SchemaTypes.InnovationFlowSettings;
  InnovationFlowState: Omit<SchemaTypes.InnovationFlowState, 'defaultCalloutTemplate'> & { defaultCalloutTemplate?: SchemaTypes.Maybe<ResolversParentTypes['Template']> };
  InnovationFlowStateSettings: SchemaTypes.InnovationFlowStateSettings;
  InnovationHub: Omit<SchemaTypes.InnovationHub, 'account' | 'innovationPackListFilter' | 'profile' | 'provider' | 'spaceListFilter'> & { account: ResolversParentTypes['Account'], innovationPackListFilter?: SchemaTypes.Maybe<Array<ResolversParentTypes['InnovationPack']>>, profile: ResolversParentTypes['Profile'], provider: ResolversParentTypes['Actor'], spaceListFilter?: SchemaTypes.Maybe<Array<ResolversParentTypes['Space']>> };
  InnovationPack: Omit<SchemaTypes.InnovationPack, 'profile' | 'provider' | 'templatesSet'> & { profile: ResolversParentTypes['Profile'], provider: ResolversParentTypes['Actor'], templatesSet?: SchemaTypes.Maybe<ResolversParentTypes['TemplatesSet']> };
  InnovationPacksInput: SchemaTypes.InnovationPacksInput;
  InputCreatorQueryResults: SchemaTypes.InputCreatorQueryResults;
  Int: SchemaTypes.Scalars['Int']['output'];
  Invitation: Omit<SchemaTypes.Invitation, 'actor' | 'createdBy'> & { actor: ResolversParentTypes['Actor'], createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  InvitationEventInput: SchemaTypes.InvitationEventInput;
  InviteForEntryRoleOnRoleSetInput: SchemaTypes.InviteForEntryRoleOnRoleSetInput;
  JoinAsEntryRoleOnRoleSetInput: SchemaTypes.JoinAsEntryRoleOnRoleSetInput;
  KnowledgeBase: Omit<SchemaTypes.KnowledgeBase, 'profile'> & { profile: ResolversParentTypes['Profile'] };
  ...
  LeaveConversationInput: SchemaTypes.LeaveConversationInput;
  Library: Omit<SchemaTypes.Library, 'innovationHubs' | 'innovationPacks' | 'innovationPacksPaginated' | 'templates' | 'templatesPaginated'> & { innovationHubs: Array<ResolversParentTypes['InnovationHub']>, innovationPacks: Array<ResolversParentTypes['InnovationPack']>, innovationPacksPaginated: ResolversParentTypes['PaginatedInnovationPacks'], templates: Array<ResolversParentTypes['TemplateResult']>, templatesPaginated: ResolversParentTypes['PaginatedLibraryTemplateResults'] };
  LibraryInnovationPacksFilterInput: SchemaTypes.LibraryInnovationPacksFilterInput;
  LibraryTemplatesFilterInput: SchemaTypes.LibraryTemplatesFilterInput;
  ...
  Link: Omit<SchemaTypes.Link, 'profile'> & { profile: ResolversParentTypes['Profile'] };
  Location: SchemaTypes.Location;
  LookupByNameQueryResults: Omit<SchemaTypes.LookupByNameQueryResults, 'space'> & { space?: SchemaTypes.Maybe<ResolversParentTypes['Space']> };
  LookupMyPrivilegesQueryResults: SchemaTypes.LookupMyPrivilegesQueryResults;
  LookupQueryResults: Omit<SchemaTypes.LookupQueryResults, 'about' | 'account' | 'calendar' | 'calendarEvent' | 'callout' | 'collaboration' | 'community' | 'communityGuidelines' | 'conversation' | 'document' | 'innovationHub' | 'innovationPack' | 'invitation' | 'organization' | 'profile' | 'roleSet' | 'space' | 'storageBucket' | 'template' | 'templateContentSpace' | 'templatesSet' | 'user'> & { about?: SchemaTypes.Maybe<ResolversParentTypes['SpaceAbout']>, account?: SchemaTypes.Maybe<ResolversParentTypes['Account']>, calendar?: SchemaTypes.Maybe<ResolversParentTypes['Calendar']>, calendarEvent?: SchemaTypes.Maybe<ResolversParentTypes['CalendarEvent']>, callout?: SchemaTypes.Maybe<ResolversParentTypes['Callout']>, collaboration?: SchemaTypes.Maybe<ResolversParentTypes['Collaboration']>, community?: SchemaTypes.Maybe<ResolversParentTypes['Community']>, communityGuidelines?: SchemaTypes.Maybe<ResolversParentTypes['CommunityGuidelines']>, conversation?: SchemaTypes.Maybe<ResolversParentTypes['Conversation']>, document?: SchemaTypes.Maybe<ResolversParentTypes['Document']>, innovationHub?: SchemaTypes.Maybe<ResolversParentTypes['InnovationHub']>, innovationPack?: SchemaTypes.Maybe<ResolversParentTypes['InnovationPack']>, invitation?: SchemaTypes.Maybe<ResolversParentTypes['Invitation']>, organization?: SchemaTypes.Maybe<ResolversParentTypes['Organization']>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']>, roleSet?: SchemaTypes.Maybe<ResolversParentTypes['RoleSet']>, space?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, storageBucket?: SchemaTypes.Maybe<ResolversParentTypes['StorageBucket']>, template?: SchemaTypes.Maybe<ResolversParentTypes['Template']>, templateContentSpace?: SchemaTypes.Maybe<ResolversParentTypes['TemplateContentSpace']>, templatesSet?: SchemaTypes.Maybe<ResolversParentTypes['TemplatesSet']>, user?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  ...
  MeConversationsResult: Omit<SchemaTypes.MeConversationsResult, 'conversations'> & { conversations: Array<ResolversParentTypes['Conversation']> };
  MeQueryResults: Omit<SchemaTypes.MeQueryResults, 'communityApplications' | 'communityInvitations' | 'conversations' | 'mySpaces' | 'notifications' | 'spaceMembershipsFlat' | 'spaceMembershipsHierarchical' | 'user'> & { communityApplications: Array<ResolversParentTypes['CommunityApplicationResult']>, communityInvitations: Array<ResolversParentTypes['CommunityInvitationResult']>, conversations: ResolversParentTypes['MeConversationsResult'], mySpaces: Array<ResolversParentTypes['MySpaceResults']>, notifications: ResolversParentTypes['PaginatedInAppNotifications'], spaceMembershipsFlat: Array<ResolversParentTypes['CommunityMembershipResult']>, spaceMembershipsHierarchical: Array<ResolversParentTypes['CommunityMembershipResult']>, user?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  MediaGallery: Omit<SchemaTypes.MediaGallery, 'storageBucket'> & { storageBucket?: SchemaTypes.Maybe<ResolversParentTypes['StorageBucket']> };
  Memo: Omit<SchemaTypes.Memo, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']>, profile: ResolversParentTypes['Profile'] };
  MemoSignature: Omit<SchemaTypes.MemoSignature, 'actor' | 'document'> & { actor?: SchemaTypes.Maybe<ResolversParentTypes['User']>, document?: SchemaTypes.Maybe<ResolversParentTypes['Document']> };
  MemoSignatureVerifyInput: SchemaTypes.MemoSignatureVerifyInput;
  MemoSigningContinueInput: SchemaTypes.MemoSigningContinueInput;
  ...
  Message: Omit<SchemaTypes.Message, 'sender'> & { sender?: SchemaTypes.Maybe<ResolversParentTypes['Actor']> };
  ...
  MySpaceResults: Omit<SchemaTypes.MySpaceResults, 'latestActivity' | 'space'> & { latestActivity?: SchemaTypes.Maybe<ResolversParentTypes['ActivityLogEntry']>, space: ResolversParentTypes['Space'] };
  NVP: SchemaTypes.Nvp;
  NameID: SchemaTypes.Scalars['NameID']['output'];
  NotificationEmailAddressInput: SchemaTypes.NotificationEmailAddressInput;
  NotificationEventsFilterInput: SchemaTypes.NotificationEventsFilterInput;
  NotificationRecipientResult: Omit<SchemaTypes.NotificationRecipientResult, 'emailRecipients' | 'inAppRecipients' | 'pushRecipients' | 'triggeredBy'> & { emailRecipients: Array<ResolversParentTypes['User']>, inAppRecipients: Array<ResolversParentTypes['User']>, pushRecipients: Array<ResolversParentTypes['User']>, triggeredBy?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  NotificationRecipientsInput: SchemaTypes.NotificationRecipientsInput;
  NotificationSettingInput: SchemaTypes.NotificationSettingInput;
  Organization: Omit<SchemaTypes.Organization, 'account' | 'actor' | 'credentials' | 'group' | 'groups' | 'profile' | 'roleSet'> & { account?: SchemaTypes.Maybe<ResolversParentTypes['Account']>, actor: ResolversParentTypes['Actor'], credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, group?: SchemaTypes.Maybe<ResolversParentTypes['UserGroup']>, groups?: SchemaTypes.Maybe<Array<ResolversParentTypes['UserGroup']>>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']>, roleSet: ResolversParentTypes['RoleSet'] };
  OrganizationAuthorizationResetInput: SchemaTypes.OrganizationAuthorizationResetInput;
  OrganizationFilterInput: SchemaTypes.OrganizationFilterInput;
  ...
  OrganizationVerificationEventInput: SchemaTypes.OrganizationVerificationEventInput;
  OrganizationsInRolesResponse: Omit<SchemaTypes.OrganizationsInRolesResponse, 'organizations'> & { organizations: Array<ResolversParentTypes['Organization']> };
  OryConfig: SchemaTypes.OryConfig;
  PageInfo: SchemaTypes.PageInfo;
  PaginatedInAppNotifications: Omit<SchemaTypes.PaginatedInAppNotifications, 'inAppNotifications'> & { inAppNotifications: Array<ResolversParentTypes['InAppNotification']> };
  PaginatedInnovationPacks: Omit<SchemaTypes.PaginatedInnovationPacks, 'innovationPacks'> & { innovationPacks: Array<ResolversParentTypes['InnovationPack']> };
  PaginatedLibraryTemplateResults: Omit<SchemaTypes.PaginatedLibraryTemplateResults, 'templateResults'> & { templateResults: Array<ResolversParentTypes['TemplateResult']> };
  PaginatedOrganization: Omit<SchemaTypes.PaginatedOrganization, 'organization'> & { organization: Array<ResolversParentTypes['Organization']> };
  PaginatedSpaces: Omit<SchemaTypes.PaginatedSpaces, 'spaces'> & { spaces: Array<ResolversParentTypes['Space']> };
  PaginatedUsers: Omit<SchemaTypes.PaginatedUsers, 'users'> & { users: Array<ResolversParentTypes['User']> };
  PaginatedVirtualContributor: SchemaTypes.PaginatedVirtualContributor;
  Platform: Omit<SchemaTypes.Platform, 'configuration' | 'forum' | 'innovationHub' | 'library' | 'roleSet'> & { configuration: ResolversParentTypes['Config'], forum: ResolversParentTypes['Forum'], innovationHub?: SchemaTypes.Maybe<ResolversParentTypes['InnovationHub']>, library: ResolversParentTypes['Library'], roleSet: ResolversParentTypes['RoleSet'] };
  ...
  PlatformAdminQueryResults: Omit<SchemaTypes.PlatformAdminQueryResults, 'accounts' | 'innovationHubs' | 'innovationPacks' | 'organizations' | 'spaces' | 'virtualAssistant'> & { accounts: Array<ResolversParentTypes['Account']>, innovationHubs: Array<ResolversParentTypes['InnovationHub']>, innovationPacks: Array<ResolversParentTypes['InnovationPack']>, organizations: ResolversParentTypes['PaginatedOrganization'], spaces: Array<ResolversParentTypes['Space']>, virtualAssistant: ResolversParentTypes['VirtualAssistant'] };
  PlatformFeatureFlag: SchemaTypes.PlatformFeatureFlag;
  PlatformIntegrationSettings: SchemaTypes.PlatformIntegrationSettings;
  PlatformInvitation: Omit<SchemaTypes.PlatformInvitation, 'createdBy'> & { createdBy: ResolversParentTypes['User'] };
  ...
  PollOption: Omit<SchemaTypes.PollOption, 'voters'> & { voters?: SchemaTypes.Maybe<Array<ResolversParentTypes['User']>> };
  ...
  Post: Omit<SchemaTypes.Post, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']>, profile: ResolversParentTypes['Profile'] };
  Profile: Omit<SchemaTypes.Profile, 'references' | 'storageBucket'> & { references?: SchemaTypes.Maybe<Array<ResolversParentTypes['Reference']>>, storageBucket: ResolversParentTypes['StorageBucket'] };
  ...
  Reaction: Omit<SchemaTypes.Reaction, 'sender'> & { sender?: SchemaTypes.Maybe<ResolversParentTypes['User']> };
  Reference: SchemaTypes.Reference;
  RefreshVirtualContributorBodyOfKnowledgeInput: SchemaTypes.RefreshVirtualContributorBodyOfKnowledgeInput;
  RelayPaginatedSpace: Omit<SchemaTypes.RelayPaginatedSpace, 'about' | 'account' | 'actor' | 'collaboration' | 'community' | 'credentials' | 'mentionableContributors' | 'profile' | 'subspaceByNameID' | 'subspaces'> & { about: ResolversParentTypes['SpaceAbout'], account: ResolversParentTypes['Account'], actor: ResolversParentTypes['Actor'], collaboration: ResolversParentTypes['Collaboration'], community: ResolversParentTypes['Community'], credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, mentionableContributors: Array<ResolversParentTypes['ActorFull']>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']>, subspaceByNameID: ResolversParentTypes['Space'], subspaces: Array<ResolversParentTypes['Space']> };
  RelayPaginatedSpaceEdge: Omit<SchemaTypes.RelayPaginatedSpaceEdge, 'node'> & { node: ResolversParentTypes['RelayPaginatedSpace'] };
  ...
  RoleSet: Omit<SchemaTypes.RoleSet, 'invitations' | 'organizationsInRole' | 'organizationsInRoles' | 'usersInRole'> & { invitations: Array<ResolversParentTypes['Invitation']>, organizationsInRole: Array<ResolversParentTypes['Organization']>, organizationsInRoles: Array<ResolversParentTypes['OrganizationsInRolesResponse']>, usersInRole: Array<ResolversParentTypes['User']> };
  RoleSetInvitationResult: Omit<SchemaTypes.RoleSetInvitationResult, 'invitation'> & { invitation?: SchemaTypes.Maybe<ResolversParentTypes['Invitation']> };
  RolesActorInput: SchemaTypes.RolesActorInput;
  ...
  SearchResultCallout: Omit<SchemaTypes.SearchResultCallout, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  SearchResultCollaboraDocument: Omit<SchemaTypes.SearchResultCollaboraDocument, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  SearchResultMemo: Omit<SchemaTypes.SearchResultMemo, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  SearchResultOrganization: Omit<SchemaTypes.SearchResultOrganization, 'organization'> & { organization: ResolversParentTypes['Organization'] };
  SearchResultPost: Omit<SchemaTypes.SearchResultPost, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  SearchResultSpace: Omit<SchemaTypes.SearchResultSpace, 'parentSpace' | 'space'> & { parentSpace?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, space: ResolversParentTypes['Space'] };
  SearchResultUser: Omit<SchemaTypes.SearchResultUser, 'user'> & { user: ResolversParentTypes['User'] };
  SearchResultWhiteboard: Omit<SchemaTypes.SearchResultWhiteboard, 'callout' | 'space'> & { callout: ResolversParentTypes['Callout'], space: ResolversParentTypes['Space'] };
  SendDirectMessageToUsersInput: SchemaTypes.SendDirectMessageToUsersInput;
  Sentry: SchemaTypes.Sentry;
  ServiceMetadata: SchemaTypes.ServiceMetadata;
  SetDefaultCalloutTemplateOnInnovationFlowStateInput: SchemaTypes.SetDefaultCalloutTemplateOnInnovationFlowStateInput;
  SetPlatformWellKnownVirtualContributorInput: SchemaTypes.SetPlatformWellKnownVirtualContributorInput;
  Space: Omit<SchemaTypes.Space, 'about' | 'account' | 'actor' | 'collaboration' | 'community' | 'credentials' | 'mentionableContributors' | 'profile' | 'subspaceByNameID' | 'subspaces'> & { about: ResolversParentTypes['SpaceAbout'], account: ResolversParentTypes['Account'], actor: ResolversParentTypes['Actor'], collaboration: ResolversParentTypes['Collaboration'], community: ResolversParentTypes['Community'], credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, mentionableContributors: Array<ResolversParentTypes['ActorFull']>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']>, subspaceByNameID: ResolversParentTypes['Space'], subspaces: Array<ResolversParentTypes['Space']> };
  SpaceAbout: Omit<SchemaTypes.SpaceAbout, 'guidelines' | 'membership' | 'profile' | 'provider'> & { guidelines: ResolversParentTypes['CommunityGuidelines'], membership: ResolversParentTypes['SpaceAboutMembership'], profile: ResolversParentTypes['Profile'], provider?: SchemaTypes.Maybe<ResolversParentTypes['Actor']> };
  SpaceAboutMembership: Omit<SchemaTypes.SpaceAboutMembership, 'leadOrganizations' | 'leadUsers'> & { leadOrganizations: Array<ResolversParentTypes['Organization']>, leadUsers: Array<ResolversParentTypes['User']> };
  SpaceFilterInput: SchemaTypes.SpaceFilterInput;
  SpacePendingMembershipInfo: Omit<SchemaTypes.SpacePendingMembershipInfo, 'about' | 'communityGuidelines'> & { about: ResolversParentTypes['SpaceAbout'], communityGuidelines: ResolversParentTypes['CommunityGuidelines'] };
  ...
  StorageAggregator: Omit<SchemaTypes.StorageAggregator, 'directStorageBucket' | 'storageBuckets'> & { directStorageBucket: ResolversParentTypes['StorageBucket'], storageBuckets: Array<ResolversParentTypes['StorageBucket']> };
  StorageAggregatorParent: SchemaTypes.StorageAggregatorParent;
  StorageBucket: Omit<SchemaTypes.StorageBucket, 'document' | 'documents'> & { document?: SchemaTypes.Maybe<ResolversParentTypes['Document']>, documents: Array<ResolversParentTypes['Document']> };
  ...
  SubspaceCreated: Omit<SchemaTypes.SubspaceCreated, 'subspace'> & { subspace: ResolversParentTypes['Space'] };
  ...
  Template: Omit<SchemaTypes.Template, 'callout' | 'communityGuidelines' | 'contentSpace' | 'profile'> & { callout?: SchemaTypes.Maybe<ResolversParentTypes['Callout']>, communityGuidelines?: SchemaTypes.Maybe<ResolversParentTypes['CommunityGuidelines']>, contentSpace?: SchemaTypes.Maybe<ResolversParentTypes['TemplateContentSpace']>, profile: ResolversParentTypes['Profile'] };
  TemplateContentSpace: Omit<SchemaTypes.TemplateContentSpace, 'about' | 'collaboration' | 'subspaces'> & { about: ResolversParentTypes['SpaceAbout'], collaboration: ResolversParentTypes['Collaboration'], subspaces: Array<ResolversParentTypes['TemplateContentSpace']> };
  TemplateDefault: Omit<SchemaTypes.TemplateDefault, 'template'> & { template?: SchemaTypes.Maybe<ResolversParentTypes['Template']> };
  TemplateResult: Omit<SchemaTypes.TemplateResult, 'innovationPack' | 'template'> & { innovationPack: ResolversParentTypes['InnovationPack'], template: ResolversParentTypes['Template'] };
  TemplatesManager: Omit<SchemaTypes.TemplatesManager, 'templatesSet'> & { templatesSet?: SchemaTypes.Maybe<ResolversParentTypes['TemplatesSet']> };
  TemplatesSet: Omit<SchemaTypes.TemplatesSet, 'calloutTemplates' | 'classificationTemplates' | 'communityGuidelinesTemplates' | 'postTemplates' | 'spaceTemplates' | 'templates' | 'whiteboardTemplates'> & { calloutTemplates: Array<ResolversParentTypes['Template']>, classificationTemplates: Array<ResolversParentTypes['Template']>, communityGuidelinesTemplates: Array<ResolversParentTypes['Template']>, postTemplates: Array<ResolversParentTypes['Template']>, spaceTemplates: Array<ResolversParentTypes['Template']>, templates: Array<ResolversParentTypes['Template']>, whiteboardTemplates: Array<ResolversParentTypes['Template']> };
  Timeline: Omit<SchemaTypes.Timeline, 'calendar'> & { calendar: ResolversParentTypes['Calendar'] };
  TransferAccountInnovationHubInput: SchemaTypes.TransferAccountInnovationHubInput;
  TransferAccountInnovationPackInput: SchemaTypes.TransferAccountInnovationPackInput;
  TransferAccountSpaceInput: SchemaTypes.TransferAccountSpaceInput;
  TransferAccountVirtualContributorInput: SchemaTypes.TransferAccountVirtualContributorInput;
  ...
  User: Omit<SchemaTypes.User, 'account' | 'actor' | 'credentials' | 'profile'> & { account?: SchemaTypes.Maybe<ResolversParentTypes['Account']>, actor: ResolversParentTypes['Actor'], credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']> };
  ...
  UserFilterInput: SchemaTypes.UserFilterInput;
  UserGroup: Omit<SchemaTypes.UserGroup, 'members' | 'parent' | 'profile'> & { members?: SchemaTypes.Maybe<Array<ResolversParentTypes['User']>>, parent?: SchemaTypes.Maybe<ResolversParentTypes['Groupable']>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']> };
  ...
  UsersInRolesResponse: Omit<SchemaTypes.UsersInRolesResponse, 'users'> & { users: Array<ResolversParentTypes['User']> };
  UsersWithAuthorizationCredentialInput: SchemaTypes.UsersWithAuthorizationCredentialInput;
  VcInteraction: SchemaTypes.VcInteraction;
  VirtualAssistant: Omit<SchemaTypes.VirtualAssistant, 'credentials' | 'profile'> & { credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']> };
  VirtualContributor: Omit<SchemaTypes.VirtualContributor, 'account' | 'actor' | 'credentials' | 'knowledgeSpace' | 'profile' | 'provider'> & { account?: SchemaTypes.Maybe<ResolversParentTypes['Account']>, actor: ResolversParentTypes['Actor'], credentials?: SchemaTypes.Maybe<Array<ResolversParentTypes['Credential']>>, knowledgeSpace?: SchemaTypes.Maybe<ResolversParentTypes['Space']>, profile?: SchemaTypes.Maybe<ResolversParentTypes['Profile']>, provider: ResolversParentTypes['Actor'] };
  ...
  VisualUploadImageInput: SchemaTypes.VisualUploadImageInput;
  Whiteboard: Omit<SchemaTypes.Whiteboard, 'createdBy' | 'profile'> & { createdBy?: SchemaTypes.Maybe<ResolversParentTypes['User']>, profile: ResolversParentTypes['Profile'] };
...
export type AccountResolvers<ContextType = any, ParentType extends ResolversParentTypes['Account'] = ResolversParentTypes['Account']> = {
  accountType?: Resolver<SchemaTypes.Maybe<ResolversTypes['AccountType']>, ParentType, ContextType>;
  ...
  baselineLicensePlan?: Resolver<ResolversTypes['AccountLicensePlan'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  credentials?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, ParentType, ContextType>;
  externalSubscriptionID?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  host?: Resolver<SchemaTypes.Maybe<ResolversTypes['Actor']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  innovationHubs?: Resolver<Array<ResolversTypes['InnovationHub']>, ParentType, ContextType, Partial<SchemaTypes.AccountInnovationHubsArgs>>;
  innovationPacks?: Resolver<Array<ResolversTypes['InnovationPack']>, ParentType, ContextType, Partial<SchemaTypes.AccountInnovationPacksArgs>>;
...
export type AccountDeletionBlockerResolvers<ContextType = any, ParentType extends ResolversParentTypes['AccountDeletionBlocker'] = ResolversParentTypes['AccountDeletionBlocker']> = {
  ...
  url?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};
...
export type AccountSubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['AccountSubscription'] = ResolversParentTypes['AccountSubscription']> = {
  expires?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
...
export type ActivityLogEntryCalendarEventCreatedResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActivityLogEntryCalendarEventCreated'] = ResolversParentTypes['ActivityLogEntryCalendarEventCreated']> = {
  ...
  space?: Resolver<SchemaTypes.Maybe<ResolversTypes['Space']>, ParentType, ContextType>;
...
export type ActivityLogEntryCalloutMemoCreatedResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActivityLogEntryCalloutMemoCreated'] = ResolversParentTypes['ActivityLogEntryCalloutMemoCreated']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  child?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  collaborationID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type ActivityLogEntrySubspaceCreatedResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActivityLogEntrySubspaceCreated'] = ResolversParentTypes['ActivityLogEntrySubspaceCreated']> = {
  child?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  collaborationID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ActorFullResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActorFull'] = ResolversParentTypes['ActorFull']> = {
  __resolveType: TypeResolveFn<'Account' | 'Organization' | 'RelayPaginatedSpace' | 'Space' | 'User' | 'VirtualAssistant' | 'VirtualContributor', ParentType, ContextType>;
};

export type ActorRolePolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActorRolePolicy'] = ResolversParentTypes['ActorRolePolicy']> = {
  maximum?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  minimum?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type ActorRolesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActorRoles'] = ResolversParentTypes['ActorRoles']> = {
  applications?: Resolver<Array<ResolversTypes['CommunityApplicationForRoleResult']>, ParentType, ContextType, Partial<SchemaTypes.ActorRolesApplicationsArgs>>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  invitations?: Resolver<Array<ResolversTypes['CommunityInvitationForRoleResult']>, ParentType, ContextType, Partial<SchemaTypes.ActorRolesInvitationsArgs>>;
...
export type AiPersonaResolvers<ContextType = any, ParentType extends ResolversParentTypes['AiPersona'] = ResolversParentTypes['AiPersona']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  bodyOfKnowledgeLastUpdated?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  engine?: Resolver<ResolversTypes['AiPersonaEngine'], ParentType, ContextType>;
  externalConfig?: Resolver<SchemaTypes.Maybe<ResolversTypes['ExternalConfig']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  prompt?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  promptGraph?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraph']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type AiServerResolvers<ContextType = any, ParentType extends ResolversParentTypes['AiServer'] = ResolversParentTypes['AiServer']> = {
  aiPersona?: Resolver<ResolversTypes['AiPersona'], ParentType, ContextType, RequireFields<SchemaTypes.AiServerAiPersonaArgs, 'ID'>>;
  aiPersonas?: Resolver<Array<ResolversTypes['AiPersona']>, ParentType, ContextType>;
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  defaultAiPersona?: Resolver<ResolversTypes['AiPersona'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type ApplicationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Application'] = ResolversParentTypes['Application']> = {
  ...
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  user?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
};

export type AssistantCapabilityResolvers<ContextType = any, ParentType extends ResolversParentTypes['AssistantCapability'] = ResolversParentTypes['AssistantCapability']> = {
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  kind?: Resolver<ResolversTypes['AssistantCapabilityKind'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type AssistantCapabilityToggleResolvers<ContextType = any, ParentType extends ResolversParentTypes['AssistantCapabilityToggle'] = ResolversParentTypes['AssistantCapabilityToggle']> = {
...
export type AuthorizationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Authorization'] = ResolversParentTypes['Authorization']> = {
  ...
  hasPrivilege?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.AuthorizationHasPrivilegeArgs, 'privilege'>>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  ...
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['AuthorizationPolicyType']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type CalendarResolvers<ContextType = any, ParentType extends ResolversParentTypes['Calendar'] = ResolversParentTypes['Calendar']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  event?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalendarEvent']>, ParentType, ContextType, RequireFields<SchemaTypes.CalendarEventArgs, 'ID'>>;
...
export type CalendarEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalendarEvent'] = ResolversParentTypes['CalendarEvent']> = {
  ...
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  durationDays?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  durationMinutes?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  googleCalendarUrl?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  icsDownloadUrl?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  multipleDays?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  outlookCalendarUrl?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  startDate?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  subspace?: Resolver<SchemaTypes.Maybe<ResolversTypes['Space']>, ParentType, ContextType>;
...
export type CalloutResolvers<ContextType = any, ParentType extends ResolversParentTypes['Callout'] = ResolversParentTypes['Callout']> = {
  ...
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  classification?: Resolver<SchemaTypes.Maybe<ResolversTypes['Classification']>, ParentType, ContextType>;
  comments?: Resolver<SchemaTypes.Maybe<ResolversTypes['Room']>, ParentType, ContextType>;
  contributionDefaults?: Resolver<ResolversTypes['CalloutContributionDefaults'], ParentType, ContextType>;
  contributions?: Resolver<Array<ResolversTypes['CalloutContribution']>, ParentType, ContextType, Partial<SchemaTypes.CalloutContributionsArgs>>;
  contributionsCount?: Resolver<ResolversTypes['CalloutContributionsCountOutput'], ParentType, ContextType>;
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  ...
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  posts?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Post']>>, ParentType, ContextType>;
  publishedBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  publishedDate?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  reactions?: Resolver<Array<ResolversTypes['CalloutReaction']>, ParentType, ContextType>;
  reactionsSummary?: Resolver<ResolversTypes['CalloutReactionsSummary'], ParentType, ContextType>;
  settings?: Resolver<ResolversTypes['CalloutSettings'], ParentType, ContextType>;
  sortOrder?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  taskColumnCounts?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['TaskColumnCount']>>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type CalloutContributionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutContribution'] = ResolversParentTypes['CalloutContribution']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  classification?: Resolver<SchemaTypes.Maybe<ResolversTypes['Classification']>, ParentType, ContextType>;
  collaboraDocument?: Resolver<SchemaTypes.Maybe<ResolversTypes['CollaboraDocument']>, ParentType, ContextType>;
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  link?: Resolver<SchemaTypes.Maybe<ResolversTypes['Link']>, ParentType, ContextType>;
  memo?: Resolver<SchemaTypes.Maybe<ResolversTypes['Memo']>, ParentType, ContextType>;
  post?: Resolver<SchemaTypes.Maybe<ResolversTypes['Post']>, ParentType, ContextType>;
  sortOrder?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['Whiteboard']>, ParentType, ContextType>;
};
...
export type CalloutContributionDefaultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutContributionDefaults'] = ResolversParentTypes['CalloutContributionDefaults']> = {
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  defaultDisplayName?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  postDescription?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  whiteboardContentAvailable?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type CalloutContributionsCountOutputResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutContributionsCountOutput'] = ResolversParentTypes['CalloutContributionsCountOutput']> = {
  collaboraDocument?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type CalloutContributorsMapViewResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutContributorsMapView'] = ResolversParentTypes['CalloutContributorsMapView']> = {
  latitude?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  longitude?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  zoom?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type CalloutContributorsSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutContributorsSettings'] = ResolversParentTypes['CalloutContributorsSettings']> = {
  contributorTypes?: Resolver<Array<ResolversTypes['ActorType']>, ParentType, ContextType>;
  defaultContributorType?: Resolver<ResolversTypes['ActorType'], ParentType, ContextType>;
  defaultView?: Resolver<ResolversTypes['ContributorCollectionView'], ParentType, ContextType>;
  mapView?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutContributorsMapView']>, ParentType, ContextType>;
};
...
export type CalloutFramingResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutFraming'] = ResolversParentTypes['CalloutFraming']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  collaboraDocument?: Resolver<SchemaTypes.Maybe<ResolversTypes['CollaboraDocument']>, ParentType, ContextType>;
  contributorCounts?: Resolver<ResolversTypes['ContributorCollectionCounts'], ParentType, ContextType>;
  contributors?: Resolver<Array<ResolversTypes['ContributorCollectionItem']>, ParentType, ContextType, RequireFields<SchemaTypes.CalloutFramingContributorsArgs, 'type'>>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  link?: Resolver<SchemaTypes.Maybe<ResolversTypes['Link']>, ParentType, ContextType>;
  mediaGallery?: Resolver<SchemaTypes.Maybe<ResolversTypes['MediaGallery']>, ParentType, ContextType>;
  memo?: Resolver<SchemaTypes.Maybe<ResolversTypes['Memo']>, ParentType, ContextType>;
  poll?: Resolver<SchemaTypes.Maybe<ResolversTypes['Poll']>, ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  subspaces?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['CalloutFramingType'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['Whiteboard']>, ParentType, ContextType>;
};
...
export type CalloutReactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutReaction'] = ResolversParentTypes['CalloutReaction']> = {
...
export type CalloutReactionsSummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutReactionsSummary'] = ResolversParentTypes['CalloutReactionsSummary']> = {
  allowedEmojis?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  emojis?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  myReactionEmoji?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
};

export type CalloutSelectionSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutSelectionSettings'] = ResolversParentTypes['CalloutSelectionSettings']> = {
  mode?: Resolver<ResolversTypes['CalloutSelectionMode'], ParentType, ContextType>;
  selectedIds?: Resolver<Array<ResolversTypes['ID']>, ParentType, ContextType>;
};

export type CalloutSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutSettings'] = ResolversParentTypes['CalloutSettings']> = {
  contribution?: Resolver<ResolversTypes['CalloutSettingsContribution'], ParentType, ContextType>;
  framing?: Resolver<ResolversTypes['CalloutSettingsFraming'], ParentType, ContextType>;
  visibility?: Resolver<ResolversTypes['CalloutVisibility'], ParentType, ContextType>;
};

export type CalloutSettingsContributionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutSettingsContribution'] = ResolversParentTypes['CalloutSettingsContribution']> = {
  allowedTypes?: Resolver<Array<ResolversTypes['CalloutContributionType']>, ParentType, ContextType>;
  canAddContributions?: Resolver<ResolversTypes['CalloutAllowedActors'], ParentType, ContextType>;
  commentsEnabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  enabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type CalloutSettingsFramingResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutSettingsFraming'] = ResolversParentTypes['CalloutSettingsFraming']> = {
  commentsEnabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  contributors?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutContributorsSettings']>, ParentType, ContextType>;
  selection?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutSelectionSettings']>, ParentType, ContextType>;
};
...
export type CalloutsSetResolvers<ContextType = any, ParentType extends ResolversParentTypes['CalloutsSet'] = ResolversParentTypes['CalloutsSet']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  callouts?: Resolver<Array<ResolversTypes['Callout']>, ParentType, ContextType, Partial<SchemaTypes.CalloutsSetCalloutsArgs>>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  tags?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, Partial<SchemaTypes.CalloutsSetTagsArgs>>;
  tagsetTemplates?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['TagsetTemplate']>>, ParentType, ContextType>;
...
export type ClassificationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Classification'] = ResolversParentTypes['Classification']> = {
  ...
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  tagset?: Resolver<SchemaTypes.Maybe<ResolversTypes['Tagset']>, ParentType, ContextType, RequireFields<SchemaTypes.ClassificationTagsetArgs, 'tagsetName'>>;
  tagsets?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Tagset']>>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type ClassificationEntryResolvers<ContextType = any, ParentType extends ResolversParentTypes['ClassificationEntry'] = ResolversParentTypes['ClassificationEntry']> = {
  cardinality?: Resolver<ResolversTypes['ClassificationCardinality'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  ...
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  selectedValueIDs?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  selectedValues?: Resolver<Array<ResolversTypes['ClassificationValue']>, ParentType, ContextType>;
  sortOrder?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  values?: Resolver<Array<ResolversTypes['ClassificationValue']>, ParentType, ContextType>;
};

export type ClassificationTemplateContentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ClassificationTemplateContent'] = ResolversParentTypes['ClassificationTemplateContent']> = {
  cardinality?: Resolver<ResolversTypes['ClassificationCardinality'], ParentType, ContextType>;
  values?: Resolver<Array<ResolversTypes['ClassificationValue']>, ParentType, ContextType>;
};

export type ClassificationValueResolvers<ContextType = any, ParentType extends ResolversParentTypes['ClassificationValue'] = ResolversParentTypes['ClassificationValue']> = {
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type CollaboraDocumentResolvers<ContextType = any, ParentType extends ResolversParentTypes['CollaboraDocument'] = ResolversParentTypes['CollaboraDocument']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  documentType?: Resolver<ResolversTypes['CollaboraDocumentType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type CollaboraEditorUrlResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CollaboraEditorUrlResult'] = ResolversParentTypes['CollaboraEditorUrlResult']> = {
...
export type CollaborationMigrationIssueResolvers<ContextType = any, ParentType extends ResolversParentTypes['CollaborationMigrationIssue'] = ResolversParentTypes['CollaborationMigrationIssue']> = {
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type CollaborationMigrationResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CollaborationMigrationResult'] = ResolversParentTypes['CollaborationMigrationResult']> = {
  failed?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  failedDocuments?: Resolver<Array<ResolversTypes['CollaborationMigrationIssue']>, ParentType, ContextType>;
  flagged?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  flaggedDocuments?: Resolver<Array<ResolversTypes['CollaborationMigrationIssue']>, ParentType, ContextType>;
...
export type CommunicationAdminMigrateRoomsResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CommunicationAdminMigrateRoomsResult'] = ResolversParentTypes['CommunicationAdminMigrateRoomsResult']> = {
...
export type CommunityResolvers<ContextType = any, ParentType extends ResolversParentTypes['Community'] = ResolversParentTypes['Community']> = {
  ...
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  group?: Resolver<ResolversTypes['UserGroup'], ParentType, ContextType, RequireFields<SchemaTypes.CommunityGroupArgs, 'ID'>>;
...
export type CommunityInvitationForRoleResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CommunityInvitationForRoleResult'] = ResolversParentTypes['CommunityInvitationForRoleResult']> = {
  ...
  state?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  welcomeMessage?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
};
...
export type ConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['Config'] = ResolversParentTypes['Config']> = {
  ...
  defaultVisualTypeConstraints?: Resolver<ResolversTypes['VisualConstraints'], ParentType, ContextType, RequireFields<SchemaTypes.ConfigDefaultVisualTypeConstraintsArgs, 'type'>>;
  ...
  language?: Resolver<ResolversTypes['LanguageConfig'], ParentType, ContextType>;
...
export type ContributorCollectionCountsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ContributorCollectionCounts'] = ResolversParentTypes['ContributorCollectionCounts']> = {
  organizations?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  users?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  virtualContributors?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
};

export type ContributorCollectionItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['ContributorCollectionItem'] = ResolversParentTypes['ContributorCollectionItem']> = {
  avatarUrl?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  location?: Resolver<SchemaTypes.Maybe<ResolversTypes['ContributorLocation']>, ParentType, ContextType>;
  roleLabel?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['ActorType'], ParentType, ContextType>;
  url?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type ContributorLocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['ContributorLocation'] = ResolversParentTypes['ContributorLocation']> = {
  city?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasValidCoordinates?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  latitude?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  longitude?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
};
...
export type ConversationCreatedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationCreatedEvent'] = ResolversParentTypes['ConversationCreatedEvent']> = {
  conversation?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType>;
  message?: Resolver<SchemaTypes.Maybe<ResolversTypes['Message']>, ParentType, ContextType>;
};

export type ConversationDeletedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationDeletedEvent'] = ResolversParentTypes['ConversationDeletedEvent']> = {
  conversationID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};

export type ConversationEventSubscriptionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationEventSubscriptionResult'] = ResolversParentTypes['ConversationEventSubscriptionResult']> = {
  conversationCreated?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationCreatedEvent']>, ParentType, ContextType>;
  conversationDeleted?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationDeletedEvent']>, ParentType, ContextType>;
  conversationUpdated?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationUpdatedEvent']>, ParentType, ContextType>;
  eventType?: Resolver<ResolversTypes['ConversationEventType'], ParentType, ContextType>;
  memberAdded?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationMemberAddedEvent']>, ParentType, ContextType>;
  memberRemoved?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationMemberRemovedEvent']>, ParentType, ContextType>;
  messageReceived?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationMessageReceivedEvent']>, ParentType, ContextType>;
  messageRemoved?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationMessageRemovedEvent']>, ParentType, ContextType>;
  readReceiptUpdated?: Resolver<SchemaTypes.Maybe<ResolversTypes['ConversationReadReceiptUpdatedEvent']>, ParentType, ContextType>;
};

export type ConversationMemberAddedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationMemberAddedEvent'] = ResolversParentTypes['ConversationMemberAddedEvent']> = {
  addedMember?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  conversation?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType>;
};

export type ConversationMemberRemovedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationMemberRemovedEvent'] = ResolversParentTypes['ConversationMemberRemovedEvent']> = {
  conversation?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType>;
  removedMemberID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};

export type ConversationMessageReceivedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationMessageReceivedEvent'] = ResolversParentTypes['ConversationMessageReceivedEvent']> = {
  message?: Resolver<ResolversTypes['Message'], ParentType, ContextType>;
  roomId?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};

export type ConversationMessageRemovedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationMessageRemovedEvent'] = ResolversParentTypes['ConversationMessageRemovedEvent']> = {
  messageId?: Resolver<ResolversTypes['MessageID'], ParentType, ContextType>;
  roomId?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};

export type ConversationReadReceiptUpdatedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationReadReceiptUpdatedEvent'] = ResolversParentTypes['ConversationReadReceiptUpdatedEvent']> = {
  lastReadEventId?: Resolver<ResolversTypes['MessageID'], ParentType, ContextType>;
  roomId?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};

export type ConversationUpdatedEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConversationUpdatedEvent'] = ResolversParentTypes['ConversationUpdatedEvent']> = {
  conversation?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType>;
};

export type CreateCalloutContributionDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutContributionData'] = ResolversParentTypes['CreateCalloutContributionData']> = {
  collaboraDocument?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCollaboraDocumentData']>, ParentType, ContextType>;
  link?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateLinkData']>, ParentType, ContextType>;
  memo?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateMemoData']>, ParentType, ContextType>;
  post?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreatePostData']>, ParentType, ContextType>;
  sortOrder?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  taskColumn?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['CalloutContributionType'], ParentType, ContextType>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateWhiteboardData']>, ParentType, ContextType>;
};
...
export type CreateCalloutContributionDefaultsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutContributionDefaultsData'] = ResolversParentTypes['CreateCalloutContributionDefaultsData']> = {
  defaultDisplayName?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  draftWhiteboardID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  postDescription?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  sourceCalloutID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  sourceWhiteboardID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
};

export type CreateCalloutContributorsMapViewDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutContributorsMapViewData'] = ResolversParentTypes['CreateCalloutContributorsMapViewData']> = {
  latitude?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  longitude?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  zoom?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type CreateCalloutContributorsSettingsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutContributorsSettingsData'] = ResolversParentTypes['CreateCalloutContributorsSettingsData']> = {
  contributorTypes?: Resolver<Array<ResolversTypes['ActorType']>, ParentType, ContextType>;
  defaultContributorType?: Resolver<SchemaTypes.Maybe<ResolversTypes['ActorType']>, ParentType, ContextType>;
  defaultView?: Resolver<SchemaTypes.Maybe<ResolversTypes['ContributorCollectionView']>, ParentType, ContextType>;
  mapView?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutContributorsMapViewData']>, ParentType, ContextType>;
};
...
export type CreateCalloutDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutData'] = ResolversParentTypes['CreateCalloutData']> = {
  classification?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateClassificationData']>, ParentType, ContextType>;
  contributionDefaults?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutContributionDefaultsData']>, ParentType, ContextType>;
  contributions?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['CreateCalloutContributionData']>>, ParentType, ContextType>;
  framing?: Resolver<ResolversTypes['CreateCalloutFramingData'], ParentType, ContextType>;
  nameID?: Resolver<SchemaTypes.Maybe<ResolversTypes['NameID']>, ParentType, ContextType>;
  sendNotification?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  settings?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutSettingsData']>, ParentType, ContextType>;
  sortOrder?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  taskBoard?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutTaskBoardData']>, ParentType, ContextType>;
};
...
export type CreateCalloutFramingDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutFramingData'] = ResolversParentTypes['CreateCalloutFramingData']> = {
  ...
  link?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateLinkData']>, ParentType, ContextType>;
  memo?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateMemoData']>, ParentType, ContextType>;
  poll?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreatePollData']>, ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['CreateProfileData'], ParentType, ContextType>;
  tags?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutFramingType']>, ParentType, ContextType>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateWhiteboardData']>, ParentType, ContextType>;
};

export type CreateCalloutSelectionSettingsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutSelectionSettingsData'] = ResolversParentTypes['CreateCalloutSelectionSettingsData']> = {
  mode?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutSelectionMode']>, ParentType, ContextType>;
  selectedIds?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['ID']>>, ParentType, ContextType>;
};

export type CreateCalloutSettingsContributionDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutSettingsContributionData'] = ResolversParentTypes['CreateCalloutSettingsContributionData']> = {
  allowedTypes?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['CalloutContributionType']>>, ParentType, ContextType>;
  canAddContributions?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutAllowedActors']>, ParentType, ContextType>;
  commentsEnabled?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  enabled?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
};

export type CreateCalloutSettingsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutSettingsData'] = ResolversParentTypes['CreateCalloutSettingsData']> = {
  contribution?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutSettingsContributionData']>, ParentType, ContextType>;
  framing?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutSettingsFramingData']>, ParentType, ContextType>;
  visibility?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutVisibility']>, ParentType, ContextType>;
};

export type CreateCalloutSettingsFramingDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutSettingsFramingData'] = ResolversParentTypes['CreateCalloutSettingsFramingData']> = {
  commentsEnabled?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  contributors?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutContributorsSettingsData']>, ParentType, ContextType>;
  selection?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutSelectionSettingsData']>, ParentType, ContextType>;
};

export type CreateCalloutTaskBoardDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutTaskBoardData'] = ResolversParentTypes['CreateCalloutTaskBoardData']> = {
  columns?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
};
...
export type CreateCalloutsSetDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCalloutsSetData'] = ResolversParentTypes['CreateCalloutsSetData']> = {
  calloutsData?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['CreateCalloutData']>>, ParentType, ContextType>;
};

export type CreateClassificationDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateClassificationData'] = ResolversParentTypes['CreateClassificationData']> = {
  tagsets?: Resolver<Array<ResolversTypes['CreateTagsetData']>, ParentType, ContextType>;
};

export type CreateCollaboraDocumentDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCollaboraDocumentData'] = ResolversParentTypes['CreateCollaboraDocumentData']> = {
  displayName?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  documentType?: Resolver<SchemaTypes.Maybe<ResolversTypes['CollaboraDocumentType']>, ParentType, ContextType>;
};
...
export type CreateCollaborationDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateCollaborationData'] = ResolversParentTypes['CreateCollaborationData']> = {
  ...
  innovationFlowData?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateInnovationFlowData']>, ParentType, ContextType>;
};
...
export type CreateInnovationFlowStateDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateInnovationFlowStateData'] = ResolversParentTypes['CreateInnovationFlowStateData']> = {
  ...
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  settings?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateInnovationFlowStateSettingsData']>, ParentType, ContextType>;
  sortOrder?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
};
...
export type CreateInnovationFlowStateSettingsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateInnovationFlowStateSettingsData'] = ResolversParentTypes['CreateInnovationFlowStateSettingsData']> = {
  ...
  descriptionDisplayMode?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutDescriptionDisplayMode']>, ParentType, ContextType>;
  showPublishDetails?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  sidebar?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['SidebarWidget']>>, ParentType, ContextType>;
...
export type CreateLinkDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateLinkData'] = ResolversParentTypes['CreateLinkData']> = {
  profile?: Resolver<ResolversTypes['CreateProfileData'], ParentType, ContextType>;
  uri?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};
...
export type CreateLocationDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateLocationData'] = ResolversParentTypes['CreateLocationData']> = {
  addressLine1?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  addressLine2?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  city?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  postalCode?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  stateOrProvince?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type CreateMemoDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateMemoData'] = ResolversParentTypes['CreateMemoData']> = {
  markdown?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateProfileData']>, ParentType, ContextType>;
};

export type CreatePollDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreatePollData'] = ResolversParentTypes['CreatePollData']> = {
  options?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  settings?: Resolver<SchemaTypes.Maybe<ResolversTypes['PollSettingsData']>, ParentType, ContextType>;
  title?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type CreatePostDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreatePostData'] = ResolversParentTypes['CreatePostData']> = {
  tags?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
};
...
export type CreateProfileDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateProfileData'] = ResolversParentTypes['CreateProfileData']> = {
  description?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  location?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateLocationData']>, ParentType, ContextType>;
  referencesData?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['CreateReferenceData']>>, ParentType, ContextType>;
  tagline?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  tags?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  tagsets?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['CreateTagsetData']>>, ParentType, ContextType>;
  visuals?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['CreateVisualOnProfileData']>>, ParentType, ContextType>;
};
...
export type CreateTagsetDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateTagsetData'] = ResolversParentTypes['CreateTagsetData']> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  tags?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['TagsetType']>, ParentType, ContextType>;
};
...
export type CreateWhiteboardDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateWhiteboardData'] = ResolversParentTypes['CreateWhiteboardData']> = {
  draftWhiteboardID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  nameID?: Resolver<SchemaTypes.Maybe<ResolversTypes['NameID']>, ParentType, ContextType>;
  previewSettings?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateWhiteboardPreviewSettingsData']>, ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateProfileData']>, ParentType, ContextType>;
  sourceWhiteboardID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
};

export type CreateWhiteboardPreviewSettingsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateWhiteboardPreviewSettingsData'] = ResolversParentTypes['CreateWhiteboardPreviewSettingsData']> = {
  coordinates?: Resolver<SchemaTypes.Maybe<ResolversTypes['WhiteboardPreviewCoordinatesData']>, ParentType, ContextType>;
  mode?: Resolver<SchemaTypes.Maybe<ResolversTypes['WhiteboardPreviewMode']>, ParentType, ContextType>;
};
...
export type CredentialResolvers<ContextType = any, ParentType extends ResolversParentTypes['Credential'] = ResolversParentTypes['Credential']> = {
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  expires?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  issuer?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
...
export type DirectMessageDeliveryResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['DirectMessageDeliveryResult'] = ResolversParentTypes['DirectMessageDeliveryResult']> = {
  conversationID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  receiverID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  status?: Resolver<ResolversTypes['DirectMessageDeliveryStatus'], ParentType, ContextType>;
};
...
export type DiscussionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Discussion'] = ResolversParentTypes['Discussion']> = {
  ...
  comments?: Resolver<ResolversTypes['Room'], ParentType, ContextType>;
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
...
export type DiscussionDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['DiscussionDetails'] = ResolversParentTypes['DiscussionDetails']> = {
  category?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  description?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type EmailChangeApproverResolvers<ContextType = any, ParentType extends ResolversParentTypes['EmailChangeApprover'] = ResolversParentTypes['EmailChangeApprover']> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  organization?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ExternalConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ExternalConfig'] = ResolversParentTypes['ExternalConfig']> = {
  apiKey?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  assistantId?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ForumResolvers<ContextType = any, ParentType extends ResolversParentTypes['Forum'] = ResolversParentTypes['Forum']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  discussion?: Resolver<SchemaTypes.Maybe<ResolversTypes['Discussion']>, ParentType, ContextType, RequireFields<SchemaTypes.ForumDiscussionArgs, 'ID'>>;
  discussionCategories?: Resolver<Array<ResolversTypes['ForumDiscussionCategory']>, ParentType, ContextType>;
  discussions?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Discussion']>>, ParentType, ContextType, Partial<SchemaTypes.ForumDiscussionsArgs>>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  mentionableContributors?: Resolver<Array<ResolversTypes['ActorFull']>, ParentType, ContextType, Partial<SchemaTypes.ForumMentionableContributorsArgs>>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type ISearchCategoryResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ISearchCategoryResult'] = ResolversParentTypes['ISearchCategoryResult']> = {
  cursor?: Resolver<SchemaTypes.Maybe<ResolversTypes['SearchCursor']>, ParentType, ContextType>;
  results?: Resolver<Array<ResolversTypes['SearchResult']>, ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};
...
export type ISearchResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['ISearchResults'] = ResolversParentTypes['ISearchResults']> = {
  actorResults?: Resolver<ResolversTypes['ISearchCategoryResult'], ParentType, ContextType>;
  calloutResults?: Resolver<ResolversTypes['ISearchCategoryResult'], ParentType, ContextType>;
  contributionResults?: Resolver<ResolversTypes['ISearchCategoryResult'], ParentType, ContextType>;
  framingResults?: Resolver<ResolversTypes['ISearchCategoryResult'], ParentType, ContextType>;
  spaceResults?: Resolver<ResolversTypes['ISearchCategoryResult'], ParentType, ContextType>;
};
...
export type InAppNotificationResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotification'] = ResolversParentTypes['InAppNotification']> = {
  category?: Resolver<ResolversTypes['NotificationEventCategory'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  payload?: Resolver<ResolversTypes['InAppNotificationPayload'], ParentType, ContextType>;
  receiver?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  state?: Resolver<ResolversTypes['NotificationEventInAppState'], ParentType, ContextType>;
  triggeredAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  triggeredBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['Actor']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEvent'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type InAppNotificationPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayload'] = ResolversParentTypes['InAppNotificationPayload']> = {
  __resolveType: TypeResolveFn<'InAppNotificationPayloadOrganizationMessageDirect' | 'InAppNotificationPayloadOrganizationMessageRoom' | 'InAppNotificationPayloadPlatformForumDiscussion' | 'InAppNotificationPayloadPlatformGlobalRoleChange' | 'InAppNotificationPayloadPlatformUser' | 'InAppNotificationPayloadPlatformUserMessageRoom' | 'InAppNotificationPayloadPlatformUserProfileRemoved' | 'InAppNotificationPayloadSpace' | 'InAppNotificationPayloadSpaceCollaborationCallout' | 'InAppNotificationPayloadSpaceCollaborationCalloutComment' | 'InAppNotificationPayloadSpaceCollaborationCalloutPostComment' | 'InAppNotificationPayloadSpaceCollaborationCalloutReaction' | 'InAppNotificationPayloadSpaceCollaborationPoll' | 'InAppNotificationPayloadSpaceCommunicationMessageDirect' | 'InAppNotificationPayloadSpaceCommunicationUpdate' | 'InAppNotificationPayloadSpaceCommunityActor' | 'InAppNotificationPayloadSpaceCommunityApplication' | 'InAppNotificationPayloadSpaceCommunityCalendarEvent' | 'InAppNotificationPayloadSpaceCommunityCalendarEventComment' | 'InAppNotificationPayloadSpaceCommunityInvitation' | 'InAppNotificationPayloadSpaceCommunityInvitationPlatform' | 'InAppNotificationPayloadUserMessageDirect' | 'InAppNotificationPayloadVirtualContributor', ParentType, ContextType>;
};

export type InAppNotificationPayloadOrganizationMessageDirectResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadOrganizationMessageDirect'] = ResolversParentTypes['InAppNotificationPayloadOrganizationMessageDirect']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  organization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Organization']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadOrganizationMessageRoomResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadOrganizationMessageRoom'] = ResolversParentTypes['InAppNotificationPayloadOrganizationMessageRoom']> = {
  comment?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  organization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType>;
  roomID?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadPlatformForumDiscussionResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadPlatformForumDiscussion'] = ResolversParentTypes['InAppNotificationPayloadPlatformForumDiscussion']> = {
  comment?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  discussion?: Resolver<ResolversTypes['DiscussionDetails'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadPlatformGlobalRoleChangeResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadPlatformGlobalRoleChange'] = ResolversParentTypes['InAppNotificationPayloadPlatformGlobalRoleChange']> = {
  role?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  user?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadPlatformUserResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadPlatformUser'] = ResolversParentTypes['InAppNotificationPayloadPlatformUser']> = {
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadPlatformUserMessageRoomResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadPlatformUserMessageRoom'] = ResolversParentTypes['InAppNotificationPayloadPlatformUserMessageRoom']> = {
  messageDetails?: Resolver<SchemaTypes.Maybe<ResolversTypes['MessageDetails']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpace'] = ResolversParentTypes['InAppNotificationPayloadSpace']> = {
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadSpaceCollaborationCalloutResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCallout'] = ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCallout']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCollaborationCalloutCommentResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCalloutComment'] = ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCalloutComment']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  messageDetails?: Resolver<SchemaTypes.Maybe<ResolversTypes['MessageDetails']>, ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCollaborationCalloutPostCommentResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCalloutPostComment'] = ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCalloutPostComment']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  messageDetails?: Resolver<SchemaTypes.Maybe<ResolversTypes['MessageDetails']>, ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCollaborationCalloutReactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCalloutReaction'] = ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationCalloutReaction']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  emoji?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCollaborationPollResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationPoll'] = ResolversParentTypes['InAppNotificationPayloadSpaceCollaborationPoll']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunicationMessageDirectResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunicationMessageDirect'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunicationMessageDirect']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunicationUpdateResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunicationUpdate'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunicationUpdate']> = {
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunityActorResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunityActor'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunityActor']> = {
  actor?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunityApplicationResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunityApplication'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunityApplication']> = {
  application?: Resolver<ResolversTypes['Application'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunityCalendarEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunityCalendarEvent'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunityCalendarEvent']> = {
  calendarEvent?: Resolver<ResolversTypes['CalendarEvent'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunityCalendarEventCommentResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunityCalendarEventComment'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunityCalendarEventComment']> = {
  calendarEvent?: Resolver<ResolversTypes['CalendarEvent'], ParentType, ContextType>;
...
export type InAppNotificationPayloadSpaceCommunityInvitationResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunityInvitation'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunityInvitation']> = {
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadSpaceCommunityInvitationPlatformResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadSpaceCommunityInvitationPlatform'] = ResolversParentTypes['InAppNotificationPayloadSpaceCommunityInvitationPlatform']> = {
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InAppNotificationPayloadUserMessageDirectResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadUserMessageDirect'] = ResolversParentTypes['InAppNotificationPayloadUserMessageDirect']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  user?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type InAppNotificationPayloadVirtualContributorResolvers<ContextType = any, ParentType extends ResolversParentTypes['InAppNotificationPayloadVirtualContributor'] = ResolversParentTypes['InAppNotificationPayloadVirtualContributor']> = {
  actor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['NotificationEventPayload'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type InnovationFlowResolvers<ContextType = any, ParentType extends ResolversParentTypes['InnovationFlow'] = ResolversParentTypes['InnovationFlow']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  currentState?: Resolver<SchemaTypes.Maybe<ResolversTypes['InnovationFlowState']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  settings?: Resolver<ResolversTypes['InnovationFlowSettings'], ParentType, ContextType>;
  states?: Resolver<Array<ResolversTypes['InnovationFlowState']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type InnovationFlowSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['InnovationFlowSettings'] = ResolversParentTypes['InnovationFlowSettings']> = {
  maximumNumberOfStates?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  minimumNumberOfStates?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};
...
export type InnovationFlowStateResolvers<ContextType = any, ParentType extends ResolversParentTypes['InnovationFlowState'] = ResolversParentTypes['InnovationFlowState']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  defaultCalloutTemplate?: Resolver<SchemaTypes.Maybe<ResolversTypes['Template']>, ParentType, ContextType>;
  description?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  settings?: Resolver<ResolversTypes['InnovationFlowStateSettings'], ParentType, ContextType>;
  sortOrder?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type InnovationFlowStateSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['InnovationFlowStateSettings'] = ResolversParentTypes['InnovationFlowStateSettings']> = {
  allowNewCallouts?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  descriptionDisplayMode?: Resolver<ResolversTypes['CalloutDescriptionDisplayMode'], ParentType, ContextType>;
  showPublishDetails?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  sidebar?: Resolver<Array<ResolversTypes['SidebarWidget']>, ParentType, ContextType>;
...
export type InnovationHubResolvers<ContextType = any, ParentType extends ResolversParentTypes['InnovationHub'] = ResolversParentTypes['InnovationHub']> = {
  ...
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  innovationPackListFilter?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['InnovationPack']>>, ParentType, ContextType>;
  ...
  spaceListFilter?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Space']>>, ParentType, ContextType>;
  spaceVisibilityFilter?: Resolver<SchemaTypes.Maybe<ResolversTypes['SpaceVisibility']>, ParentType, ContextType>;
  ...
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  virtualContributorListFilter?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['VirtualContributor']>>, ParentType, ContextType>;
};
...
export type InnovationPackResolvers<ContextType = any, ParentType extends ResolversParentTypes['InnovationPack'] = ResolversParentTypes['InnovationPack']> = {
  ...
  provider?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  searchVisibility?: Resolver<ResolversTypes['SearchVisibility'], ParentType, ContextType>;
  templatesSet?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplatesSet']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type InputCreatorQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['InputCreatorQueryResults'] = ResolversParentTypes['InputCreatorQueryResults']> = {
  callout?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCalloutData']>, ParentType, ContextType, RequireFields<SchemaTypes.InputCreatorQueryResultsCalloutArgs, 'ID'>>;
  collaboration?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCollaborationData']>, ParentType, ContextType, RequireFields<SchemaTypes.InputCreatorQueryResultsCollaborationArgs, 'ID'>>;
  communityGuidelines?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateCommunityGuidelinesData']>, ParentType, ContextType, RequireFields<SchemaTypes.InputCreatorQueryResultsCommunityGuidelinesArgs, 'ID'>>;
  innovationFlow?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateInnovationFlowData']>, ParentType, ContextType, RequireFields<SchemaTypes.InputCreatorQueryResultsInnovationFlowArgs, 'ID'>>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['CreateWhiteboardData']>, ParentType, ContextType, RequireFields<SchemaTypes.InputCreatorQueryResultsWhiteboardArgs, 'ID'>>;
};
...
export type InvitationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Invitation'] = ResolversParentTypes['Invitation']> = {
  ...
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  extraRoles?: Resolver<Array<ResolversTypes['RoleName']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  ...
  nextEvents?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  state?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  suggestedLanguage?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  welcomeMessage?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};
...
export type KratosIdentityResolvers<ContextType = any, ParentType extends ResolversParentTypes['KratosIdentity'] = ResolversParentTypes['KratosIdentity']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  email?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  firstName?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  isVerified?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  lastName?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  verificationStatus?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type LanguageConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['LanguageConfig'] = ResolversParentTypes['LanguageConfig']> = {
...
export type LibraryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Library'] = ResolversParentTypes['Library']> = {
  ...
  innovationPacks?: Resolver<Array<ResolversTypes['InnovationPack']>, ParentType, ContextType, Partial<SchemaTypes.LibraryInnovationPacksArgs>>;
  innovationPacksPaginated?: Resolver<ResolversTypes['PaginatedInnovationPacks'], ParentType, ContextType, Partial<SchemaTypes.LibraryInnovationPacksPaginatedArgs>>;
  templates?: Resolver<Array<ResolversTypes['TemplateResult']>, ParentType, ContextType, Partial<SchemaTypes.LibraryTemplatesArgs>>;
  templatesPaginated?: Resolver<ResolversTypes['PaginatedLibraryTemplateResults'], ParentType, ContextType, Partial<SchemaTypes.LibraryTemplatesPaginatedArgs>>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  virtualContributors?: Resolver<Array<ResolversTypes['VirtualContributor']>, ParentType, ContextType>;
};
...
export type LicenseResolvers<ContextType = any, ParentType extends ResolversParentTypes['License'] = ResolversParentTypes['License']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  availableEntitlements?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['LicenseEntitlementType']>>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  entitlements?: Resolver<Array<ResolversTypes['LicenseEntitlement']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['LicenseType']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type LicensePlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['LicensePlan'] = ResolversParentTypes['LicensePlan']> = {
  ...
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  pricePerMonth?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type LookupByNameQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['LookupByNameQueryResults'] = ResolversParentTypes['LookupByNameQueryResults']> = {
  innovationHub?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsInnovationHubArgs, 'NAMEID'>>;
  innovationPack?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsInnovationPackArgs, 'NAMEID'>>;
  organization?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsOrganizationArgs, 'NAMEID'>>;
  space?: Resolver<SchemaTypes.Maybe<ResolversTypes['Space']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsSpaceArgs, 'NAMEID'>>;
  template?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsTemplateArgs, 'NAMEID' | 'templatesSetID'>>;
  user?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsUserArgs, 'NAMEID'>>;
  virtualContributor?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupByNameQueryResultsVirtualContributorArgs, 'NAMEID'>>;
};
...
export type LookupMyPrivilegesQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['LookupMyPrivilegesQueryResults'] = ResolversParentTypes['LookupMyPrivilegesQueryResults']> = {
  account?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsAccountArgs, 'ID'>>;
  application?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsApplicationArgs, 'ID'>>;
  calendar?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsCalendarArgs, 'ID'>>;
  calendarEvent?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsCalendarEventArgs, 'ID'>>;
  callout?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsCalloutArgs, 'ID'>>;
  collaboration?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsCollaborationArgs, 'ID'>>;
  community?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsCommunityArgs, 'ID'>>;
  communityGuidelines?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsCommunityGuidelinesArgs, 'ID'>>;
  document?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsDocumentArgs, 'ID'>>;
  innovationFlow?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsInnovationFlowArgs, 'ID'>>;
  innovationHub?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsInnovationHubArgs, 'ID'>>;
  innovationPack?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsInnovationPackArgs, 'ID'>>;
  invitation?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsInvitationArgs, 'ID'>>;
  license?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsLicenseArgs, 'ID'>>;
  post?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsPostArgs, 'ID'>>;
  profile?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsProfileArgs, 'ID'>>;
  roleSet?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsRoleSetArgs, 'ID'>>;
  room?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsRoomArgs, 'ID'>>;
  space?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsSpaceArgs, 'ID'>>;
  spaceAbout?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsSpaceAboutArgs, 'ID'>>;
  storageAggregator?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsStorageAggregatorArgs, 'ID'>>;
  storageBucket?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsStorageBucketArgs, 'ID'>>;
  template?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsTemplateArgs, 'ID'>>;
  templatesManager?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsTemplatesManagerArgs, 'ID'>>;
  templatesSet?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsTemplatesSetArgs, 'ID'>>;
  user?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsUserArgs, 'ID'>>;
  virtualContributor?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsVirtualContributorArgs, 'ID'>>;
  whiteboard?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupMyPrivilegesQueryResultsWhiteboardArgs, 'ID'>>;
};
...
export type LookupQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['LookupQueryResults'] = ResolversParentTypes['LookupQueryResults']> = {
  about?: Resolver<SchemaTypes.Maybe<ResolversTypes['SpaceAbout']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsAboutArgs, 'ID'>>;
  account?: Resolver<SchemaTypes.Maybe<ResolversTypes['Account']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsAccountArgs, 'ID'>>;
  application?: Resolver<SchemaTypes.Maybe<ResolversTypes['Application']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsApplicationArgs, 'ID'>>;
  authorizationPolicy?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsAuthorizationPolicyArgs, 'ID'>>;
  authorizationPrivilegesForUser?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['AuthorizationPrivilege']>>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsAuthorizationPrivilegesForUserArgs, 'authorizationPolicyID' | 'userID'>>;
  calendar?: Resolver<SchemaTypes.Maybe<ResolversTypes['Calendar']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCalendarArgs, 'ID'>>;
  calendarEvent?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalendarEvent']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCalendarEventArgs, 'ID'>>;
  callout?: Resolver<SchemaTypes.Maybe<ResolversTypes['Callout']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCalloutArgs, 'ID'>>;
  calloutsSet?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutsSet']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCalloutsSetArgs, 'ID'>>;
  collaboration?: Resolver<SchemaTypes.Maybe<ResolversTypes['Collaboration']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCollaborationArgs, 'ID'>>;
  community?: Resolver<SchemaTypes.Maybe<ResolversTypes['Community']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCommunityArgs, 'ID'>>;
  communityGuidelines?: Resolver<SchemaTypes.Maybe<ResolversTypes['CommunityGuidelines']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsCommunityGuidelinesArgs, 'ID'>>;
  contribution?: Resolver<SchemaTypes.Maybe<ResolversTypes['CalloutContribution']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsContributionArgs, 'ID'>>;
  conversation?: Resolver<SchemaTypes.Maybe<ResolversTypes['Conversation']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsConversationArgs, 'ID'>>;
  document?: Resolver<SchemaTypes.Maybe<ResolversTypes['Document']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsDocumentArgs, 'ID'>>;
  innovationFlow?: Resolver<SchemaTypes.Maybe<ResolversTypes['InnovationFlow']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsInnovationFlowArgs, 'ID'>>;
  innovationHub?: Resolver<SchemaTypes.Maybe<ResolversTypes['InnovationHub']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsInnovationHubArgs, 'ID'>>;
  innovationPack?: Resolver<SchemaTypes.Maybe<ResolversTypes['InnovationPack']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsInnovationPackArgs, 'ID'>>;
  invitation?: Resolver<SchemaTypes.Maybe<ResolversTypes['Invitation']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsInvitationArgs, 'ID'>>;
  knowledgeBase?: Resolver<ResolversTypes['KnowledgeBase'], ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsKnowledgeBaseArgs, 'ID'>>;
  license?: Resolver<SchemaTypes.Maybe<ResolversTypes['License']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsLicenseArgs, 'ID'>>;
  memo?: Resolver<SchemaTypes.Maybe<ResolversTypes['Memo']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsMemoArgs, 'ID'>>;
  myPrivileges?: Resolver<SchemaTypes.Maybe<ResolversTypes['LookupMyPrivilegesQueryResults']>, ParentType, ContextType>;
  organization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Organization']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsOrganizationArgs, 'ID'>>;
  platformInvitation?: Resolver<SchemaTypes.Maybe<ResolversTypes['PlatformInvitation']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsPlatformInvitationArgs, 'ID'>>;
  post?: Resolver<SchemaTypes.Maybe<ResolversTypes['Post']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsPostArgs, 'ID'>>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['Profile']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsProfileArgs, 'ID'>>;
  roleSet?: Resolver<SchemaTypes.Maybe<ResolversTypes['RoleSet']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsRoleSetArgs, 'ID'>>;
  room?: Resolver<SchemaTypes.Maybe<ResolversTypes['Room']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsRoomArgs, 'ID'>>;
  space?: Resolver<SchemaTypes.Maybe<ResolversTypes['Space']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsSpaceArgs, 'ID'>>;
  storageAggregator?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageAggregator']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsStorageAggregatorArgs, 'ID'>>;
  storageBucket?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageBucket']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsStorageBucketArgs, 'ID'>>;
  template?: Resolver<SchemaTypes.Maybe<ResolversTypes['Template']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsTemplateArgs, 'ID'>>;
  templateContentSpace?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplateContentSpace']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsTemplateContentSpaceArgs, 'ID'>>;
  templatesManager?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplatesManager']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsTemplatesManagerArgs, 'ID'>>;
  templatesSet?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplatesSet']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsTemplatesSetArgs, 'ID'>>;
  user?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsUserArgs, 'ID'>>;
  virtualContributor?: Resolver<SchemaTypes.Maybe<ResolversTypes['VirtualContributor']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsVirtualContributorArgs, 'ID'>>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['Whiteboard']>, ParentType, ContextType, RequireFields<SchemaTypes.LookupQueryResultsWhiteboardArgs, 'ID'>>;
};
...
export type McpApiKeyResolvers<ContextType = any, ParentType extends ResolversParentTypes['McpApiKey'] = ResolversParentTypes['McpApiKey']> = {
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  expiresAt?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  lastUsedAt?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  lastUsedFromIp?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  operations?: Resolver<Array<ResolversTypes['McpApiKeyOperation']>, ParentType, ContextType>;
  status?: Resolver<ResolversTypes['McpApiKeyStatus'], ParentType, ContextType>;
};

export type McpApiKeyMintResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['McpApiKeyMintResult'] = ResolversParentTypes['McpApiKeyMintResult']> = {
...
export type MeQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['MeQueryResults'] = ResolversParentTypes['MeQueryResults']> = {
  ...
  communityApplications?: Resolver<Array<ResolversTypes['CommunityApplicationResult']>, ParentType, ContextType, Partial<SchemaTypes.MeQueryResultsCommunityApplicationsArgs>>;
  communityInvitations?: Resolver<Array<ResolversTypes['CommunityInvitationResult']>, ParentType, ContextType, Partial<SchemaTypes.MeQueryResultsCommunityInvitationsArgs>>;
  communityInvitationsCount?: Resolver<ResolversTypes['Float'], ParentType, ContextType, Partial<SchemaTypes.MeQueryResultsCommunityInvitationsCountArgs>>;
  conversations?: Resolver<ResolversTypes['MeConversationsResult'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  mcpApiKeys?: Resolver<Array<ResolversTypes['McpApiKey']>, ParentType, ContextType>;
  mySpaces?: Resolver<Array<ResolversTypes['MySpaceResults']>, ParentType, ContextType, Partial<SchemaTypes.MeQueryResultsMySpacesArgs>>;
  notifications?: Resolver<ResolversTypes['PaginatedInAppNotifications'], ParentType, ContextType, Partial<SchemaTypes.MeQueryResultsNotificationsArgs>>;
  notificationsUnreadCount?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  spaceMembershipsFlat?: Resolver<Array<ResolversTypes['CommunityMembershipResult']>, ParentType, ContextType>;
  spaceMembershipsHierarchical?: Resolver<Array<ResolversTypes['CommunityMembershipResult']>, ParentType, ContextType, Partial<SchemaTypes.MeQueryResultsSpaceMembershipsHierarchicalArgs>>;
  user?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
};

export type MediaGalleryResolvers<ContextType = any, ParentType extends ResolversParentTypes['MediaGallery'] = ResolversParentTypes['MediaGallery']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  storageBucket?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageBucket']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type MemoSignatureResolvers<ContextType = any, ParentType extends ResolversParentTypes['MemoSignature'] = ResolversParentTypes['MemoSignature']> = {
  actor?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  document?: Resolver<SchemaTypes.Maybe<ResolversTypes['Document']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
...
export type MessageResolvers<ContextType = any, ParentType extends ResolversParentTypes['Message'] = ResolversParentTypes['Message']> = {
  ...
  sender?: Resolver<SchemaTypes.Maybe<ResolversTypes['Actor']>, ParentType, ContextType>;
  threadID?: Resolver<SchemaTypes.Maybe<ResolversTypes['MessageID']>, ParentType, ContextType>;
  timestamp?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type MessageDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['MessageDetails'] = ResolversParentTypes['MessageDetails']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MessageParentResolvers<ContextType = any, ParentType extends ResolversParentTypes['MessageParent'] = ResolversParentTypes['MessageParent']> = {
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type MessagingResolvers<ContextType = any, ParentType extends ResolversParentTypes['Messaging'] = ResolversParentTypes['Messaging']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type ModelCardAiEngineResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ModelCardAiEngineResult'] = ResolversParentTypes['ModelCardAiEngineResult']> = {
  additionalTechnicalDetails?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  areAnswersRestrictedToBodyOfKnowledge?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  canAccessWebWhenAnswering?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  ...
  isInteractionDataUsedForTraining?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  isUsingOpenWeightsModel?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type ModelCardMonitoringResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ModelCardMonitoringResult'] = ResolversParentTypes['ModelCardMonitoringResult']> = {
  isUsageMonitoredByAlkemio?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type ModelCardSpaceUsageResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ModelCardSpaceUsageResult'] = ResolversParentTypes['ModelCardSpaceUsageResult']> = {
  flags?: Resolver<Array<ResolversTypes['VirtualContributorModelCardFlag']>, ParentType, ContextType>;
  modelCardEntry?: Resolver<ResolversTypes['VirtualContributorModelCardEntry'], ParentType, ContextType>;
};

export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  addClassificationEntryFromTemplate?: Resolver<ResolversTypes['ClassificationEntry'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAddClassificationEntryFromTemplateArgs, 'classificationData'>>;
  addIframeAllowedURL?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationAddIframeAllowedUrlArgs, 'whitelistedURL'>>;
  addNotificationEmailToBlacklist?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationAddNotificationEmailToBlacklistArgs, 'input'>>;
  addPollOption?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAddPollOptionArgs, 'optionData'>>;
  addReactionToCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAddReactionToCalloutArgs, 'reactionData'>>;
  addReactionToMessageInRoom?: Resolver<ResolversTypes['Reaction'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAddReactionToMessageInRoomArgs, 'reactionData'>>;
  addVisualToMediaGallery?: Resolver<ResolversTypes['Visual'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAddVisualToMediaGalleryArgs, 'addData'>>;
  ...
  adminCommunicationMigrateOrphanedConversations?: Resolver<ResolversTypes['CommunicationAdminMigrateRoomsResult'], ParentType, ContextType>;
  ...
  adminCommunicationSyncSpaceHierarchy?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  adminCommunicationUpdateRoomState?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminCommunicationUpdateRoomStateArgs, 'roomStateData'>>;
  adminIdentityDeleteKratosIdentity?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminIdentityDeleteKratosIdentityArgs, 'kratosIdentityId'>>;
  adminInAppNotificationsPrune?: Resolver<ResolversTypes['PruneInAppNotificationAdminResult'], ParentType, ContextType>;
  adminLicensePolicyCreateCredentialRule?: Resolver<ResolversTypes['LicensingCredentialBasedPolicyCredentialRule'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminLicensePolicyCreateCredentialRuleArgs, 'createData'>>;
  adminLicensePolicyDeleteCredentialRule?: Resolver<ResolversTypes['LicensingCredentialBasedPolicyCredentialRule'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminLicensePolicyDeleteCredentialRuleArgs, 'deleteData'>>;
  adminLicensePolicyUpdateCredentialRule?: Resolver<ResolversTypes['LicensingCredentialBasedPolicyCredentialRule'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminLicensePolicyUpdateCredentialRuleArgs, 'updateData'>>;
  adminRevokeMcpApiKey?: Resolver<ResolversTypes['McpApiKey'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminRevokeMcpApiKeyArgs, 'revokeData'>>;
  adminSearchIngestFromScratch?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  adminUpdateContributorAvatars?: Resolver<ResolversTypes['Profile'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminUpdateContributorAvatarsArgs, 'profileID'>>;
  adminUpdateGeoLocationData?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  adminUserAccountDelete?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminUserAccountDeleteArgs, 'userID'>>;
  adminUserEmailChange?: Resolver<ResolversTypes['UserEmailChangeResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminUserEmailChangeArgs, 'adminUserEmailChangeData'>>;
  adminUserEmailChangeDriftResolve?: Resolver<ResolversTypes['UserEmailChangeResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminUserEmailChangeDriftResolveArgs, 'adminUserEmailChangeDriftResolveData'>>;
  adminWingbackCreateTestCustomer?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  adminWingbackGetCustomerEntitlements?: Resolver<Array<ResolversTypes['LicensingGrantedEntitlement']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationAdminWingbackGetCustomerEntitlementsArgs, 'customerID'>>;
  aiServerAuthorizationPolicyReset?: Resolver<ResolversTypes['AiServer'], ParentType, ContextType>;
  aiServerCreateAiPersona?: Resolver<ResolversTypes['AiPersona'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAiServerCreateAiPersonaArgs, 'aiPersonaData'>>;
  aiServerDeleteAiPersona?: Resolver<ResolversTypes['AiPersona'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAiServerDeleteAiPersonaArgs, 'deleteData'>>;
  aiServerUpdateAiPersona?: Resolver<ResolversTypes['AiPersona'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAiServerUpdateAiPersonaArgs, 'aiPersonaData'>>;
  applyForEntryRoleOnRoleSet?: Resolver<ResolversTypes['Application'], ParentType, ContextType, RequireFields<SchemaTypes.MutationApplyForEntryRoleOnRoleSetArgs, 'applicationData'>>;
  assignConversationMember?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignConversationMemberArgs, 'memberData'>>;
  assignLicensePlanToAccount?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignLicensePlanToAccountArgs, 'planData'>>;
  assignLicensePlanToSpace?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignLicensePlanToSpaceArgs, 'planData'>>;
  assignPlatformRoleToUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignPlatformRoleToUserArgs, 'roleData'>>;
  assignRole?: Resolver<ResolversTypes['Actor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignRoleArgs, 'roleData'>>;
  assignRoleToOrganization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignRoleToOrganizationArgs, 'roleData'>>;
  assignRoleToUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignRoleToUserArgs, 'roleData'>>;
  assignRoleToVirtualContributor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAssignRoleToVirtualContributorArgs, 'roleData'>>;
  ...
  authorizationPlatformRolesAccessReset?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  authorizationPolicyResetAll?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  authorizationPolicyResetOnAccount?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAuthorizationPolicyResetOnAccountArgs, 'authorizationResetData'>>;
  ...
  authorizationPolicyResetToGlobalAdminsAccess?: Resolver<ResolversTypes['Authorization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationAuthorizationPolicyResetToGlobalAdminsAccessArgs, 'authorizationID'>>;
  castPollVote?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCastPollVoteArgs, 'voteData'>>;
  cleanupCollections?: Resolver<ResolversTypes['MigrateEmbeddings'], ParentType, ContextType>;
  continueMemoSigning?: Resolver<ResolversTypes['MemoSigningContinueResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationContinueMemoSigningArgs, 'signingData'>>;
  convertSpaceL1ToSpaceL0?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationConvertSpaceL1ToSpaceL0Args, 'convertData'>>;
  convertSpaceL1ToSpaceL2?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationConvertSpaceL1ToSpaceL2Args, 'convertData'>>;
  convertSpaceL2ToSpaceL1?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationConvertSpaceL2ToSpaceL1Args, 'convertData'>>;
  convertVirtualContributorToUseKnowledgeBase?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationConvertVirtualContributorToUseKnowledgeBaseArgs, 'conversionData'>>;
  createCalloutOnCalloutsSet?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateCalloutOnCalloutsSetArgs, 'calloutData'>>;
  createClassificationEntry?: Resolver<ResolversTypes['ClassificationEntry'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateClassificationEntryArgs, 'classificationData'>>;
  createContributionOnCallout?: Resolver<ResolversTypes['CalloutContribution'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateContributionOnCalloutArgs, 'contributionData'>>;
  createConversation?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateConversationArgs, 'conversationData'>>;
  ...
  createEventOnCalendar?: Resolver<ResolversTypes['CalendarEvent'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateEventOnCalendarArgs, 'eventData'>>;
  ...
  createInnovationHub?: Resolver<ResolversTypes['InnovationHub'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateInnovationHubArgs, 'createData'>>;
  createInnovationPack?: Resolver<ResolversTypes['InnovationPack'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateInnovationPackArgs, 'innovationPackData'>>;
  createLicensePlan?: Resolver<ResolversTypes['LicensePlan'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateLicensePlanArgs, 'planData'>>;
  ...
  createSpace?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateSpaceArgs, 'spaceData'>>;
  createStateOnInnovationFlow?: Resolver<ResolversTypes['InnovationFlowState'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateStateOnInnovationFlowArgs, 'stateData'>>;
  createSubspace?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateSubspaceArgs, 'subspaceData'>>;
  ...
  createTaskColumnOnCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateTaskColumnOnCalloutArgs, 'columnData'>>;
  createTemplate?: Resolver<ResolversTypes['Template'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateTemplateArgs, 'templateData'>>;
  createTemplateFromContentSpace?: Resolver<ResolversTypes['Template'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateTemplateFromContentSpaceArgs, 'templateData'>>;
  createTemplateFromSpace?: Resolver<ResolversTypes['Template'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateTemplateFromSpaceArgs, 'templateData'>>;
  createUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateUserArgs, 'userData'>>;
  createVirtualContributor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateVirtualContributorArgs, 'virtualContributorData'>>;
  createWhiteboardDraftOnCalloutsSet?: Resolver<ResolversTypes['UUID'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateWhiteboardDraftOnCalloutsSetArgs, 'draftData'>>;
  createWhiteboardDraftOnTemplatesSet?: Resolver<ResolversTypes['UUID'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateWhiteboardDraftOnTemplatesSetArgs, 'draftData'>>;
  createWingbackAccount?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<SchemaTypes.MutationCreateWingbackAccountArgs, 'accountID'>>;
  deleteApplication?: Resolver<ResolversTypes['Application'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteApplicationArgs, 'deleteData'>>;
  deleteCalendarEvent?: Resolver<ResolversTypes['CalendarEvent'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteCalendarEventArgs, 'deleteData'>>;
  deleteCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteCalloutArgs, 'deleteData'>>;
  deleteClassificationEntry?: Resolver<ResolversTypes['ClassificationEntry'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteClassificationEntryArgs, 'classificationData'>>;
  deleteCollaboraDocument?: Resolver<ResolversTypes['CollaboraDocument'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteCollaboraDocumentArgs, 'deleteData'>>;
  deleteContribution?: Resolver<ResolversTypes['CalloutContribution'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteContributionArgs, 'deleteData'>>;
  deleteConversation?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteConversationArgs, 'deleteData'>>;
  ...
  deleteDocument?: Resolver<ResolversTypes['Document'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteDocumentArgs, 'deleteData'>>;
  deleteInnovationHub?: Resolver<ResolversTypes['InnovationHub'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteInnovationHubArgs, 'deleteData'>>;
  deleteInnovationPack?: Resolver<ResolversTypes['InnovationPack'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteInnovationPackArgs, 'deleteData'>>;
  deleteInvitation?: Resolver<ResolversTypes['Invitation'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteInvitationArgs, 'deleteData'>>;
  deleteLicensePlan?: Resolver<ResolversTypes['LicensePlan'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteLicensePlanArgs, 'deleteData'>>;
  deleteLink?: Resolver<ResolversTypes['Link'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteLinkArgs, 'deleteData'>>;
  deleteMemo?: Resolver<ResolversTypes['Memo'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteMemoArgs, 'memoData'>>;
  ...
  deletePlatformInvitation?: Resolver<ResolversTypes['PlatformInvitation'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeletePlatformInvitationArgs, 'deleteData'>>;
  deletePost?: Resolver<ResolversTypes['Post'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeletePostArgs, 'deleteData'>>;
  ...
  deleteSpace?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteSpaceArgs, 'deleteData'>>;
  deleteStateOnInnovationFlow?: Resolver<ResolversTypes['InnovationFlowState'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteStateOnInnovationFlowArgs, 'stateData'>>;
  deleteStorageBucket?: Resolver<ResolversTypes['StorageBucket'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteStorageBucketArgs, 'deleteData'>>;
  deleteTaskColumnOnCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteTaskColumnOnCalloutArgs, 'columnData'>>;
  deleteTemplate?: Resolver<ResolversTypes['Template'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteTemplateArgs, 'deleteData'>>;
  ...
  deleteVirtualContributor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteVirtualContributorArgs, 'deleteData'>>;
  deleteVisualFromMediaGallery?: Resolver<ResolversTypes['Visual'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteVisualFromMediaGalleryArgs, 'deleteData'>>;
  deleteWhiteboard?: Resolver<ResolversTypes['Whiteboard'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteWhiteboardArgs, 'whiteboardData'>>;
  deleteWhiteboardDraft?: Resolver<ResolversTypes['UUID'], ParentType, ContextType, RequireFields<SchemaTypes.MutationDeleteWhiteboardDraftArgs, 'whiteboardID'>>;
  enablePushSubscription?: Resolver<ResolversTypes['PushSubscription'], ParentType, ContextType, RequireFields<SchemaTypes.MutationEnablePushSubscriptionArgs, 'subscriptionData'>>;
  eventOnApplication?: Resolver<ResolversTypes['Application'], ParentType, ContextType, RequireFields<SchemaTypes.MutationEventOnApplicationArgs, 'eventData'>>;
  eventOnInvitation?: Resolver<ResolversTypes['Invitation'], ParentType, ContextType, RequireFields<SchemaTypes.MutationEventOnInvitationArgs, 'eventData'>>;
  eventOnOrganizationVerification?: Resolver<ResolversTypes['OrganizationVerification'], ParentType, ContextType, RequireFields<SchemaTypes.MutationEventOnOrganizationVerificationArgs, 'eventData'>>;
  grantCredentialToActor?: Resolver<ResolversTypes['Credential'], ParentType, ContextType, RequireFields<SchemaTypes.MutationGrantCredentialToActorArgs, 'actorID' | 'credentialType'>>;
  grantCredentialToOrganization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationGrantCredentialToOrganizationArgs, 'grantCredentialData'>>;
  ...
  importCollaboraDocument?: Resolver<ResolversTypes['CalloutContribution'], ParentType, ContextType, RequireFields<SchemaTypes.MutationImportCollaboraDocumentArgs, 'file' | 'uploadData'>>;
  inviteForEntryRoleOnRoleSet?: Resolver<Array<ResolversTypes['RoleSetInvitationResult']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationInviteForEntryRoleOnRoleSetArgs, 'invitationData'>>;
  joinRoleSet?: Resolver<ResolversTypes['RoleSet'], ParentType, ContextType, RequireFields<SchemaTypes.MutationJoinRoleSetArgs, 'joinData'>>;
  leaveConversation?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationLeaveConversationArgs, 'leaveData'>>;
  licenseResetOnAccount?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<SchemaTypes.MutationLicenseResetOnAccountArgs, 'resetData'>>;
  markMessageAsReadInRoom?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMarkMessageAsReadInRoomArgs, 'messageData'>>;
  markNotificationsAsRead?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, Partial<SchemaTypes.MutationMarkNotificationsAsReadArgs>>;
  markNotificationsAsUnread?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, Partial<SchemaTypes.MutationMarkNotificationsAsUnreadArgs>>;
  migrateLegacyMemoContent?: Resolver<ResolversTypes['CollaborationMigrationResult'], ParentType, ContextType>;
  migrateLegacyWhiteboardContent?: Resolver<ResolversTypes['CollaborationMigrationResult'], ParentType, ContextType>;
  mintMcpApiKey?: Resolver<ResolversTypes['McpApiKeyMintResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMintMcpApiKeyArgs, 'mintData'>>;
  moveContributionToCallout?: Resolver<ResolversTypes['CalloutContribution'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMoveContributionToCalloutArgs, 'moveContributionData'>>;
  moveSpaceL1ToSpaceL0?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMoveSpaceL1ToSpaceL0Args, 'moveData'>>;
  moveSpaceL1ToSpaceL2?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMoveSpaceL1ToSpaceL2Args, 'moveData'>>;
  moveSpaceL2ToSpaceL1?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMoveSpaceL2ToSpaceL1Args, 'moveData'>>;
  moveTaskToColumn?: Resolver<ResolversTypes['CalloutContribution'], ParentType, ContextType, RequireFields<SchemaTypes.MutationMoveTaskToColumnArgs, 'moveData'>>;
  prepareMemoSigning?: Resolver<ResolversTypes['MemoSigningPrepareResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationPrepareMemoSigningArgs, 'signingData'>>;
  refreshAllBodiesOfKnowledge?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  refreshVirtualContributorBodyOfKnowledge?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRefreshVirtualContributorBodyOfKnowledgeArgs, 'refreshData'>>;
  removeCommunityGuidelinesContent?: Resolver<ResolversTypes['CommunityGuidelines'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveCommunityGuidelinesContentArgs, 'communityGuidelinesData'>>;
  removeConversationMember?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveConversationMemberArgs, 'memberData'>>;
  removeDefaultCalloutTemplateOnInnovationFlowState?: Resolver<ResolversTypes['InnovationFlowState'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveDefaultCalloutTemplateOnInnovationFlowStateArgs, 'removeData'>>;
  removeIframeAllowedURL?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveIframeAllowedUrlArgs, 'whitelistedURL'>>;
  removeMessageOnRoom?: Resolver<ResolversTypes['MessageID'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveMessageOnRoomArgs, 'messageData'>>;
  removeNotificationEmailFromBlacklist?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveNotificationEmailFromBlacklistArgs, 'input'>>;
  removePlatformRoleFromUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemovePlatformRoleFromUserArgs, 'roleData'>>;
  removePollOption?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemovePollOptionArgs, 'optionData'>>;
  removePollVote?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemovePollVoteArgs, 'voteData'>>;
  removeReactionFromCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveReactionFromCalloutArgs, 'reactionData'>>;
  removeReactionToMessageInRoom?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveReactionToMessageInRoomArgs, 'reactionData'>>;
  removeRole?: Resolver<ResolversTypes['Actor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveRoleArgs, 'roleData'>>;
  removeRoleFromOrganization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveRoleFromOrganizationArgs, 'roleData'>>;
  removeRoleFromUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveRoleFromUserArgs, 'roleData'>>;
  removeRoleFromVirtualContributor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRemoveRoleFromVirtualContributorArgs, 'roleData'>>;
  ...
  reorderPollOptions?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationReorderPollOptionsArgs, 'optionData'>>;
  replaceCollaboraDocument?: Resolver<ResolversTypes['CollaboraDocument'], ParentType, ContextType, RequireFields<SchemaTypes.MutationReplaceCollaboraDocumentArgs, 'file' | 'replaceData'>>;
  replaceWhiteboardContentFromSource?: Resolver<ResolversTypes['Whiteboard'], ParentType, ContextType, RequireFields<SchemaTypes.MutationReplaceWhiteboardContentFromSourceArgs, 'input'>>;
  resetConversationVc?: Resolver<ResolversTypes['Conversation'], ParentType, ContextType, RequireFields<SchemaTypes.MutationResetConversationVcArgs, 'input'>>;
  resetLicenseOnAccounts?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  revokeCredentialFromActor?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRevokeCredentialFromActorArgs, 'actorID' | 'credentialType'>>;
  revokeCredentialFromOrganization?: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRevokeCredentialFromOrganizationArgs, 'revokeCredentialData'>>;
  ...
  revokeLicensePlanFromAccount?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRevokeLicensePlanFromAccountArgs, 'planData'>>;
  revokeLicensePlanFromSpace?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRevokeLicensePlanFromSpaceArgs, 'planData'>>;
  revokeMcpApiKey?: Resolver<ResolversTypes['McpApiKey'], ParentType, ContextType, RequireFields<SchemaTypes.MutationRevokeMcpApiKeyArgs, 'revokeData'>>;
  sendDirectMessageToUsers?: Resolver<Array<ResolversTypes['DirectMessageDeliveryResult']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationSendDirectMessageToUsersArgs, 'messageData'>>;
  sendMessageReplyToRoom?: Resolver<ResolversTypes['Message'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSendMessageReplyToRoomArgs, 'messageData'>>;
  sendMessageToCommunityLeads?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSendMessageToCommunityLeadsArgs, 'messageData'>>;
  sendMessageToOrganization?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSendMessageToOrganizationArgs, 'messageData'>>;
  sendMessageToRoom?: Resolver<ResolversTypes['Message'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSendMessageToRoomArgs, 'messageData'>>;
  sendMessageToUsers?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSendMessageToUsersArgs, 'messageData'>>;
  setDefaultCalloutTemplateOnInnovationFlowState?: Resolver<ResolversTypes['InnovationFlowState'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSetDefaultCalloutTemplateOnInnovationFlowStateArgs, 'setData'>>;
  setPlatformWellKnownVirtualContributor?: Resolver<ResolversTypes['PlatformWellKnownVirtualContributors'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSetPlatformWellKnownVirtualContributorArgs, 'mappingData'>>;
  subscribeToPushNotifications?: Resolver<ResolversTypes['PushSubscription'], ParentType, ContextType, RequireFields<SchemaTypes.MutationSubscribeToPushNotificationsArgs, 'subscriptionData'>>;
  transferCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationTransferCalloutArgs, 'transferData'>>;
  transferInnovationHubToAccount?: Resolver<ResolversTypes['InnovationHub'], ParentType, ContextType, RequireFields<SchemaTypes.MutationTransferInnovationHubToAccountArgs, 'transferData'>>;
  transferInnovationPackToAccount?: Resolver<ResolversTypes['InnovationPack'], ParentType, ContextType, RequireFields<SchemaTypes.MutationTransferInnovationPackToAccountArgs, 'transferData'>>;
  transferSpaceToAccount?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationTransferSpaceToAccountArgs, 'transferData'>>;
  transferVirtualContributorToAccount?: Resolver<ResolversTypes['InnovationPack'], ParentType, ContextType, RequireFields<SchemaTypes.MutationTransferVirtualContributorToAccountArgs, 'transferData'>>;
  unsubscribeFromPushNotifications?: Resolver<ResolversTypes['PushSubscription'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUnsubscribeFromPushNotificationsArgs, 'subscriptionData'>>;
  updateApplicationFormOnRoleSet?: Resolver<ResolversTypes['RoleSet'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateApplicationFormOnRoleSetArgs, 'applicationFormData'>>;
  updateAssistantActorCapabilities?: Resolver<ResolversTypes['VirtualAssistant'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateAssistantActorCapabilitiesArgs, 'grantData'>>;
  updateBaselineLicensePlanOnAccount?: Resolver<ResolversTypes['Account'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateBaselineLicensePlanOnAccountArgs, 'updateData'>>;
  updateCalendarEvent?: Resolver<ResolversTypes['CalendarEvent'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCalendarEventArgs, 'eventData'>>;
  updateCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCalloutArgs, 'calloutData'>>;
  updateCalloutPublishInfo?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCalloutPublishInfoArgs, 'calloutData'>>;
  updateCalloutVisibility?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCalloutVisibilityArgs, 'calloutData'>>;
  updateCalloutsSortOrder?: Resolver<Array<ResolversTypes['Callout']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCalloutsSortOrderArgs, 'sortOrderData'>>;
  updateClassificationEntry?: Resolver<ResolversTypes['ClassificationEntry'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateClassificationEntryArgs, 'classificationData'>>;
  updateClassificationEntryDisplay?: Resolver<ResolversTypes['ClassificationEntry'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateClassificationEntryDisplayArgs, 'classificationData'>>;
  updateClassificationEntrySelection?: Resolver<ResolversTypes['ClassificationEntry'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateClassificationEntrySelectionArgs, 'classificationData'>>;
  updateClassificationTagset?: Resolver<ResolversTypes['Tagset'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateClassificationTagsetArgs, 'updateData'>>;
  updateCollaboraDocument?: Resolver<ResolversTypes['CollaboraDocument'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCollaboraDocumentArgs, 'updateData'>>;
  updateCollaborationFromSpaceTemplate?: Resolver<ResolversTypes['Collaboration'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCollaborationFromSpaceTemplateArgs, 'updateData'>>;
  updateCommunityGuidelines?: Resolver<ResolversTypes['CommunityGuidelines'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateCommunityGuidelinesArgs, 'communityGuidelinesData'>>;
  updateContributionsSortOrder?: Resolver<Array<ResolversTypes['CalloutContribution']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateContributionsSortOrderArgs, 'sortOrderData'>>;
  updateConversation?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateConversationArgs, 'updateData'>>;
  ...
  updateDocument?: Resolver<ResolversTypes['Document'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateDocumentArgs, 'documentData'>>;
  updateInnovationFlow?: Resolver<ResolversTypes['InnovationFlow'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateInnovationFlowArgs, 'innovationFlowData'>>;
  updateInnovationFlowCurrentState?: Resolver<ResolversTypes['InnovationFlow'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateInnovationFlowCurrentStateArgs, 'innovationFlowStateData'>>;
  updateInnovationFlowState?: Resolver<ResolversTypes['InnovationFlowState'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateInnovationFlowStateArgs, 'stateData'>>;
  updateInnovationFlowStatesSortOrder?: Resolver<Array<ResolversTypes['InnovationFlowState']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateInnovationFlowStatesSortOrderArgs, 'sortOrderData'>>;
  updateInnovationHub?: Resolver<ResolversTypes['InnovationHub'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateInnovationHubArgs, 'updateData'>>;
  updateInnovationPack?: Resolver<ResolversTypes['InnovationPack'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateInnovationPackArgs, 'innovationPackData'>>;
  updateLicensePlan?: Resolver<ResolversTypes['LicensePlan'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateLicensePlanArgs, 'updateData'>>;
  updateLink?: Resolver<ResolversTypes['Link'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateLinkArgs, 'linkData'>>;
  updateMemo?: Resolver<ResolversTypes['Memo'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateMemoArgs, 'memoData'>>;
  updateNotificationState?: Resolver<ResolversTypes['NotificationEventInAppState'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateNotificationStateArgs, 'notificationData'>>;
  ...
  updateOrganizationPlatformSettings?: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateOrganizationPlatformSettingsArgs, 'organizationData'>>;
  updateOrganizationSettings?: Resolver<ResolversTypes['Organization'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateOrganizationSettingsArgs, 'settingsData'>>;
  updatePlatformSettings?: Resolver<ResolversTypes['PlatformSettings'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdatePlatformSettingsArgs, 'settingsData'>>;
  updatePollOption?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdatePollOptionArgs, 'optionData'>>;
  updatePollStatus?: Resolver<ResolversTypes['Poll'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdatePollStatusArgs, 'statusData'>>;
  updatePost?: Resolver<ResolversTypes['Post'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdatePostArgs, 'postData'>>;
  ...
  updateReference?: Resolver<ResolversTypes['Reference'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateReferenceArgs, 'referenceData'>>;
  updateSpace?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateSpaceArgs, 'spaceData'>>;
  updateSpacePlatformSettings?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateSpacePlatformSettingsArgs, 'updateData'>>;
  updateSpaceSettings?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateSpaceSettingsArgs, 'settingsData'>>;
  updateSubspacePinned?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateSubspacePinnedArgs, 'pinnedData'>>;
  updateSubspacesSortOrder?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateSubspacesSortOrderArgs, 'sortOrderData'>>;
  updateTagset?: Resolver<ResolversTypes['Tagset'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTagsetArgs, 'updateData'>>;
  updateTaskColumnOnCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTaskColumnOnCalloutArgs, 'columnData'>>;
  updateTaskColumnsSortOrderOnCallout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTaskColumnsSortOrderOnCalloutArgs, 'sortOrderData'>>;
  updateTemplate?: Resolver<ResolversTypes['Template'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTemplateArgs, 'updateData'>>;
  updateTemplateContentSpace?: Resolver<ResolversTypes['TemplateContentSpace'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTemplateContentSpaceArgs, 'templateContentSpaceData'>>;
  updateTemplateDefault?: Resolver<ResolversTypes['TemplateDefault'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTemplateDefaultArgs, 'templateDefaultData'>>;
  updateTemplateFromSpace?: Resolver<ResolversTypes['Template'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateTemplateFromSpaceArgs, 'updateData'>>;
  ...
  updateUserPlatformSettings?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateUserPlatformSettingsArgs, 'updateData'>>;
  updateUserSettings?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateUserSettingsArgs, 'settingsData'>>;
  updateVirtualContributor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateVirtualContributorArgs, 'virtualContributorData'>>;
  updateVirtualContributorPlatformSettings?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateVirtualContributorPlatformSettingsArgs, 'settingsData'>>;
  updateVirtualContributorSettings?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateVirtualContributorSettingsArgs, 'settingsData'>>;
  ...
  updateWhiteboard?: Resolver<ResolversTypes['Whiteboard'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateWhiteboardArgs, 'whiteboardData'>>;
  updateWhiteboardGuestAccess?: Resolver<ResolversTypes['UpdateWhiteboardGuestAccessResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUpdateWhiteboardGuestAccessArgs, 'input'>>;
  uploadFileOnLink?: Resolver<ResolversTypes['Link'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUploadFileOnLinkArgs, 'file' | 'uploadData'>>;
  uploadFileOnReference?: Resolver<ResolversTypes['Reference'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUploadFileOnReferenceArgs, 'file' | 'uploadData'>>;
  uploadFileOnStorageBucket?: Resolver<ResolversTypes['StorageBucketUploadFileResult'], ParentType, ContextType, RequireFields<SchemaTypes.MutationUploadFileOnStorageBucketArgs, 'file' | 'uploadData'>>;
...
export type MySpaceResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['MySpaceResults'] = ResolversParentTypes['MySpaceResults']> = {
  latestActivity?: Resolver<SchemaTypes.Maybe<ResolversTypes['ActivityLogEntry']>, ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
};
...
export type NotificationRecipientResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['NotificationRecipientResult'] = ResolversParentTypes['NotificationRecipientResult']> = {
  emailRecipients?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType>;
  inAppRecipients?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType>;
  pushRecipients?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType>;
  triggeredBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
};

export type OrganizationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Organization'] = ResolversParentTypes['Organization']> = {
  account?: Resolver<SchemaTypes.Maybe<ResolversTypes['Account']>, ParentType, ContextType>;
  actor?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  ...
  metrics?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['NVP']>>, ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['Profile']>, ParentType, ContextType>;
  roleSet?: Resolver<ResolversTypes['RoleSet'], ParentType, ContextType>;
  settings?: Resolver<ResolversTypes['OrganizationSettings'], ParentType, ContextType>;
  storageAggregator?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageAggregator']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['ActorType'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type PaginatedInAppNotificationsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaginatedInAppNotifications'] = ResolversParentTypes['PaginatedInAppNotifications']> = {
  inAppNotifications?: Resolver<Array<ResolversTypes['InAppNotification']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type PaginatedInnovationPacksResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaginatedInnovationPacks'] = ResolversParentTypes['PaginatedInnovationPacks']> = {
  innovationPacks?: Resolver<Array<ResolversTypes['InnovationPack']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type PaginatedLibraryTemplateResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaginatedLibraryTemplateResults'] = ResolversParentTypes['PaginatedLibraryTemplateResults']> = {
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  templateResults?: Resolver<Array<ResolversTypes['TemplateResult']>, ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};
...
export type PaginatedVirtualContributorResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaginatedVirtualContributor'] = ResolversParentTypes['PaginatedVirtualContributor']> = {
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  virtualContributors?: Resolver<Array<ResolversTypes['VirtualContributor']>, ParentType, ContextType>;
};
...
export type PlatformResolvers<ContextType = any, ParentType extends ResolversParentTypes['Platform'] = ResolversParentTypes['Platform']> = {
  ...
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  innovationHub?: Resolver<SchemaTypes.Maybe<ResolversTypes['InnovationHub']>, ParentType, ContextType, Partial<SchemaTypes.PlatformInnovationHubArgs>>;
  latestReleaseDiscussion?: Resolver<SchemaTypes.Maybe<ResolversTypes['LatestReleaseDiscussion']>, ParentType, ContextType>;
  ...
  messaging?: Resolver<SchemaTypes.Maybe<ResolversTypes['Messaging']>, ParentType, ContextType>;
  metadata?: Resolver<ResolversTypes['Metadata'], ParentType, ContextType>;
  roleSet?: Resolver<ResolversTypes['RoleSet'], ParentType, ContextType>;
  settings?: Resolver<ResolversTypes['PlatformSettings'], ParentType, ContextType>;
  storageAggregator?: Resolver<ResolversTypes['StorageAggregator'], ParentType, ContextType>;
  templatesManager?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplatesManager']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  virtualAssistantAccess?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  wellKnownVirtualContributors?: Resolver<ResolversTypes['PlatformWellKnownVirtualContributors'], ParentType, ContextType>;
};

export type PlatformAccessRoleResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformAccessRole'] = ResolversParentTypes['PlatformAccessRole']> = {
  grantedPrivileges?: Resolver<Array<ResolversTypes['AuthorizationPrivilege']>, ParentType, ContextType>;
  roleName?: Resolver<ResolversTypes['RoleName'], ParentType, ContextType>;
};

export type PlatformAdminCommunicationQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformAdminCommunicationQueryResults'] = ResolversParentTypes['PlatformAdminCommunicationQueryResults']> = {
  adminCommunicationMembership?: Resolver<ResolversTypes['CommunicationAdminMembershipResult'], ParentType, ContextType, RequireFields<SchemaTypes.PlatformAdminCommunicationQueryResultsAdminCommunicationMembershipArgs, 'communicationData'>>;
  adminCommunicationOrphanedUsage?: Resolver<ResolversTypes['CommunicationAdminOrphanedUsageResult'], ParentType, ContextType>;
};

export type PlatformAdminIdentityQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformAdminIdentityQueryResults'] = ResolversParentTypes['PlatformAdminIdentityQueryResults']> = {
  identities?: Resolver<Array<ResolversTypes['KratosIdentity']>, ParentType, ContextType, RequireFields<SchemaTypes.PlatformAdminIdentityQueryResultsIdentitiesArgs, 'filter'>>;
};

export type PlatformAdminQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformAdminQueryResults'] = ResolversParentTypes['PlatformAdminQueryResults']> = {
  accounts?: Resolver<Array<ResolversTypes['Account']>, ParentType, ContextType>;
  communication?: Resolver<ResolversTypes['PlatformAdminCommunicationQueryResults'], ParentType, ContextType>;
  identity?: Resolver<ResolversTypes['PlatformAdminIdentityQueryResults'], ParentType, ContextType>;
  innovationHubs?: Resolver<Array<ResolversTypes['InnovationHub']>, ParentType, ContextType>;
  innovationPacks?: Resolver<Array<ResolversTypes['InnovationPack']>, ParentType, ContextType, Partial<SchemaTypes.PlatformAdminQueryResultsInnovationPacksArgs>>;
  latestUserEmailChangeAuditEntry?: Resolver<SchemaTypes.Maybe<ResolversTypes['UserEmailChangeAuditEntry']>, ParentType, ContextType, RequireFields<SchemaTypes.PlatformAdminQueryResultsLatestUserEmailChangeAuditEntryArgs, 'userID'>>;
  mcpApiKeys?: Resolver<Array<ResolversTypes['McpApiKey']>, ParentType, ContextType, RequireFields<SchemaTypes.PlatformAdminQueryResultsMcpApiKeysArgs, 'userID'>>;
  organizations?: Resolver<ResolversTypes['PaginatedOrganization'], ParentType, ContextType, Partial<SchemaTypes.PlatformAdminQueryResultsOrganizationsArgs>>;
  spaces?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType, Partial<SchemaTypes.PlatformAdminQueryResultsSpacesArgs>>;
  userEmailChangeAuditEntries?: Resolver<ResolversTypes['UserEmailChangeAuditEntries'], ParentType, ContextType, RequireFields<SchemaTypes.PlatformAdminQueryResultsUserEmailChangeAuditEntriesArgs, 'userID'>>;
  users?: Resolver<ResolversTypes['PaginatedUsers'], ParentType, ContextType, Partial<SchemaTypes.PlatformAdminQueryResultsUsersArgs>>;
  virtualAssistant?: Resolver<ResolversTypes['VirtualAssistant'], ParentType, ContextType>;
  virtualContributors?: Resolver<Array<ResolversTypes['VirtualContributor']>, ParentType, ContextType, Partial<SchemaTypes.PlatformAdminQueryResultsVirtualContributorsArgs>>;
};
...
export type PlatformIntegrationSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformIntegrationSettings'] = ResolversParentTypes['PlatformIntegrationSettings']> = {
  ...
  notificationEmailBlacklist?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
};
...
export type PlatformInvitationResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformInvitation'] = ResolversParentTypes['PlatformInvitation']> = {
  ...
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  lastName?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  platformRole?: Resolver<SchemaTypes.Maybe<ResolversTypes['RoleName']>, ParentType, ContextType>;
  profileCreated?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  roleSetExtraRoles?: Resolver<Array<ResolversTypes['RoleName']>, ParentType, ContextType>;
...
export type PlatformRolesAccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformRolesAccess'] = ResolversParentTypes['PlatformRolesAccess']> = {
  roles?: Resolver<Array<ResolversTypes['PlatformAccessRole']>, ParentType, ContextType>;
};
...
export type PlatformWellKnownVirtualContributorMappingResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformWellKnownVirtualContributorMapping'] = ResolversParentTypes['PlatformWellKnownVirtualContributorMapping']> = {
  virtualContributorID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  wellKnown?: Resolver<ResolversTypes['VirtualContributorWellKnown'], ParentType, ContextType>;
};

export type PlatformWellKnownVirtualContributorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlatformWellKnownVirtualContributors'] = ResolversParentTypes['PlatformWellKnownVirtualContributors']> = {
  mappings?: Resolver<Array<ResolversTypes['PlatformWellKnownVirtualContributorMapping']>, ParentType, ContextType>;
};

export type PollResolvers<ContextType = any, ParentType extends ResolversParentTypes['Poll'] = ResolversParentTypes['Poll']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  canSeeDetailedResults?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  deadline?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  myVote?: Resolver<SchemaTypes.Maybe<ResolversTypes['PollVote']>, ParentType, ContextType>;
  ...
  totalVotes?: Resolver<SchemaTypes.Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type PollOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PollOption'] = ResolversParentTypes['PollOption']> = {
  ...
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  voteCount?: Resolver<SchemaTypes.Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  votePercentage?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  voters?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['User']>>, ParentType, ContextType>;
};

export type PollOptionsChangedSubscriptionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['PollOptionsChangedSubscriptionResult'] = ResolversParentTypes['PollOptionsChangedSubscriptionResult']> = {
  poll?: Resolver<ResolversTypes['Poll'], ParentType, ContextType>;
  pollEventType?: Resolver<ResolversTypes['PollEventType'], ParentType, ContextType>;
};

export type PollSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PollSettings'] = ResolversParentTypes['PollSettings']> = {
  allowContributorsAddOptions?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  ...
  resultsDetail?: Resolver<ResolversTypes['PollResultsDetail'], ParentType, ContextType>;
  resultsVisibility?: Resolver<ResolversTypes['PollResultsVisibility'], ParentType, ContextType>;
};

export type PollSettingsDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['PollSettingsData'] = ResolversParentTypes['PollSettingsData']> = {
  allowContributorsAddOptions?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  maxResponses?: Resolver<SchemaTypes.Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  minResponses?: Resolver<SchemaTypes.Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  resultsDetail?: Resolver<SchemaTypes.Maybe<ResolversTypes['PollResultsDetail']>, ParentType, ContextType>;
  resultsVisibility?: Resolver<SchemaTypes.Maybe<ResolversTypes['PollResultsVisibility']>, ParentType, ContextType>;
};

export type PollVoteResolvers<ContextType = any, ParentType extends ResolversParentTypes['PollVote'] = ResolversParentTypes['PollVote']> = {
  createdBy?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  selectedOptions?: Resolver<Array<ResolversTypes['PollOption']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type PollVoteUpdatedSubscriptionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['PollVoteUpdatedSubscriptionResult'] = ResolversParentTypes['PollVoteUpdatedSubscriptionResult']> = {
  poll?: Resolver<ResolversTypes['Poll'], ParentType, ContextType>;
  pollEventType?: Resolver<ResolversTypes['PollEventType'], ParentType, ContextType>;
};
...
export type ProfileResolvers<ContextType = any, ParentType extends ResolversParentTypes['Profile'] = ResolversParentTypes['Profile']> = {
  ...
  tagline?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  tagset?: Resolver<SchemaTypes.Maybe<ResolversTypes['Tagset']>, ParentType, ContextType, Partial<SchemaTypes.ProfileTagsetArgs>>;
  tagsets?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Tagset']>>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['ProfileType']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  visual?: Resolver<SchemaTypes.Maybe<ResolversTypes['Visual']>, ParentType, ContextType, RequireFields<SchemaTypes.ProfileVisualArgs, 'type'>>;
  visuals?: Resolver<Array<ResolversTypes['Visual']>, ParentType, ContextType>;
};

export type PromptGraphResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraph'] = ResolversParentTypes['PromptGraph']> = {
  edges?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['PromptGraphEdge']>>, ParentType, ContextType>;
  end?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  nodes?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['PromptGraphNode']>>, ParentType, ContextType>;
  start?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  state?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraphDataStruct']>, ParentType, ContextType>;
};

export type PromptGraphDataPointResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDataPoint'] = ResolversParentTypes['PromptGraphDataPoint']> = {
  description?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  items?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraphDataStruct']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  optional?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type PromptGraphDataStructResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDataStruct'] = ResolversParentTypes['PromptGraphDataStruct']> = {
  properties?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['PromptGraphDataPoint']>>, ParentType, ContextType>;
  title?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type PromptGraphDefinitionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDefinition'] = ResolversParentTypes['PromptGraphDefinition']> = {
  edges?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['PromptGraphDefinitionEdge']>>, ParentType, ContextType>;
  end?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  nodes?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['PromptGraphDefinitionNode']>>, ParentType, ContextType>;
  start?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  state?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraphDefinitionDataStruct']>, ParentType, ContextType>;
};

export type PromptGraphDefinitionDataPointResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDefinitionDataPoint'] = ResolversParentTypes['PromptGraphDefinitionDataPoint']> = {
  description?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  optional?: Resolver<SchemaTypes.Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PromptGraphDefinitionDataStructResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDefinitionDataStruct'] = ResolversParentTypes['PromptGraphDefinitionDataStruct']> = {
  properties?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['PromptGraphDefinitionDataPoint']>>, ParentType, ContextType>;
  title?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type PromptGraphDefinitionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDefinitionEdge'] = ResolversParentTypes['PromptGraphDefinitionEdge']> = {
  from?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  to?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type PromptGraphDefinitionNodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphDefinitionNode'] = ResolversParentTypes['PromptGraphDefinitionNode']> = {
  input_variables?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  output?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraphDefinitionDataStruct']>, ParentType, ContextType>;
  prompt?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  system?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type PromptGraphEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphEdge'] = ResolversParentTypes['PromptGraphEdge']> = {
  from?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  to?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type PromptGraphNodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PromptGraphNode'] = ResolversParentTypes['PromptGraphNode']> = {
  input_variables?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  output?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraphDataStruct']>, ParentType, ContextType>;
  prompt?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  system?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type PruneInAppNotificationAdminResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['PruneInAppNotificationAdminResult'] = ResolversParentTypes['PruneInAppNotificationAdminResult']> = {
  removedCountExceedingUserLimit?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  removedCountOutsideRetentionPeriod?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
};
...
export type PushSubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PushSubscription'] = ResolversParentTypes['PushSubscription']> = {
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  lastActiveDate?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  status?: Resolver<ResolversTypes['PushSubscriptionStatus'], ParentType, ContextType>;
  userAgent?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  activityFeed?: Resolver<ResolversTypes['ActivityFeed'], ParentType, ContextType, Partial<SchemaTypes.QueryActivityFeedArgs>>;
  activityFeedGrouped?: Resolver<Array<ResolversTypes['ActivityLogEntry']>, ParentType, ContextType, Partial<SchemaTypes.QueryActivityFeedGroupedArgs>>;
  activityLogOnCollaboration?: Resolver<Array<ResolversTypes['ActivityLogEntry']>, ParentType, ContextType, RequireFields<SchemaTypes.QueryActivityLogOnCollaborationArgs, 'queryData'>>;
  actor?: Resolver<SchemaTypes.Maybe<ResolversTypes['ActorFull']>, ParentType, ContextType, RequireFields<SchemaTypes.QueryActorArgs, 'id'>>;
  actorsWithCredential?: Resolver<Array<ResolversTypes['ActorFull']>, ParentType, ContextType, RequireFields<SchemaTypes.QueryActorsWithCredentialArgs, 'credentialType'>>;
  adminIdentitiesUnverified?: Resolver<Array<ResolversTypes['KratosIdentity']>, ParentType, ContextType>;
  aiServer?: Resolver<ResolversTypes['AiServer'], ParentType, ContextType>;
  collaboraEditorUrl?: Resolver<ResolversTypes['CollaboraEditorUrlResult'], ParentType, ContextType, RequireFields<SchemaTypes.QueryCollaboraEditorUrlArgs, 'collaboraDocumentID'>>;
  collaboraServiceAvailable?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<SchemaTypes.QueryCollaboraServiceAvailableArgs, 'collaboraDocumentID'>>;
  exploreSpaces?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType, Partial<SchemaTypes.QueryExploreSpacesArgs>>;
  ...
  myPushSubscriptions?: Resolver<Array<ResolversTypes['PushSubscription']>, ParentType, ContextType>;
  notificationRecipients?: Resolver<ResolversTypes['NotificationRecipientResult'], ParentType, ContextType, RequireFields<SchemaTypes.QueryNotificationRecipientsArgs, 'eventData'>>;
  ...
  platformAdmin?: Resolver<ResolversTypes['PlatformAdminQueryResults'], ParentType, ContextType>;
  platformCapabilities?: Resolver<Array<ResolversTypes['AssistantCapability']>, ParentType, ContextType>;
  restrictedSpaceNames?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  rolesOrganization?: Resolver<ResolversTypes['ActorRoles'], ParentType, ContextType, RequireFields<SchemaTypes.QueryRolesOrganizationArgs, 'rolesData'>>;
  rolesUser?: Resolver<ResolversTypes['ActorRoles'], ParentType, ContextType, RequireFields<SchemaTypes.QueryRolesUserArgs, 'rolesData'>>;
  rolesVirtualContributor?: Resolver<ResolversTypes['ActorRoles'], ParentType, ContextType, RequireFields<SchemaTypes.QueryRolesVirtualContributorArgs, 'rolesData'>>;
  search?: Resolver<ResolversTypes['ISearchResults'], ParentType, ContextType, RequireFields<SchemaTypes.QuerySearchArgs, 'searchData'>>;
  signingAttempt?: Resolver<ResolversTypes['MemoSignature'], ParentType, ContextType, RequireFields<SchemaTypes.QuerySigningAttemptArgs, 'ID'>>;
  spaces?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType, Partial<SchemaTypes.QuerySpacesArgs>>;
  spacesPaginated?: Resolver<ResolversTypes['PaginatedSpaces'], ParentType, ContextType, Partial<SchemaTypes.QuerySpacesPaginatedArgs>>;
  task?: Resolver<ResolversTypes['Task'], ParentType, ContextType, RequireFields<SchemaTypes.QueryTaskArgs, 'id'>>;
  tasks?: Resolver<Array<ResolversTypes['Task']>, ParentType, ContextType, Partial<SchemaTypes.QueryTasksArgs>>;
  urlResolver?: Resolver<ResolversTypes['UrlResolverQueryResults'], ParentType, ContextType, RequireFields<SchemaTypes.QueryUrlResolverArgs, 'url'>>;
  ...
  vapidPublicKey?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  verifyMemoSignature?: Resolver<ResolversTypes['MemoSignatureVerificationStatus'], ParentType, ContextType, RequireFields<SchemaTypes.QueryVerifyMemoSignatureArgs, 'verificationData'>>;
  virtualContributor?: Resolver<ResolversTypes['VirtualContributor'], ParentType, ContextType, RequireFields<SchemaTypes.QueryVirtualContributorArgs, 'ID'>>;
  virtualContributors?: Resolver<Array<ResolversTypes['VirtualContributor']>, ParentType, ContextType, Partial<SchemaTypes.QueryVirtualContributorsArgs>>;
};
...
export type ReactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Reaction'] = ResolversParentTypes['Reaction']> = {
  ...
  id?: Resolver<ResolversTypes['MessageID'], ParentType, ContextType>;
  sender?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  timestamp?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};
...
export type RelayPaginatedSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['RelayPaginatedSpace'] = ResolversParentTypes['RelayPaginatedSpace']> = {
  ...
  account?: Resolver<ResolversTypes['Account'], ParentType, ContextType>;
  activeSubscription?: Resolver<SchemaTypes.Maybe<ResolversTypes['SpaceSubscription']>, ParentType, ContextType>;
  ...
  credentials?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  layout?: Resolver<ResolversTypes['SpaceSettingsLayout'], ParentType, ContextType>;
  ...
  license?: Resolver<ResolversTypes['License'], ParentType, ContextType>;
  mentionableContributors?: Resolver<Array<ResolversTypes['ActorFull']>, ParentType, ContextType, Partial<SchemaTypes.RelayPaginatedSpaceMentionableContributorsArgs>>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  pinned?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  platformAccess?: Resolver<ResolversTypes['PlatformRolesAccess'], ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['Profile']>, ParentType, ContextType>;
  ...
  subspaceByNameID?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.RelayPaginatedSpaceSubspaceByNameIdArgs, 'NAMEID'>>;
  subspaces?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType, Partial<SchemaTypes.RelayPaginatedSpaceSubspacesArgs>>;
  templatesManager?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplatesManager']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['ActorType'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type RoleResolvers<ContextType = any, ParentType extends ResolversParentTypes['Role'] = ResolversParentTypes['Role']> = {
  ...
  organizationPolicy?: Resolver<ResolversTypes['ActorRolePolicy'], ParentType, ContextType>;
  ...
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  userPolicy?: Resolver<ResolversTypes['ActorRolePolicy'], ParentType, ContextType>;
  virtualContributorPolicy?: Resolver<ResolversTypes['ActorRolePolicy'], ParentType, ContextType>;
};
...
export type RoleSetResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoleSet'] = ResolversParentTypes['RoleSet']> = {
  ...
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  availableUsersForElevatedRole?: Resolver<ResolversTypes['PaginatedUsers'], ParentType, ContextType, RequireFields<SchemaTypes.RoleSetAvailableUsersForElevatedRoleArgs, 'role'>>;
  availableUsersForEntryRole?: Resolver<ResolversTypes['PaginatedUsers'], ParentType, ContextType, Partial<SchemaTypes.RoleSetAvailableUsersForEntryRoleArgs>>;
  availableVirtualContributorsForEntryRole?: Resolver<ResolversTypes['PaginatedVirtualContributor'], ParentType, ContextType, Partial<SchemaTypes.RoleSetAvailableVirtualContributorsForEntryRoleArgs>>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  ...
  license?: Resolver<ResolversTypes['License'], ParentType, ContextType>;
  myMembershipStatus?: Resolver<SchemaTypes.Maybe<ResolversTypes['CommunityMembershipStatus']>, ParentType, ContextType>;
  ...
  organizationsInRole?: Resolver<Array<ResolversTypes['Organization']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetOrganizationsInRoleArgs, 'role'>>;
  organizationsInRoles?: Resolver<Array<ResolversTypes['OrganizationsInRolesResponse']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetOrganizationsInRolesArgs, 'roles'>>;
  platformInvitations?: Resolver<Array<ResolversTypes['PlatformInvitation']>, ParentType, ContextType>;
  roleDefinition?: Resolver<ResolversTypes['Role'], ParentType, ContextType, RequireFields<SchemaTypes.RoleSetRoleDefinitionArgs, 'role'>>;
  roleDefinitions?: Resolver<Array<ResolversTypes['Role']>, ParentType, ContextType, Partial<SchemaTypes.RoleSetRoleDefinitionsArgs>>;
  roleNames?: Resolver<Array<ResolversTypes['RoleName']>, ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['RoleSetType']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  usersInRole?: Resolver<Array<ResolversTypes['User']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetUsersInRoleArgs, 'role'>>;
  usersInRoles?: Resolver<Array<ResolversTypes['UsersInRolesResponse']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetUsersInRolesArgs, 'roles'>>;
  virtualContributorsInRole?: Resolver<Array<ResolversTypes['VirtualContributor']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetVirtualContributorsInRoleArgs, 'role'>>;
  virtualContributorsInRoleInHierarchy?: Resolver<Array<ResolversTypes['VirtualContributor']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetVirtualContributorsInRoleInHierarchyArgs, 'role'>>;
  virtualContributorsInRoles?: Resolver<Array<ResolversTypes['VirtualContributorsInRolesResponse']>, ParentType, ContextType, RequireFields<SchemaTypes.RoleSetVirtualContributorsInRolesArgs, 'roles'>>;
};

export type RoleSetInvitationResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoleSetInvitationResult'] = ResolversParentTypes['RoleSetInvitationResult']> = {
  application?: Resolver<SchemaTypes.Maybe<ResolversTypes['Application']>, ParentType, ContextType>;
  invitation?: Resolver<SchemaTypes.Maybe<ResolversTypes['Invitation']>, ParentType, ContextType>;
  platformInvitation?: Resolver<SchemaTypes.Maybe<ResolversTypes['PlatformInvitation']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['RoleSetInvitationResultType'], ParentType, ContextType>;
};
...
export type RoomResolvers<ContextType = any, ParentType extends ResolversParentTypes['Room'] = ResolversParentTypes['Room']> = {
  ...
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  lastMessage?: Resolver<SchemaTypes.Maybe<ResolversTypes['Message']>, ParentType, ContextType>;
  ...
  unreadCounts?: Resolver<ResolversTypes['RoomUnreadCounts'], ParentType, ContextType, Partial<SchemaTypes.RoomUnreadCountsArgs>>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type RoomEventSubscriptionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoomEventSubscriptionResult'] = ResolversParentTypes['RoomEventSubscriptionResult']> = {
  message?: Resolver<SchemaTypes.Maybe<ResolversTypes['RoomMessageEventSubscriptionResult']>, ParentType, ContextType>;
  reaction?: Resolver<SchemaTypes.Maybe<ResolversTypes['RoomMessageReactionEventSubscriptionResult']>, ParentType, ContextType>;
  room?: Resolver<ResolversTypes['Room'], ParentType, ContextType>;
  roomID?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type RoomMessageReactionEventSubscriptionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoomMessageReactionEventSubscriptionResult'] = ResolversParentTypes['RoomMessageReactionEventSubscriptionResult']> = {
  ...
  messageID?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['MutationType'], ParentType, ContextType>;
};

export type RoomThreadUnreadCountResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoomThreadUnreadCount'] = ResolversParentTypes['RoomThreadUnreadCount']> = {
  count?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  threadId?: Resolver<ResolversTypes['MessageID'], ParentType, ContextType>;
};

export type RoomUnreadCountsResolvers<ContextType = any, ParentType extends ResolversParentTypes['RoomUnreadCounts'] = ResolversParentTypes['RoomUnreadCounts']> = {
  roomUnreadCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  threadUnreadCounts?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['RoomThreadUnreadCount']>>, ParentType, ContextType>;
};

export interface SearchCursorScalarConfig extends GraphQLScalarTypeConfig<ResolversTypes['SearchCursor'], any> {
  name: 'SearchCursor';
}
...
export type SearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchResult'] = ResolversParentTypes['SearchResult']> = {
  __resolveType: TypeResolveFn<'SearchResultCallout' | 'SearchResultCollaboraDocument' | 'SearchResultMemo' | 'SearchResultOrganization' | 'SearchResultPost' | 'SearchResultSpace' | 'SearchResultUser' | 'SearchResultWhiteboard', ParentType, ContextType>;
};
...
export type SearchResultCollaboraDocumentResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchResultCollaboraDocument'] = ResolversParentTypes['SearchResultCollaboraDocument']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  collaboraDocument?: Resolver<ResolversTypes['CollaboraDocument'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
...
export type SearchResultMemoResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchResultMemo'] = ResolversParentTypes['SearchResultMemo']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  isContribution?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  memo?: Resolver<ResolversTypes['Memo'], ParentType, ContextType>;
...
export type SearchResultSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchResultSpace'] = ResolversParentTypes['SearchResultSpace']> = {
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  parentSpace?: Resolver<SchemaTypes.Maybe<ResolversTypes['Space']>, ParentType, ContextType>;
  score?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['Space'], ParentType, ContextType>;
  terms?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['SearchResultType'], ParentType, ContextType>;
...
export type SearchResultWhiteboardResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchResultWhiteboard'] = ResolversParentTypes['SearchResultWhiteboard']> = {
  callout?: Resolver<ResolversTypes['Callout'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  isContribution?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  score?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type SpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['Space'] = ResolversParentTypes['Space']> = {
  ...
  levelZeroSpaceID?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  license?: Resolver<ResolversTypes['License'], ParentType, ContextType>;
  mentionableContributors?: Resolver<Array<ResolversTypes['ActorFull']>, ParentType, ContextType, Partial<SchemaTypes.SpaceMentionableContributorsArgs>>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  pinned?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  platformAccess?: Resolver<ResolversTypes['PlatformRolesAccess'], ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['Profile']>, ParentType, ContextType>;
  ...
  storageAggregator?: Resolver<ResolversTypes['StorageAggregator'], ParentType, ContextType>;
  subscriptions?: Resolver<Array<ResolversTypes['SpaceSubscription']>, ParentType, ContextType>;
  subspaceByNameID?: Resolver<ResolversTypes['Space'], ParentType, ContextType, RequireFields<SchemaTypes.SpaceSubspaceByNameIdArgs, 'NAMEID'>>;
  subspaces?: Resolver<Array<ResolversTypes['Space']>, ParentType, ContextType, Partial<SchemaTypes.SpaceSubspacesArgs>>;
  templatesManager?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplatesManager']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['ActorType'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  visibility?: Resolver<ResolversTypes['SpaceVisibility'], ParentType, ContextType>;
...
export type SpaceAboutResolvers<ContextType = any, ParentType extends ResolversParentTypes['SpaceAbout'] = ResolversParentTypes['SpaceAbout']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  classifications?: Resolver<Array<ResolversTypes['ClassificationEntry']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  guidelines?: Resolver<ResolversTypes['CommunityGuidelines'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  isContentPublic?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  membership?: Resolver<ResolversTypes['SpaceAboutMembership'], ParentType, ContextType>;
  metrics?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['NVP']>>, ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  provider?: Resolver<SchemaTypes.Maybe<ResolversTypes['Actor']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  who?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  why?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
};

export type SpaceAboutMembershipResolvers<ContextType = any, ParentType extends ResolversParentTypes['SpaceAboutMembership'] = ResolversParentTypes['SpaceAboutMembership']> = {
  applicationForm?: Resolver<ResolversTypes['Form'], ParentType, ContextType>;
  communityID?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  leadOrganizations?: Resolver<Array<ResolversTypes['Organization']>, ParentType, ContextType>;
...
export type SpaceSettingsCollaborationResolvers<ContextType = any, ParentType extends ResolversParentTypes['SpaceSettingsCollaboration'] = ResolversParentTypes['SpaceSettingsCollaboration']> = {
  ...
  allowGuestContributions?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  ...
  allowMembersToVideoCall?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  inheritMembershipRights?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type SpaceSettingsLayoutResolvers<ContextType = any, ParentType extends ResolversParentTypes['SpaceSettingsLayout'] = ResolversParentTypes['SpaceSettingsLayout']> = {
  calloutDescriptionDisplayMode?: Resolver<ResolversTypes['CalloutDescriptionDisplayMode'], ParentType, ContextType>;
};
...
export type SpaceSettingsPrivacyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SpaceSettingsPrivacy'] = ResolversParentTypes['SpaceSettingsPrivacy']> = {
  ...
  userInformationVisibility?: Resolver<SchemaTypes.Maybe<ResolversTypes['UserInformationVisibility']>, ParentType, ContextType>;
};
...
export type StorageAggregatorResolvers<ContextType = any, ParentType extends ResolversParentTypes['StorageAggregator'] = ResolversParentTypes['StorageAggregator']> = {
  ...
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  parentEntity?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageAggregatorParent']>, ParentType, ContextType>;
  size?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  ...
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageAggregatorType']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type StorageAggregatorParentResolvers<ContextType = any, ParentType extends ResolversParentTypes['StorageAggregatorParent'] = ResolversParentTypes['StorageAggregatorParent']> = {
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  level?: Resolver<SchemaTypes.Maybe<ResolversTypes['SpaceLevel']>, ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type StorageBucketResolvers<ContextType = any, ParentType extends ResolversParentTypes['StorageBucket'] = ResolversParentTypes['StorageBucket']> = {
  ...
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  document?: Resolver<SchemaTypes.Maybe<ResolversTypes['Document']>, ParentType, ContextType, RequireFields<SchemaTypes.StorageBucketDocumentArgs, 'ID'>>;
  documents?: Resolver<Array<ResolversTypes['Document']>, ParentType, ContextType, Partial<SchemaTypes.StorageBucketDocumentsArgs>>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  maxFileSize?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  parentEntity?: Resolver<SchemaTypes.Maybe<ResolversTypes['StorageBucketParent']>, ParentType, ContextType>;
  size?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type StorageBucketUploadFileResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['StorageBucketUploadFileResult'] = ResolversParentTypes['StorageBucketUploadFileResult']> = {
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type SubscriptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = {
  activityCreated?: SubscriptionResolver<ResolversTypes['ActivityCreatedSubscriptionResult'], "activityCreated", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionActivityCreatedArgs, 'input'>>;
  calloutPostCreated?: SubscriptionResolver<ResolversTypes['CalloutPostCreated'], "calloutPostCreated", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionCalloutPostCreatedArgs, 'calloutID'>>;
  conversationEvents?: SubscriptionResolver<ResolversTypes['ConversationEventSubscriptionResult'], "conversationEvents", ParentType, ContextType>;
  forumDiscussionUpdated?: SubscriptionResolver<ResolversTypes['Discussion'], "forumDiscussionUpdated", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionForumDiscussionUpdatedArgs, 'forumID'>>;
  inAppNotificationReceived?: SubscriptionResolver<ResolversTypes['InAppNotification'], "inAppNotificationReceived", ParentType, ContextType>;
  notificationsUnreadCount?: SubscriptionResolver<ResolversTypes['Int'], "notificationsUnreadCount", ParentType, ContextType>;
  pollOptionsChanged?: SubscriptionResolver<ResolversTypes['PollOptionsChangedSubscriptionResult'], "pollOptionsChanged", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionPollOptionsChangedArgs, 'pollID'>>;
  pollVoteUpdated?: SubscriptionResolver<ResolversTypes['PollVoteUpdatedSubscriptionResult'], "pollVoteUpdated", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionPollVoteUpdatedArgs, 'pollID'>>;
  roomEvents?: SubscriptionResolver<ResolversTypes['RoomEventSubscriptionResult'], "roomEvents", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionRoomEventsArgs, 'roomID'>>;
  subspaceCreated?: SubscriptionResolver<ResolversTypes['SubspaceCreated'], "subspaceCreated", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionSubspaceCreatedArgs, 'spaceID'>>;
  virtualContributorUpdated?: SubscriptionResolver<ResolversTypes['VirtualContributorUpdatedSubscriptionResult'], "virtualContributorUpdated", ParentType, ContextType, RequireFields<SchemaTypes.SubscriptionVirtualContributorUpdatedArgs, 'virtualContributorID'>>;
};
...
export type TagsetTemplateResolvers<ContextType = any, ParentType extends ResolversParentTypes['TagsetTemplate'] = ResolversParentTypes['TagsetTemplate']> = {
  allowedValues?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  defaultSelectedValue?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['TagsetType'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type TaskResolvers<ContextType = any, ParentType extends ResolversParentTypes['Task'] = ResolversParentTypes['Task']> = {
  ...
  end?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  errors?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  itemsCount?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  itemsDone?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  progress?: Resolver<SchemaTypes.Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  results?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  start?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  status?: Resolver<ResolversTypes['TaskStatus'], ParentType, ContextType>;
  type?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type TaskColumnCountResolvers<ContextType = any, ParentType extends ResolversParentTypes['TaskColumnCount'] = ResolversParentTypes['TaskColumnCount']> = {
...
export type TemplateResolvers<ContextType = any, ParentType extends ResolversParentTypes['Template'] = ResolversParentTypes['Template']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  callout?: Resolver<SchemaTypes.Maybe<ResolversTypes['Callout']>, ParentType, ContextType>;
  classification?: Resolver<SchemaTypes.Maybe<ResolversTypes['ClassificationTemplateContent']>, ParentType, ContextType>;
  communityGuidelines?: Resolver<SchemaTypes.Maybe<ResolversTypes['CommunityGuidelines']>, ParentType, ContextType>;
  contentSpace?: Resolver<SchemaTypes.Maybe<ResolversTypes['TemplateContentSpace']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  postDefaultDescription?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
...
export type TemplateContentSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['TemplateContentSpace'] = ResolversParentTypes['TemplateContentSpace']> = {
  about?: Resolver<ResolversTypes['SpaceAbout'], ParentType, ContextType>;
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  collaboration?: Resolver<ResolversTypes['Collaboration'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  ...
  level?: Resolver<ResolversTypes['SpaceLevel'], ParentType, ContextType>;
  settings?: Resolver<ResolversTypes['SpaceSettings'], ParentType, ContextType>;
  subspaces?: Resolver<Array<ResolversTypes['TemplateContentSpace']>, ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};
...
export type TemplateDefaultResolvers<ContextType = any, ParentType extends ResolversParentTypes['TemplateDefault'] = ResolversParentTypes['TemplateDefault']> = {
  ...
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  template?: Resolver<SchemaTypes.Maybe<ResolversTypes['Template']>, ParentType, ContextType>;
...
export type TemplatesSetResolvers<ContextType = any, ParentType extends ResolversParentTypes['TemplatesSet'] = ResolversParentTypes['TemplatesSet']> = {
  ...
  classificationTemplates?: Resolver<Array<ResolversTypes['Template']>, ParentType, ContextType>;
  classificationTemplatesCount?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  ...
  spaceTemplates?: Resolver<Array<ResolversTypes['Template']>, ParentType, ContextType>;
  spaceTemplatesCount?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type UpdateWhiteboardGuestAccessResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['UpdateWhiteboardGuestAccessResult'] = ResolversParentTypes['UpdateWhiteboardGuestAccessResult']> = {
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  whiteboard?: Resolver<SchemaTypes.Maybe<ResolversTypes['Whiteboard']>, ParentType, ContextType>;
};
...
export type UrlResolverQueryClosestAncestorResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlResolverQueryClosestAncestor'] = ResolversParentTypes['UrlResolverQueryClosestAncestor']> = {
  discussionId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  innovationHubId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  innovationPack?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultInnovationPack']>, ParentType, ContextType>;
  organizationId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  space?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultSpace']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['UrlType'], ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  userId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  virtualContributor?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultVirtualContributor']>, ParentType, ContextType>;
};
...
export type UrlResolverQueryResultCalendarResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlResolverQueryResultCalendar'] = ResolversParentTypes['UrlResolverQueryResultCalendar']> = {
  calendarEventId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};
...
export type UrlResolverQueryResultCalloutsSetResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlResolverQueryResultCalloutsSet'] = ResolversParentTypes['UrlResolverQueryResultCalloutsSet']> = {
  calloutId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  contributionId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  memoId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  postId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['UrlType'], ParentType, ContextType>;
  whiteboardId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
};
...
export type UrlResolverQueryResultSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlResolverQueryResultSpace'] = ResolversParentTypes['UrlResolverQueryResultSpace']> = {
  calendar?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultCalendar']>, ParentType, ContextType>;
  ...
  templatesSet?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultTemplatesSet']>, ParentType, ContextType>;
};
...
export type UrlResolverQueryResultTemplatesSetResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlResolverQueryResultTemplatesSet'] = ResolversParentTypes['UrlResolverQueryResultTemplatesSet']> = {
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  templateId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
};
...
export type UrlResolverQueryResultsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlResolverQueryResults'] = ResolversParentTypes['UrlResolverQueryResults']> = {
  closestAncestor?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryClosestAncestor']>, ParentType, ContextType>;
  discussionId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  innovationHubId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  innovationPack?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultInnovationPack']>, ParentType, ContextType>;
  organizationId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  space?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultSpace']>, ParentType, ContextType>;
  state?: Resolver<ResolversTypes['UrlResolverResultState'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['UrlType'], ParentType, ContextType>;
  userId?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  virtualContributor?: Resolver<SchemaTypes.Maybe<ResolversTypes['UrlResolverQueryResultVirtualContributor']>, ParentType, ContextType>;
};
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = {
  account?: Resolver<SchemaTypes.Maybe<ResolversTypes['Account']>, ParentType, ContextType>;
  actor?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  authentication?: Resolver<SchemaTypes.Maybe<ResolversTypes['UserAuthenticationResult']>, ParentType, ContextType>;
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  credentials?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, ParentType, ContextType>;
  email?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  isContactableViaEmail?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  lastName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  phone?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['Profile']>, ParentType, ContextType>;
...
export type UserAuthenticationResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserAuthenticationResult'] = ResolversParentTypes['UserAuthenticationResult']> = {
  authenticatedAt?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  createdAt?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  methods?: Resolver<Array<ResolversTypes['AuthenticationType']>, ParentType, ContextType>;
};

export type UserEmailChangeAuditEntriesResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserEmailChangeAuditEntries'] = ResolversParentTypes['UserEmailChangeAuditEntries']> = {
  auditEntries?: Resolver<Array<ResolversTypes['UserEmailChangeAuditEntry']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['UserEmailChangeAuditEntriesPageInfo'], ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
};

export type UserEmailChangeAuditEntriesPageInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserEmailChangeAuditEntriesPageInfo'] = ResolversParentTypes['UserEmailChangeAuditEntriesPageInfo']> = {
  endCursor?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasNextPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasPreviousPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  startCursor?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type UserEmailChangeAuditEntryResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserEmailChangeAuditEntry'] = ResolversParentTypes['UserEmailChangeAuditEntry']> = {
  approver?: Resolver<SchemaTypes.Maybe<ResolversTypes['EmailChangeApprover']>, ParentType, ContextType>;
  failureReason?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  initiator?: Resolver<SchemaTypes.Maybe<ResolversTypes['UserProfileSummary']>, ParentType, ContextType>;
  initiatorRole?: Resolver<ResolversTypes['UserEmailChangeInitiatorRole'], ParentType, ContextType>;
  newEmail?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  oldEmail?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  outcome?: Resolver<ResolversTypes['UserEmailChangeAuditOutcome'], ParentType, ContextType>;
  reason?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  subject?: Resolver<ResolversTypes['UserProfileSummary'], ParentType, ContextType>;
  timestamp?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type UserEmailChangeResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserEmailChangeResult'] = ResolversParentTypes['UserEmailChangeResult']> = {
  email?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};
...
export type UserProfileSummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserProfileSummary'] = ResolversParentTypes['UserProfileSummary']> = {
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
};
...
export type UserSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettings'] = ResolversParentTypes['UserSettings']> = {
  assistant?: Resolver<ResolversTypes['UserSettingsAssistant'], ParentType, ContextType>;
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  communication?: Resolver<ResolversTypes['UserSettingsCommunication'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  dashboard?: Resolver<ResolversTypes['UserSettingsDashboard'], ParentType, ContextType>;
  designVersion?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  homeSpace?: Resolver<ResolversTypes['UserSettingsHomeSpace'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  language?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  languageOfferAnswered?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  notification?: Resolver<ResolversTypes['UserSettingsNotification'], ParentType, ContextType>;
  privacy?: Resolver<ResolversTypes['UserSettingsPrivacy'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type UserSettingsAssistantResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsAssistant'] = ResolversParentTypes['UserSettingsAssistant']> = {
  enabledCapabilities?: Resolver<Array<ResolversTypes['AssistantCapabilityToggle']>, ParentType, ContextType>;
};
...
export type UserSettingsCommunicationResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsCommunication'] = ResolversParentTypes['UserSettingsCommunication']> = {
  allowOtherUsersToContactViaEmail?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  allowOtherUsersToSendMessages?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type UserSettingsDashboardResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsDashboard'] = ResolversParentTypes['UserSettingsDashboard']> = {
  activityView?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type UserSettingsHomeSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsHomeSpace'] = ResolversParentTypes['UserSettingsHomeSpace']> = {
  autoRedirect?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  spaceID?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type UserSettingsNotificationResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotification'] = ResolversParentTypes['UserSettingsNotification']> = {
  organization?: Resolver<ResolversTypes['UserSettingsNotificationOrganization'], ParentType, ContextType>;
  platform?: Resolver<ResolversTypes['UserSettingsNotificationPlatform'], ParentType, ContextType>;
  sound?: Resolver<ResolversTypes['UserSettingsNotificationSound'], ParentType, ContextType>;
  space?: Resolver<ResolversTypes['UserSettingsNotificationSpace'], ParentType, ContextType>;
  user?: Resolver<ResolversTypes['UserSettingsNotificationUser'], ParentType, ContextType>;
  virtualContributor?: Resolver<ResolversTypes['UserSettingsNotificationVirtualContributor'], ParentType, ContextType>;
};

export type UserSettingsNotificationChannelsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationChannels'] = ResolversParentTypes['UserSettingsNotificationChannels']> = {
...
export type UserSettingsNotificationOrganizationResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationOrganization'] = ResolversParentTypes['UserSettingsNotificationOrganization']> = {
  adminMentioned?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  adminMessageReceived?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationPlatformResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationPlatform'] = ResolversParentTypes['UserSettingsNotificationPlatform']> = {
  admin?: Resolver<ResolversTypes['UserSettingsNotificationPlatformAdmin'], ParentType, ContextType>;
  forumDiscussionComment?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  forumDiscussionCreated?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationPlatformAdminResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationPlatformAdmin'] = ResolversParentTypes['UserSettingsNotificationPlatformAdmin']> = {
  spaceCreated?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  userEmailChanged?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  userGlobalRoleChanged?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  userProfileCreated?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  userProfileRemoved?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationSoundResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationSound'] = ResolversParentTypes['UserSettingsNotificationSound']> = {
  chatMessage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  inAppNotification?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};

export type UserSettingsNotificationSpaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationSpace'] = ResolversParentTypes['UserSettingsNotificationSpace']> = {
  admin?: Resolver<ResolversTypes['UserSettingsNotificationSpaceAdmin'], ParentType, ContextType>;
  collaborationCalloutComment?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationCalloutContributionCreated?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationCalloutPostContributionComment?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationCalloutPublished?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationCalloutReaction?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationPollModifiedOnPollIVotedOn?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationPollVoteAffectedByOptionChange?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationPollVoteCastOnOwnPoll?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  collaborationPollVoteCastOnPollIVotedOn?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  communicationUpdates?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  communityCalendarEvents?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationSpaceAdminResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationSpaceAdmin'] = ResolversParentTypes['UserSettingsNotificationSpaceAdmin']> = {
  collaborationCalloutContributionCreated?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  communicationMessageReceived?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  communityApplicationReceived?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  communityNewMember?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  userEmailChanged?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationUserResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationUser'] = ResolversParentTypes['UserSettingsNotificationUser']> = {
  commentReply?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  conversationMessageDirect?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  conversationMessageGroup?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  membership?: Resolver<ResolversTypes['UserSettingsNotificationUserMembership'], ParentType, ContextType>;
  mentioned?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  messageReceived?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationUserMembershipResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationUserMembership'] = ResolversParentTypes['UserSettingsNotificationUserMembership']> = {
  spaceCommunityInvitationReceived?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
  spaceCommunityJoined?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};

export type UserSettingsNotificationVirtualContributorResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserSettingsNotificationVirtualContributor'] = ResolversParentTypes['UserSettingsNotificationVirtualContributor']> = {
  adminSpaceCommunityInvitation?: Resolver<ResolversTypes['UserSettingsNotificationChannels'], ParentType, ContextType>;
};
...
export type VcInteractionResolvers<ContextType = any, ParentType extends ResolversParentTypes['VcInteraction'] = ResolversParentTypes['VcInteraction']> = {
  threadID?: Resolver<ResolversTypes['MessageID'], ParentType, ContextType>;
  virtualContributorID?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type VirtualAssistantResolvers<ContextType = any, ParentType extends ResolversParentTypes['VirtualAssistant'] = ResolversParentTypes['VirtualAssistant']> = {
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  capabilityGrant?: Resolver<Array<ResolversTypes['AssistantCapabilityToggle']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  credentials?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
...
export type VirtualContributorResolvers<ContextType = any, ParentType extends ResolversParentTypes['VirtualContributor'] = ResolversParentTypes['VirtualContributor']> = {
  account?: Resolver<SchemaTypes.Maybe<ResolversTypes['Account']>, ParentType, ContextType>;
  actor?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  aiPersona?: Resolver<SchemaTypes.Maybe<ResolversTypes['AiPersona']>, ParentType, ContextType>;
  authorization?: Resolver<SchemaTypes.Maybe<ResolversTypes['Authorization']>, ParentType, ContextType>;
  bodyOfKnowledgeDescription?: Resolver<SchemaTypes.Maybe<ResolversTypes['Markdown']>, ParentType, ContextType>;
  bodyOfKnowledgeID?: Resolver<SchemaTypes.Maybe<ResolversTypes['UUID']>, ParentType, ContextType>;
  bodyOfKnowledgeLastUpdated?: Resolver<SchemaTypes.Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  bodyOfKnowledgeType?: Resolver<ResolversTypes['VirtualContributorBodyOfKnowledgeType'], ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  credentials?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['Credential']>>, ParentType, ContextType>;
  dataAccessMode?: Resolver<ResolversTypes['VirtualContributorDataAccessMode'], ParentType, ContextType>;
  engine?: Resolver<ResolversTypes['AiPersonaEngine'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  interactionModes?: Resolver<ResolversTypes['VirtualContributorInteractionMode'], ParentType, ContextType>;
  knowledgeBase?: Resolver<ResolversTypes['KnowledgeBase'], ParentType, ContextType>;
  knowledgeSpace?: Resolver<SchemaTypes.Maybe<ResolversTypes['Space']>, ParentType, ContextType>;
  listedInStore?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  modelCard?: Resolver<ResolversTypes['VirtualContributorModelCard'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  platformSettings?: Resolver<ResolversTypes['VirtualContributorPlatformSettings'], ParentType, ContextType>;
  profile?: Resolver<SchemaTypes.Maybe<ResolversTypes['Profile']>, ParentType, ContextType>;
  promptGraphDefinition?: Resolver<SchemaTypes.Maybe<ResolversTypes['PromptGraphDefinition']>, ParentType, ContextType>;
  provider?: Resolver<ResolversTypes['Actor'], ParentType, ContextType>;
  searchVisibility?: Resolver<ResolversTypes['SearchVisibility'], ParentType, ContextType>;
  ...
  type?: Resolver<ResolversTypes['ActorType'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  wellKnownVirtualContributor?: Resolver<SchemaTypes.Maybe<ResolversTypes['VirtualContributorWellKnown']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type VirtualContributorModelCardResolvers<ContextType = any, ParentType extends ResolversParentTypes['VirtualContributorModelCard'] = ResolversParentTypes['VirtualContributorModelCard']> = {
  aiEngine?: Resolver<SchemaTypes.Maybe<ResolversTypes['ModelCardAiEngineResult']>, ParentType, ContextType>;
  monitoring?: Resolver<SchemaTypes.Maybe<ResolversTypes['ModelCardMonitoringResult']>, ParentType, ContextType>;
  spaceUsage?: Resolver<SchemaTypes.Maybe<Array<ResolversTypes['ModelCardSpaceUsageResult']>>, ParentType, ContextType>;
};

export type VirtualContributorModelCardFlagResolvers<ContextType = any, ParentType extends ResolversParentTypes['VirtualContributorModelCardFlag'] = ResolversParentTypes['VirtualContributorModelCardFlag']> = {
  enabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['VirtualContributorModelCardEntryFlagName'], ParentType, ContextType>;
};

export type VirtualContributorPlatformSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['VirtualContributorPlatformSettings'] = ResolversParentTypes['VirtualContributorPlatformSettings']> = {
  promptGraphEditingEnabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};
...
export type VisualResolvers<ContextType = any, ParentType extends ResolversParentTypes['Visual'] = ResolversParentTypes['Visual']> = {
  ...
  alternativeText?: Resolver<SchemaTypes.Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type WhiteboardResolvers<ContextType = any, ParentType extends ResolversParentTypes['Whiteboard'] = ResolversParentTypes['Whiteboard']> = {
  ...
  createdBy?: Resolver<SchemaTypes.Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  createdDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  guestContributionsAllowed?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['UUID'], ParentType, ContextType>;
  isMultiUser?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  nameID?: Resolver<ResolversTypes['NameID'], ParentType, ContextType>;
  previewSettings?: Resolver<ResolversTypes['WhiteboardPreviewSettings'], ParentType, ContextType>;
  profile?: Resolver<ResolversTypes['Profile'], ParentType, ContextType>;
  updatedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type WhiteboardPreviewCoordinatesResolvers<ContextType = any, ParentType extends ResolversParentTypes['WhiteboardPreviewCoordinates'] = ResolversParentTypes['WhiteboardPreviewCoordinates']> = {
...
export type WhiteboardPreviewCoordinatesDataResolvers<ContextType = any, ParentType extends ResolversParentTypes['WhiteboardPreviewCoordinatesData'] = ResolversParentTypes['WhiteboardPreviewCoordinatesData']> = {
  height?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  width?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  x?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  y?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
...
export type WhiteboardPreviewSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['WhiteboardPreviewSettings'] = ResolversParentTypes['WhiteboardPreviewSettings']> = {
  coordinates?: Resolver<SchemaTypes.Maybe<ResolversTypes['WhiteboardPreviewCoordinates']>, ParentType, ContextType>;
  mode?: Resolver<ResolversTypes['WhiteboardPreviewMode'], ParentType, ContextType>;
};
...
export type ActivityFeedGroupedQuery = { activityFeedGrouped: Array<
    ...
    | { id: string, type: SchemaTypes.ActivityEventType, createdDate: Date, triggeredBy: { id: string }, space?: { id: string } | undefined }
    | { id: string, type: SchemaTypes.ActivityEventType, createdDate: Date, triggeredBy: { id: string }, space?: { id: string } | undefined }
    | { actorType: SchemaTypes.ActorType, id: string, type: SchemaTypes.ActivityEventType, createdDate: Date, actor: { id: string }, triggeredBy: { id: string }, space?: { id: string } | undefined }
    | { id: string, type: SchemaTypes.ActivityEventType, createdDate: Date, triggeredBy: { id: string }, space?: { id: string } | undefined }
    | { id: string, type: SchemaTypes.ActivityEventType, createdDate: Date, triggeredBy: { id: string }, space?: { id: string } | undefined }
  > };
...
export type MeQuery = { me: { user?: { id: string, nameID: string, email: string, profile?: { displayName: string, url: string, avatar?: { uri: string } | undefined, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined } | undefined } | undefined } };

export type MySpacesHierarchicalQueryVariables = SchemaTypes.Exact<{
  limit?: SchemaTypes.InputMaybe<SchemaTypes.Scalars['Float']['input']>;
}>;


export type MySpacesHierarchicalQuery = { me: { user?: { id: string, nameID: string, email: string, profile?: { displayName: string, url: string, avatar?: { uri: string } | undefined, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined } | undefined } | undefined, spaceMembershipsHierarchical: Array<{ space: { id: string, nameID: string, createdDate: Date, visibility: SchemaTypes.SpaceVisibility, about: { id: string, isContentPublic: boolean, membership: { myPrivileges?: Array<SchemaTypes.AuthorizationPrivilege> | undefined }, classifications: Array<{ id: string, displayLabel: string, cardinality: SchemaTypes.ClassificationCardinality, display: boolean, sortOrder: number, values: Array<{ id: string, label: string }>, selectedValues: Array<{ id: string, label: string }> }>, profile: { id: string, displayName: string, tagline?: string | undefined, url: string, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, avatar?: { uri: string } | undefined, banner?: { uri: string } | undefined, bannerWide?: { uri: string } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType, allowedValues: Array<string> }> | undefined } }, community: { id: string, roleSet: { memberUsers: Array<{ id: string }>, memberOrganizations: Array<{ id: string, nameID: string, profile?: { displayName: string, url: string, avatar?: { uri: string } | undefined, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType }> | undefined } | undefined }>, leadOrganizations: Array<{ id: string, nameID: string, profile?: { displayName: string, url: string, avatar?: { uri: string } | undefined, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType }> | undefined } | undefined }>, leadUsers: Array<{ id: string }>, adminUsers: Array<{ id: string }> } }, subspaces: Array<{ id: string, nameID: string, createdDate: Date, visibility: SchemaTypes.SpaceVisibility, about: { id: string, isContentPublic: boolean, membership: { myPrivileges?: Array<SchemaTypes.AuthorizationPrivilege> | undefined }, classifications: Array<{ id: string, displayLabel: string, cardinality: SchemaTypes.ClassificationCardinality, display: boolean, sortOrder: number, values: Array<{ id: string, label: string }>, selectedValues: Array<{ id: string, label: string }> }>, profile: { id: string, displayName: string, tagline?: string | undefined, url: string, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, avatar?: { uri: string } | undefined, banner?: { uri: string } | undefined, bannerWide?: { uri: string } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType, allowedValues: Array<string> }> | undefined } } }> } }> } };
...
export type SpaceAboutOnlyByNameQueryVariables = SchemaTypes.Exact<{
  nameId: SchemaTypes.Scalars['NameID']['input'];
}>;


export type SpaceAboutOnlyByNameQuery = { lookupByName: { space?: { id: string, nameID: string, createdDate: Date, visibility: SchemaTypes.SpaceVisibility, about: { id: string, isContentPublic: boolean, membership: { myPrivileges?: Array<SchemaTypes.AuthorizationPrivilege> | undefined }, classifications: Array<{ id: string, displayLabel: string, cardinality: SchemaTypes.ClassificationCardinality, display: boolean, sortOrder: number, values: Array<{ id: string, label: string }>, selectedValues: Array<{ id: string, label: string }> }>, profile: { id: string, displayName: string, tagline?: string | undefined, url: string, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, avatar?: { uri: string } | undefined, banner?: { uri: string } | undefined, bannerWide?: { uri: string } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType, allowedValues: Array<string> }> | undefined } } } | undefined } };
...
export type SpaceClassificationsQueryVariables = SchemaTypes.Exact<{
  nameId: SchemaTypes.Scalars['NameID']['input'];
}>;


export type SpaceClassificationsQuery = { lookupByName: { space?: { id: string, nameID: string, about: { classifications: Array<{ id: string, displayLabel: string, cardinality: SchemaTypes.ClassificationCardinality, display: boolean, sortOrder: number, values: Array<{ id: string, label: string }>, selectedValues: Array<{ id: string, label: string }> }>, profile: { displayName: string, tagsets?: Array<{ name: string, tags: Array<string> }> | undefined } } } | undefined } };

export type SpacesForSelectorQueryVariables = SchemaTypes.Exact<{
  limit?: SchemaTypes.InputMaybe<SchemaTypes.Scalars['Float']['input']>;
}>;


export type SpacesForSelectorQuery = { me: { user?: { id: string } | undefined, spaceMembershipsHierarchical: Array<{ space: { id: string, nameID: string, visibility: SchemaTypes.SpaceVisibility, about: { isContentPublic: boolean, profile: { displayName: string } }, community: { roleSet: { leadUsers: Array<{ id: string }> } } } }> } };
...
export type SubspaceDetailsQuery = { lookup: { space?: { id: string, nameID: string, createdDate: Date, visibility: SchemaTypes.SpaceVisibility, about: { id: string, isContentPublic: boolean, membership: { myPrivileges?: Array<SchemaTypes.AuthorizationPrivilege> | undefined }, classifications: Array<{ id: string, displayLabel: string, cardinality: SchemaTypes.ClassificationCardinality, display: boolean, sortOrder: number, values: Array<{ id: string, label: string }>, selectedValues: Array<{ id: string, label: string }> }>, profile: { id: string, displayName: string, tagline?: string | undefined, url: string, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, avatar?: { uri: string } | undefined, banner?: { uri: string } | undefined, bannerWide?: { uri: string } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType, allowedValues: Array<string> }> | undefined } }, community: { id: string, roleSet: { memberUsers: Array<{ id: string }>, memberOrganizations: Array<{ id: string, nameID: string, profile?: { displayName: string, url: string, avatar?: { uri: string } | undefined, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType }> | undefined } | undefined }>, leadOrganizations: Array<{ id: string, nameID: string, profile?: { displayName: string, url: string, avatar?: { uri: string } | undefined, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType }> | undefined } | undefined }>, leadUsers: Array<{ id: string }>, adminUsers: Array<{ id: string }> } }, subspaces: Array<{ id: string, nameID: string, createdDate: Date, visibility: SchemaTypes.SpaceVisibility, about: { id: string, isContentPublic: boolean, membership: { myPrivileges?: Array<SchemaTypes.AuthorizationPrivilege> | undefined }, classifications: Array<{ id: string, displayLabel: string, cardinality: SchemaTypes.ClassificationCardinality, display: boolean, sortOrder: number, values: Array<{ id: string, label: string }>, selectedValues: Array<{ id: string, label: string }> }>, profile: { id: string, displayName: string, tagline?: string | undefined, url: string, location?: { country?: string | undefined, city?: string | undefined, geoLocation: { latitude?: number | undefined, longitude?: number | undefined } } | undefined, avatar?: { uri: string } | undefined, banner?: { uri: string } | undefined, bannerWide?: { uri: string } | undefined, tagsets?: Array<{ name: string, tags: Array<string>, type: SchemaTypes.TagsetType, allowedValues: Array<string> }> | undefined } } }> } | undefined } };
...
export const SpaceAboutFragmentFragmentDoc = gql`
  ...
  profile {
    ...
    `;
export const OrganizationCoreProfileFragmentDoc = gql`
  ...
  profile {
    ...
    `;
export const CommunityRolesFragmentFragmentDoc = gql`
  ...
  roleSet {
    ...
    ${OrganizationCoreProfileFragmentDoc}`;
export const SpaceAboutOnlyFragmentFragmentDoc = gql`
...
export const SpaceGraphInfoFragmentFragmentDoc = gql`
  ...
  subspaces {
    ...SpaceAboutOnlyFragment
  }
}
    ${SpaceAboutFragmentFragmentDoc}
${CommunityRolesFragmentFragmentDoc}
${SpaceAboutOnlyFragmentFragmentDoc}`;
...
export const MySpacesHierarchicalDocument = gql`
    query mySpacesHierarchical($limit: Float = 200) {
  me {
    user {
      id
      nameID
...
export const OrganizationByNameIdDocument = gql`
  ...
  lookupByName {
    ...
    `;
export const SpaceAboutOnlyByNameDocument = gql`
    query SpaceAboutOnlyByName($nameId: NameID!) {
  lookupByName {
    space(NAMEID: $nameId) {
      ...SpaceAboutOnlyFragment
    }
...
export const SpaceByNameDocument = gql`
  ...
  lookupByName {
    ...
    ${SpaceGraphInfoFragmentFragmentDoc}`;
export const SpaceClassificationsDocument = gql`
    query SpaceClassifications($nameId: NameID!) {
  lookupByName {
    space(NAMEID: $nameId) {
      id
      nameID
    ...
    `;
export const SpacesForSelectorDocument = gql`
...
const SpaceAboutOnlyByNameDocumentString = print(SpaceAboutOnlyByNameDocument);
const SpaceByNameDocumentString = print(SpaceByNameDocument);
const SpaceClassificationsDocumentString = print(SpaceClassificationsDocument);
const SpacesForSelectorDocumentString = print(SpacesForSelectorDocument);
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    mySpacesHierarchical(variables?: SchemaTypes.MySpacesHierarchicalQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: SchemaTypes.MySpacesHierarchicalQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<SchemaTypes.MySpacesHierarchicalQuery>(MySpacesHierarchicalDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'mySpacesHierarchical', 'query', variables);
    },
    ...
    SpaceAboutOnlyByName(variables: SchemaTypes.SpaceAboutOnlyByNameQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: SchemaTypes.SpaceAboutOnlyByNameQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<SchemaTypes.SpaceAboutOnlyByNameQuery>(SpaceAboutOnlyByNameDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SpaceAboutOnlyByName', 'query', variables);
    },
    ...
    SpaceClassifications(variables: SchemaTypes.SpaceClassificationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: SchemaTypes.SpaceClassificationsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<SchemaTypes.SpaceClassificationsQuery>(SpaceClassificationsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SpaceClassifications', 'query', variables);
    },
    SpacesForSelector(variables?: SchemaTypes.SpacesForSelectorQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: SchemaTypes.SpacesForSelectorQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<SchemaTypes.SpacesForSelectorQuery>(SpacesForSelectorDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SpacesForSelector', 'query', variables);
    },
    ...
    usersByIDs(variables: SchemaTypes.UsersByIDsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: SchemaTypes.UsersByIDsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<SchemaTypes.UsersByIDsQuery>(UsersByIDsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'usersByIDs', 'query', variables);
    }
  };
}
