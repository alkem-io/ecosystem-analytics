                ...
                <div className="relative aspect-video bg-muted overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3">
                    <Badge variant="default" className={cn(
                      ...
                      space.plan === "Premium" ? "bg-amber-500/90 hover:bg-amber-500" : 
                      space.plan === "Plus" ? "bg-blue-500/90 hover:bg-blue-500" : "bg-slate-500/90 hover:bg-slate-500"
                    )}>
                      {space.plan}
                    </Badge>
                  </div>
            ...
            <div className="space-y-4">
               {templatePacks.map((pack) => (
                <Card key={pack.id} className="flex items-center p-4 gap-4 hover:border-primary/50 transition-colors group">
                  <div className="h-12 w-12 rounded-lg bg-orange-100 dark:bg-orange-900/20 flex items-center justify-center text-orange-600 dark:text-orange-400 shrink-0">
